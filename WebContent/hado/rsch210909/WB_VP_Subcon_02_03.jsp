...
<head>
	...
	//<![CDATA[
		...
		function savef(){
			...
			relationf(main);
  			...
  			fn_itemChk1(main, 29, 1);
  			if(itemChk1 == true){
  			    fn_itemChk2(main, 29, 11);    
  			}
  			if(itemChk2 == true){
  			    fn_itemChk3(main, 29, 17);    
  			}
		...
		function relationf(main){
			...
			research2f(main, 12, 4, 2, 0);
			research2f(main, 12, 5, 2, 0);
			research2f(main, 12, 6, 2, 0);
			...
			if(main.allSum18_2.value != "0"){
    			if(main.allSum18_2.value != "100"){
    			    msg=msg+"\n";
    			  	msg=msg+"하도급거래현황의 18-2번의 하도급대금의 수령 수단별 비율의 합계를 100%로 입력해 주세요.";
      			}
			}    			
			
			research2f(main, 18, 21, 1, 10);
			research2f(main, 18, 3, 2, 0);
			
			if(main.allSum18_4.value != "0"){
    			if(main.allSum18_4.value != "100"){
    			    msg=msg+"\n";
    			  	msg=msg+"하도급거래현황의 18-4번의 하도급대금을 수령한 경우 지급받은 수단별 비중의 합계를 100%로 입력해 주세요.";
      			}
			}
			
			research2f(main, 19, 1, 1, 0);
			research2f(main, 19, 2, 3, 6);
			research2f(main, 20, 1, 2, 0);
			research2f(main, 20, 2, 2, 0);
			research2f(main, 21, 1, 2, 0);
			research2f(main, 21, 2, 2, 0);
			research2f(main, 22, 1, 2, 0);
			research2f(main, 23, 1, 1, 9);
			research2f(main, 24, 1, 2, 0);
			research2f(main, 25, 1, 2, 0);
			research2f(main, 26, 1, 2, 0);
			research2f(main, 27, 1, 3, 6);
			research2f(main, 27, 11, 1, 10);
			research2f(main, 28, 1, 2, 0);
			research2f(main, 29, 1, 2, 0);
			research2f(main, 29, 11, 2, 10);
			research2f(main, 29, 17, 2, 11);
			...
			if( main.q2_17_1[0].checked==true || main.q2_17_1[5].checked==true ) {
				initf(main, 17, 2, 2, 0); //initf(main, 17, 11, 1, 0);
			}
	...
	//2015-07-18 /강슬기/화면 인쇄시 새 창에서 출력
		...
		function fn_chk(main, fno, sno){
		    if(fno == "28" && sno == "6"){
    		    if(main.q2_28_6_10.checked){
    			    initf(main, 28, 6, 3, 9);
    			    initf(main, 28, 16, 1, 0);
    			}else{
    			    research3f(main, 28, 6, 3, 9, 28, 1);
    			    research3f(main, 28, 16, 1, 0, 28, 1);
    			}
		    }    		    
		}
		...
		function fn_itemChk1(main, fno, sno, gesu){
		    rowChk = 0;
  			for(i=0;i<=6;i++) {
  			    if(main.q2_29_1[i].checked == true) rowChk++;
  			    if(main.q2_29_2[i].checked == true) rowChk++;
  			    if(main.q2_29_3[i].checked == true) rowChk++;
  			    if(main.q2_29_4[i].checked == true) rowChk++;
  			    if(main.q2_29_5[i].checked == true) rowChk++;
  			    if(main.q2_29_6[i].checked == true) rowChk++;
  			    if(main.q2_29_7[i].checked == true) rowChk++;
  			    if(main.q2_29_8[i].checked == true) rowChk++;
  			    if(main.q2_29_9[i].checked == true) rowChk++;
  			    if(main.q2_29_10[i].checked == true) rowChk++;
   			}	
		    
        	if(rowChk < 10){
        	    msg=msg+"\n";
			  	msg=msg+"하도급거래현황의 29-1번 하도급 거래와 하도급 정책에 대한 귀사의 만족도 조사에 모두 응답해 주세요.";
        	}
		...
		function fn_itemChk2(main, fno, sno){
		    rowChk = 0;
			for(i=0;i<=6;i++) {
			    if(main.q2_29_11[i].checked == true) rowChk++;
			    if(main.q2_29_12[i].checked == true) rowChk++;
			    if(main.q2_29_14[i].checked == true) rowChk++;
			    if(main.q2_29_15[i].checked == true) rowChk++;
			    if(main.q2_29_16[i].checked == true) rowChk++;
			}			    
	    
			if(rowChk < 5){
			    msg=msg+"\n";
			  	msg=msg+"하도급거래현황의 29-2번 하도급 거래와 하도급 정책에 대한 귀사의 만족도 조사에 모두 응답해 주세요.";
	    	}
		...
		function fn_itemChk3(main, fno, sno){
		    rowChk = 0;
			for(i=0;i<=6;i++) {
			    if(main.q2_29_17[i].checked == true) rowChk++;
			    if(main.q2_29_18[i].checked == true) rowChk++;
			    if(main.q2_29_19[i].checked == true) rowChk++;
			    if(main.q2_29_20[i].checked == true) rowChk++;
			    if(main.q2_29_21[i].checked == true) rowChk++;
			    if(main.q2_29_22[i].checked == true) rowChk++;
			    if(main.q2_29_23[i].checked == true) rowChk++;
			    if(main.q2_29_24[i].checked == true) rowChk++;
			    if(main.q2_29_25[i].checked == true) rowChk++;
			    if(main.q2_29_26[i].checked == true) rowChk++;
			    if(main.q2_29_27[i].checked == true) rowChk++;
			    if(main.q2_29_28[i].checked == true) rowChk++;
			}			    
	    
			if(rowChk < 12){
			    msg=msg+"\n";
			  	msg=msg+"하도급거래현황의 29-3번 하도급 거래와 하도급 정책에 대한 귀사의 만족도 조사에 모두 응답해 주세요.";
	    	}
		...
		<div id="subcontent">
						...
						<li>
							<table class="tbl_blue">
								...
								<tbody>
									<tr>
										<th>구분</th>
										<th>조사대상 원(상위) 사업자와의 하도급 거래 계약 금액<br/>[VAT 포함 금액]</th>
									</tr>
									<tr>
										<th><%= st_Current_Year_n-3%>년도</th>
										<td>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_11_2" value="1" <%if(qa[11][2][1]!=null && qa[11][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(11,2);"></input> 가. 100% (전체 서면계약)<span class="boxcontentsubtitle">문11-6로</span></li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_11_3" value="1" <%if(qa[11][3][1]!=null && qa[11][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(11,3);"></input> 가. 있다(<input type="text" name="q2_11_22" value="<%=qa[11][22][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>건)</li>
						<li><input type="radio" name="q2_11_3" value="2" <%if(qa[11][3][2]!=null && qa[11][3][2].equals("1")){out.print("checked");}%> onclick="checkradio(11,3);"></input> 나. 없다<span class="boxcontentsubtitle">문11-6로</span></li>
					</ul>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
				    ...
				    <li class="boxcontentsubtitle">※ 문12-1에서 문12-6은 조사대상 원사업자와의 <strong>하도급 계약 체결시, 하도급 거래 단가(대금)의 결정</strong>에 관한 질문입니다.</li>
                </ul>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
				    ...
				    <li class="boxcontentsubtitle">※ 문13-1에서 문13-2는 <strong>하도급대금 지급보증</strong>에 관한 질문입니다.</li>
                </ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						...
						<li class="boxcontentsubtitle">&nbsp;&nbsp;- 2개 이상의 신용평가전문기관 회사채평가에서 A0이상의 등급을 받은 업체의 경우(2020.7.7 이후 면제 대상 아님)</li>
						<li class="boxcontentsubtitle">&nbsp;&nbsp;- 개별 공사금액이 1,000만원 이하인 경우</li>
						<li class="boxcontentsubtitle">&nbsp;&nbsp;- 발주자가 수급사업자에게 하도급대금을 직접 지급하는 경우</li>
						<li class="boxcontentsubtitle">&nbsp;&nbsp;- 상생결제시스템을 통해 하도급대금을 지급하는 경우</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<input type="hidden" name="c2_13_1" value="<%=setHiddenValue(qa, 13, 1, 6)%>"></input>
					<ul class="lt">
						<li><input type="radio" name="q2_13_1" value="1" <%if(qa[13][1][1]!=null && qa[13][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(13,1);"></input> 가. 원사업자가 지급보증 면제대상임<span class="boxcontentsubtitle">믄14-1로</span></li>
						<li><input type="radio" name="q2_13_1" value="2" <%if(qa[13][1][2]!=null && qa[13][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(13,1);"></input> 나. 100% (전체 지급보증)<span class="boxcontentsubtitle">믄14-1로</span></li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_13_2" value="1" <%if(qa[13][2][1]!=null && qa[13][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(13,2);"></input> 가. 원사업자와의 합의에 따라</li>
						<li><input type="radio" name="q2_13_2" value="2" <%if(qa[13][2][2]!=null && qa[13][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(13,2);"></input> 나. 원사업자가 보증수수료 부담을 고려함</li>
						<li><input type="radio" name="q2_13_2" value="3" <%if(qa[13][2][3]!=null && qa[13][2][3].equals("1")){out.print("checked");}%> onclick="checkradio(13,2);"></input> 다. 보증기관에서 보증서 발급을 회피함</li>
						<li><input type="radio" name="q2_13_2" value="4" <%if(qa[13][2][4]!=null && qa[13][2][4].equals("1")){out.print("checked");}%> onclick="checkradio(13,2);"></input> 라. 기타(<input type="text" name="q2_13_11" value="<%=qa[13][11][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
				    ...
				    <li class="boxcontentsubtitle">※ 문14-1에서 문14-2는 <strong>건설 위탁의 취소 및 변경</strong>에 관한 질문입니다.</li>
                </ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_14_1" value="1" <%if(qa[14][1][1]!=null && qa[14][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(14,1);"></input> 가. 100% (전체이행)<span class="boxcontentsubtitle">문15-1로</span></li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
				    ...
				    <li class="boxcontentsubtitle">※ 문15-1에서 문15-2는 <strong>목적물 인도</strong>에 관한 질문입니다.</li>
                </ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>15-1. </span> 조사대상 원사업자가 <%= st_Current_Year_n-1%>년도에 귀사에게  건설 위탁한 후, 그 목적물을 인수한  비율은 어떻게 됩니까?</li>
						<li class="boxcontentsubtitle">* 인수 비율 = 100*(인수한 물량/인수하기로 한 물량)</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<input type="hidden" name="c2_15_1" value="<%=setHiddenValue(qa, 15, 1, 5)%>"></input>
					<ul class="lt">
						<li><input type="radio" name="q2_15_1" value="1" <%if(qa[15][1][1]!=null && qa[15][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(15,1);"></input> 가. 100% (전체수령)<span class="boxcontentsubtitle">문16-1로</span></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>15-2. </span> 조사대상 원사업자가 건설 위탁한 목적물을 수령하지 않은 이유는 무엇입니까?</li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
				    ...
				    <li class="boxcontentsubtitle">※ 문16-1에서 문16-2는 <strong>계약체결 후, 하도급대금 감액</strong>에 관한 질문입니다.</li>
                </ul>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문17-1에서 문17-2는 <strong>선급금 수령</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_17_1" value="1" <%if(qa[17][1][1]!=null && qa[17][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(17,1);"></input> 가. 100% (전체지급)<span class="boxcontentsubtitle">문18-1로</span></li>
						...
						<li><input type="radio" name="q2_17_1" value="6" <%if(qa[17][1][6]!=null && qa[17][1][6].equals("1")){out.print("checked");}%> onclick="checkradio(17,1);"></input> 바. 지급대상 선급금 없음<span class="boxcontentsubtitle">문18-1로</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
				    <input type="hidden" name="c2_17_2" value="<%=setHiddenValue(qa, 17, 2, 6)%>"></input>
					<ul class="lt">
                        <li><input type="radio" name="q2_17_2" value="1" <%if(qa[17][2][1]!=null && qa[17][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 가. 귀사가 선급금 수령을 포기하거나 유예를 요청함</li>
                        <li><input type="radio" name="q2_17_2" value="2" <%if(qa[17][2][2]!=null && qa[17][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 나. 원사업자와 선급금을 지급받지 않기로 하도급계약을 맺음</li>
                        <li><input type="radio" name="q2_17_2" value="3" <%if(qa[17][2][3]!=null && qa[17][2][3].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 다. 귀사가 선급금지급 이행보증서 미제출</li>
                        <li><input type="radio" name="q2_17_2" value="4" <%if(qa[17][2][4]!=null && qa[17][2][4].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 라. 공사금액이 소액이고 공사기간이 짧았음</li>
                        <li><input type="radio" name="q2_17_2" value="5" <%if(qa[17][2][5]!=null && qa[17][2][5].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 마. 원사업자의 자금사정 등으로 지급받지 못함</li>
                        <li><input type="radio" name="q2_17_2" value="6" <%if(qa[17][2][6]!=null && qa[17][2][6].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 바. 기타(<input type="text" name="q2_17_11" value="<%=qa[17][11][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문18-1에서 문18-7는 <strong>하도급대금 수령</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_18_3" value="1" <%if(qa[18][3][1]!=null && qa[18][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(18,3);"></input> 가. 없음<span class="boxcontentsubtitle">문19-1로</span></li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문19-1에서 문19-2는 <strong>설계변경 또는 경제상황의 변동(물가상승)에 따른 공사대금 증액조정</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>19-2. </span> <%= st_Current_Year_n-1%>년도에 원사업자가 발주자로부터 설계변경 또는 경제상황의 변동(물가상승) 등에 따른 공사대금의 증액 조정을 받으 후 귀사에게 공사대금의 증액 조정을 해주지 못한 경우가 있다면, 그 이유는 무엇입니까?</li>
						<li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_19_2_2" value="1" <%if(qa[19][2][2]!=null && qa[19][2][2].equals("1")){out.print("checked");}%>></input> 나. 귀사의 자금사정으로 지급하지 못함</li>
						<li><input type="checkbox" name="q2_19_2_3" value="1" <%if(qa[19][2][3]!=null && qa[19][2][3].equals("1")){out.print("checked");}%>></input> 다. 대상 금액이나 조정비율이 작았음</li>
						<li><input type="checkbox" name="q2_19_2_4" value="1" <%if(qa[19][2][4]!=null && qa[19][2][4].equals("1")){out.print("checked");}%>></input> 라. 물가조정 대상기간 이후 하도급계약을 체결하였기 때문에 증액 조정하지 않음</li>
						<li><input type="checkbox" name="q2_19_2_5" value="1" <%if(qa[19][2][5]!=null && qa[19][2][5].equals("1")){out.print("checked");}%>></input> 마. 기타 (<input type="text" name="q2_19_11" value="<%=qa[19][11][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
						<li><input type="checkbox" name="q2_19_2_6" value="1" <%if(qa[19][2][6]!=null && qa[19][2][6].equals("1")){out.print("checked");}%>></input> 바. 공사대금의 증액 조정을 해주지 못한 경우가 없음</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문20-1에서 문20-5는 <strong>공급원가(재료비, 노무비, 경비 등) 변동에 따른 하도급대금 조정 신청</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>20-1. </span> 귀사는 하도급대금 조정제도에 대하 알고 있습니까?</li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_20_2" value="1" <%if(qa[20][2][1]!=null && qa[20][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 가. 있다<span class="boxcontentsubtitle">문20-3로</span></li>
						<li><input type="radio" name="q2_20_2" value="2" <%if(qa[20][2][2]!=null && qa[20][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 나. 없다<span class="boxcontentsubtitle">문20-5로</span></li>
					</ul>
					<div class="fc pt_50"></div>
					<div class="fc pt_50"></div>
				</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문21-1에서 문21-4는 조사대상 원사업자의 <strong>하도급법 위반</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_21_2" value="2" <%if(qa[21][2][2]!=null && qa[21][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,2);"></input> 나. 없다<span class="boxcontentsubtitle">문22-1로</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문22-1에서 문22-6은 <strong>하자보수 보증</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_22_1" value="1" <%if(qa[22][1][1]!=null && qa[22][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,1);"></input> 가. 하자보증 이행 요구 사실 없음<span class="boxcontentsubtitle">문23로</span></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						...
						<li class="boxcontentsubtitle">* 유보금 : 원사업자가 수급사업자에게 지급하여야 할 대금(선급금, 기성금, 잔금 등) 중 일부를 지급하지 아니하고 일정기간 동안 유보시켜 놓은 금액</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<input type="hidden" name="c2_22_3" value="<%=setHiddenValue(qa, 22, 3, 4)%>"></input>
					<ul class="lt">
						<li><input type="radio" name="q2_22_3" value="1" <%if(qa[22][3][1]!=null && qa[22][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,3);"></input> 가. 유보금 설정 사례 없음<span class="boxcontentsubtitle">문23로</span></li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문23은 조사대상 원사업자와의 <strong>협력관계</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>23. </span> <%= st_Current_Year_n-1%>년도에 조사대상 원사업자가 귀사와의 협력관계 증진을 위해 다음의 사항을 유상 또는 무상으로 지원한 경우가 몇 건 있습니까?</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<ul class="lt">
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문24-1에서 문24-2는 <strong>특약</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_24_2_2" value="1" <%if(qa[24][2][2]!=null && qa[24][2][2].equals("1")){out.print("checked");}%>></input> 나. 민원처리, 인·허가, 환경관리, 품질관리 등에  따른 비용을 귀사가 부담·분담</li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문25-1에서 문25-9는 <strong>조사대상 원사업자의 기술자료 요구</strong>에 관한 질문입니다.</li> 
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_25_1" value="2" <%if(qa[25][1][2]!=null && qa[25][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(25,1);"></input> 나. 없다<span class="boxcontentsubtitle">문26-1로</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_25_3" value="3" <%if(qa[25][3][3]!=null && qa[25][3][3].equals("1")){out.print("checked");}%> onclick="checkradio(25,3);"></input> 다. 제공하지 않음<span class="boxcontentsubtitle">문26-1로</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
							...
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" name="q2_25_31" value="<%=qa[25][31][20]%>" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>
										</td>
									</tr>
									<tr>
										<th>6</th>
										<td>
											<input type="text" name="q2_25_26" value="<%=qa[25][26][20]%>" class="text08b" onFocus="javascript:this.className='text08o';" onBlur="javascript:this.className='text08b';"></input>
										</td>
										<td>
											<input type="text" name="q2_25_32" value="<%=qa[25][32][20]%>" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										<th>2</th>
										<td>
											<input type="text" name="q2_25_34" value="<%=qa[25][34][20]%>" class="text08b" onFocus="javascript:this.className='text08o';" onBlur="javascript:this.className='text08b';"></input>
										</td>
										<td>
											<input type="text" name="q2_25_37" value="<%=qa[25][37][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>백만 원
										</td>
									</tr>
									<tr>
										<th>3</th>
										<td>
											<input type="text" name="q2_25_35" value="<%=qa[25][35][20]%>" class="text08b" onFocus="javascript:this.className='text08o';" onBlur="javascript:this.className='text08b';"></input>
										</td>
										<td>
											<input type="text" name="q2_25_38" value="<%=qa[25][38][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>백만 원
										</td>
									</tr>
								</tbody>
							</table>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문26-1에서 문26-4는 <strong>안전관리 부담</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>26-1. </span> <%= st_Current_Year_n-1%>년도에 귀사가 조사대상 원사업자로부터 위탁받은 공사 기간 중 사업장 안전관리업무 중의 일부를 귀사가 직접 수행한 사실이 있었습니까?</li>
						<li class="boxcontentsubtitle"></li>
					</ul>
				</div>
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_26_1" value="2" <%if(qa[26][1][2]!=null && qa[26][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(26,1);"></input> 나. 없다<span class="boxcontentsubtitle">문27-1로</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_26_2" value="2" <%if(qa[26][2][2]!=null && qa[26][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(26,2);"></input> 나. 원사업자가 부담<span class="boxcontentsubtitle">문27-1로</span></li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_26_3" value="1" <%if(qa[26][3][1]!=null && qa[26][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(26,3);"></input> 가. 지급하였음<span class="boxcontentsubtitle">문27-1로</span></li>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문27-1에서 문27-2는 <strong>조사대상 원사업자의 경영간섭</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_27_1_6" value="1" <%if(qa[27][1][6]!=null && qa[27][1][6].equals("1")){out.print("checked");}%>></input> 바. 없음</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문28-1에서 문28-6은 <strong>전속거래</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_28_1" value="2" <%if(qa[28][1][2]!=null && qa[28][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(28,1);"></input> 나. 없다<span class="boxcontentsubtitle">문29-1로</span></li>
					</ul>
					<div class="fc pt_50"></div>
				</div>
				<div class="fc"></div>
						...
						<li>
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										<th>전속거래 업체 수</th>
										<td><input type="text" name="q2_28_11" value="<%=qa[28][11][20]%>" onKeyUp="sukeyup(this);" size="30" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사</td>
									</tr>
									<tr>
										<th>전속거래를 통한 매출액</th>
										<td><input type="text" name="q2_28_12" value="<%=qa[28][12][20]%>" onKeyUp="sukeyup(this);" size="30" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 백만 원</td>
									</tr>
									<tr>
										<th>평균 전속거래 기간</th>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_28_6_10" value="1" <%if(qa[28][6][10]!=null && qa[28][6][10].equals("1")){out.print("checked");}%> onclick="fn_chk(this.form, 28, 6);"></input> 차. 해당사항 없음</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문29-1에서 문29-3은 <strong>하도급 거래와 하도급 정책에 대한</strong> 귀사의 <strong>만족도</strong>를 묻는 질문입니다.</li>
				</ul>
			</div>
									 ...
									 <tr>
										...
										<td style="text-align: center;">
											<%-- <input type="text" name="q2_29_27" value="<%=qa[29][27][20]%>" onKeyUp="sukeyup(this);" size="30" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> --%>
                                              <input type="hidden" name="c2_29_27" value="<%=setHiddenValue(qa, 29, 27, 1)%>"></input>
                                              <input type="radio" name="q2_29_27" value="1" <%if(qa[29][27][1]!=null && qa[29][27][1].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_27" value="2" <%if(qa[29][27][2]!=null && qa[29][27][2].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_27" value="3" <%if(qa[29][27][3]!=null && qa[29][27][3].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_27" value="4" <%if(qa[29][27][4]!=null && qa[29][27][4].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_27" value="5" <%if(qa[29][27][5]!=null && qa[29][27][5].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_27" value="6" <%if(qa[29][27][6]!=null && qa[29][27][6].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_27" value="7" <%if(qa[29][27][7]!=null && qa[29][27][7].equals("1")){out.print("checked");}%> onclick="checkradio(29,27);"></input>
                                        </td>
									</tr>
									<tr>
										<th style="text-align: left;">11) 보복조치</th>
										<td style="text-align: center;">
                                              <input type="hidden" name="c2_29_28" value="<%=setHiddenValue(qa, 29, 28, 1)%>"></input>
                                              <input type="radio" name="q2_29_28" value="1" <%if(qa[29][28][1]!=null && qa[29][28][1].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_28" value="2" <%if(qa[29][28][2]!=null && qa[29][28][2].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_28" value="3" <%if(qa[29][28][3]!=null && qa[29][28][3].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_28" value="4" <%if(qa[29][28][4]!=null && qa[29][28][4].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_28" value="5" <%if(qa[29][28][5]!=null && qa[29][28][5].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_28" value="6" <%if(qa[29][28][6]!=null && qa[29][28][6].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
                                        <td style="text-align: center;">
                                          <input type="radio" name="q2_29_28" value="7" <%if(qa[29][28][7]!=null && qa[29][28][7].equals("1")){out.print("checked");}%> onclick="checkradio(29,28);"></input>
                                        </td>
									</tr>
								</tbody>
							</table>
			...
			<div class="fr">
				<ul class="lt">
					...
					<li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_0<%=ckOentGB%>_04.jsp" onfocus="this.blur()" class="contentbutton2">4. 조사표 전송하기</a></li>
				</ul>
			</div>
			<!-- 버튼 end -->
		</div>
