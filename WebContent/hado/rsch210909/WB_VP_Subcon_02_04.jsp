	...
	<!-- Begin Header -->
		...
		<div id="submenu">
			<ul class="lt fr">
				...
				<li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_0<%=ckOentGB%>_04.jsp" onfocus="this.blur()" class="mainmenuup">4. 조사표 전송</a></li>
				<li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_Add.jsp" onfocus="this.blur()" onClick="message();" class="mainmenu">5. 추가 설문</a></li>
			</ul>
		</div>
		<!-- End Header -->
