...
* 프로그램명   : WB_VP_Subcon_01_02.jsp
* 프로그램설명  : 수급사업자 > 년도별 조사표 > 2015년 제조업 조사표 > 귀사의 일반현황
* 프로그램버전  : 1.0.1
* 최초작성일자  : 2009년 05월
* 작 성 이 력       :
*=========================================================
...
/*---------------------------------------- Variable Difinition ----------------------------------------*/
  ...
  String sconamt = "0";
  String sempcnt  = "0";    // 20100720 - 정광식 / 숫자형 기본값(0) 세팅
...
<head>
  ...
  //<![CDATA[
    ...
    function goPrint(){
      url = "WB_VP_Subcon_01_02.jsp?mode=print";
      w = 1024;
      h = 768;
      //HelpWindow2(url, w, h);
