		...
		<div id="subcontent">
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문13-1에서 문13-2는 <strong>제조 위탁의 취소 및 변경</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
                    ...
                    <li class="boxcontentsubtitle">※ 문14-1에서 문14-2는 <strong>물품 수령</strong>에 관한 질문입니다.</li>
				</ul>
			</div>
