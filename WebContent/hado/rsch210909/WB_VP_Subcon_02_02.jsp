	...
	function savef(){
        ...
        */%> --%>
		...
		if(msg!="") msg+="\n";
      	...
      	//제외대상 항목을 선택한 경우 회사개요만 입력하도록 처리
        if(!jQuery("input:radio[name='q0']").is(":checked")) {
            researchf(main.q1,2,"회사개요의 1번 영업상태를 선택해주세요");
            researchf(main.q2,2,"회사개요의 2번 회사규모를 선택해주세요");
            researchf(main.q3_3,1,"회사개요의 3번 <%=st_Current_Year_n-3%>년 매출액을 입력해주세요");
            researchf(main.q3_1,1,"회사개요의 3번 <%=st_Current_Year_n-2%>년 매출액을 입력해주세요");
            researchf(main.q3_2,1,"회사개요의 3번 <%=st_Current_Year_n-1%>년 매출액을 입력해주세요");
            researchf(main.q3_4,1,"회사개요의 3번 <%=st_Current_Year_n-3%>년 영업비용을 입력해주세요");
            researchf(main.q3_5,1,"회사개요의 3번 <%=st_Current_Year_n-2%>년 영업비용을 입력해주세요");
            researchf(main.q3_6,1,"회사개요의 3번 <%=st_Current_Year_n-1%>년 영업비용을 입력해주세요");
            researchf(main.q3_7,1,"회사개요의 3번 <%=st_Current_Year_n-3%>년 자산총액을 입력해주세요");
            researchf(main.q3_8,1,"회사개요의 3번 <%=st_Current_Year_n-2%>년 자산총액을 입력해주세요");
            researchf(main.q3_9,1,"회사개요의 3번 <%=st_Current_Year_n-1%>년 자산총액을 입력해주세요");
            researchf(main.q3_10,1,"회사개요의 3번 <%=st_Current_Year_n-3%>년 시공능력평가액을 입력해주세요");
            researchf(main.q3_11,1,"회사개요의 3번 <%=st_Current_Year_n-2%>년 시공능력평가액을 입력해주세요");
            researchf(main.q3_12,1,"회사개요의 3번 <%=st_Current_Year_n-1%>년 시공능력평가액을 입력해주세요");
  ...
  <div id="wrapper">
    ...
    <div id="submenu">
      <ul class="lt fr">
        ...
        <li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_0<%=ckOentGB%>_02.jsp" onfocus="this.blur()" class="mainmenuup">2. 귀사의 일반현황</a></li>
        <li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_0<%=ckOentGB%>_03.jsp" onfocus="this.blur()" class="mainmenu">3. 하도급 거래 현황</a></li>
    ...
    <div id="subcontent">
        ...
        <div class="boxcontentleft">
          <ul class="lt">
            ...
            * 사업자등록증에 명시된 회사명(한글/영문)으로 기입.</li>
            <li class="boxcontentsubtitle"><font color="#FF0066">* 연간 매출액, 자산총액 단위는 <strong><u>백만원</u></strong> 임</font></li>
            ...
            <li class="boxcontentsubtitle">* 팩스번호 대표번호 1개만 입력.</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
                        <li><span>※ </span>본 설문조사는 귀사의 <strong><u>재무상황과 하도급거래상황을 전반적으로 잘 파악하고 있는 기업대표 또는 회사</u> &nbsp;&nbsp;&nbsp;<u>책임자를</u></strong> 대상으로 하고 있습니다.</li>
            <li>
              <table class="tbl_blue">
                <colgroup>
                  <col style="width:15%;" />
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="radio" name="rcogb" value="0" <%if(scompgb!=null && scompgb.equals("0")){out.print("checked");}%>></input>비법인
                    </td>
                    <th>법인등록번호</th>
                  ...
                  <tr>
                    ...
                    <td><input type="hidden" name="rincorp" value="<%=sIncorp%>"></input>
                      <input type="text" name="rincorp1" value="<%=sIncorp1%>" maxlength="4" class="text02b" onFocus="javascript:this.className='text02o';" onBlur="javascript:this.className='text02b';" onKeyUp="fnextTextMove('rincorp1',4,'rincorp2');"></input>년
                      <input type="text" name="rincorp2" value="<%=sIncorp2%>" maxlength="2" class="text02b" onFocus="javascript:this.className='text02o';" onBlur="javascript:this.className='text02b';" onKeyUp="isMonth(this);"></input>월
                    </td>
                    <th>사업자등록번호</th>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="clt">
            <li class="boxcontenttitle"><span>3. </span>귀사의 지난 3년간(<%=st_Current_Year_n-3%>년~<%=st_Current_Year_n-1%>년) 매출액, 영업비용, 자산총액 및 시공능력평가액을 응답해주십시오.</li>
            <li class="boxcontentsubtitle">* 영업비용은 매출원가, 인건비, 임차료, 세금과공과, 감가상각비 등 생산활동에 소요된 비용을 포괄하며, 손익계산서 상 매출원가와 판매비및관리비의 합으로 계산함.</li>
            <li class="boxcontentsubtitle">* 영업비용의 경우 경제와 관련된 조사들에 대부분 포함되는 질문임. 업계전반을 살피는 목적으로(업황을 파악하는 목적)으로 사용될 예정임. (하도급번 위반과는 상관 없음)</li>
            <li class="boxcontentsubtitle">* 영업비용은 손익계산서에 있는 자료 기준으로 입력하되, 영업비용을  구하기 어려우면 대략적인 금액으로 기입</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li>
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr align="center">
                    ...
                    <td><input type="text" name="q3_1" value="<%=ssale1%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount003');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount003" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-2%>년도</th>
                    <td><input type="text" name="q3_2" value="<%=ssale2%>" onKeyUp="sukeyup(this); amountToHangul(this,'hanAmount001');" maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount001" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-1%>년도</th>
                    <td><input type="text" name="q3_3" value="<%=ssale%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount002');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr align="center">
                    <th><%= st_Current_Year_n-3%>년도</th>
                    <td><input type="text" name="q3_4" value="<%=soper1%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount004');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount004" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-2%>년도</th>
                    <td><input type="text" name="q3_5" value="<%=soper2%>" onKeyUp="sukeyup(this); amountToHangul(this,'hanAmount005');" maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount005" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-1%>년도</th>
                    <td><input type="text" name="q3_6" value="<%=soper%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount006');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr align="center">
                    <th><%= st_Current_Year_n-3%>년도</th>
                    <td><input type="text" name="q3_7" value="<%=samt1%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount007');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount007" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-2%>년도</th>
                    <td><input type="text" name="q3_8" value="<%=samt2%>" onKeyUp="sukeyup(this); amountToHangul(this,'hanAmount008');" maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount008" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-1%>년도</th>
                    <td><input type="text" name="q3_9" value="<%=samt%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount009');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr align="center">
                    <th><%= st_Current_Year_n-3%>년도</th>
                    <td><input type="text" name="q3_10" value="<%=sconamt1%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount0010');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount0010" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-2%>년도</th>
                    <td><input type="text" name="q3_11" value="<%=sconamt2%>" onKeyUp="sukeyup(this); amountToHangul(this,'hanAmount0011');" maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount0011" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= st_Current_Year_n-1%>년도</th>
                    <td><input type="text" name="q3_12" value="<%=sconamt%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount0012');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr align="center">
                    <th>총 근로자</th>
                    <td>
                      <input type="text" name="q4" id="q4" readonly="readonly" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" value="<%=sEmpCnt%>" size="6"></input> 명
                    </td>
                  </tr>
                  <tr align="center">
                    <th>상용 근로자</th>
                    <td>
                      <input type="text" name="q4_1" id="q4_1" onkeyup ="sukeyup(this); total();" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" value="<%=sEmpCnt1%>" size="6"></input> 명
                    </td>
                  </tr>
                  <tr align="center">
                    <th>임시 및 일용 근로자</th>
                    <td>
                      <input type="text" name="q4_2" id="q4_2" onkeyup ="sukeyup(this); total();" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" value="<%=sEmpCnt2%>" size="6"></input> 명
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <div class="fc pt_10"></div>
            ...
            <div class="boxcontent">
              ...
              <div class="boxcontentright">
                <ul class="clt">
                  <li><span>▣ </span>만일 귀사와 조사대상 원사업자와의 거래관계가 <strong>아래 사유에 해당</strong>될 경우, 귀사는 <strong>조사 대상에서 제외됩니다.</strong></li>
                    ...
                    <table class="tbl_blue">
                      ...
                      <tbody>
                        <tr>
                          ...
                          요건에 해당되지 않는 경우</td>
                          <td>ㆍ귀사가 공정거래법상의 <strong>대기업</strong>인 경우<br/>
                                                  ㆍ귀사가 중소기업이고, 귀사의 연간 매출액(2020년 기준)이 조사 &nbsp;&nbsp;&nbsp;대상 원사업자의 연간 매출액에 비해 큰 경우</td>
                        </tr>
                        <tr>
                          <td>② 하도급거래가 아닌 경우</td>
                          <td>ㆍ목적물을 판매하는 단순 <strong>매매행위</strong></font><br/>
                              ㆍ조사대상 원사업자로부터 위탁받은 목적물을 제조하지 않고 &nbsp;&nbsp;&nbsp;<strong>단순 구매</strong>하여 <strong>납품</strong>하는 경우 등</td>
                        </tr>
                        <tr>
                  ...
                  <li><span>▣</span><strong>제외대상 항목 선택 (택1)</strong></li>
                  <li><input type="radio" name="q0" value="1" <%if(sSentNoExcept!=null && sSentNoExcept.equals("1")){out.print("checked");}%>></input> 1. 귀사가 "하도급법상의 수급사업자" 요건에 해당되지 않는 경우</li>
                  <li><input type="radio" name="q0" value="2" <%if(sSentNoExcept!=null && sSentNoExcept.equals("2")){out.print("checked");}%>></input> 2. 하도급거래가 아닌 경우</li>
                  <li><input type="radio" name="q0" value="3" <%if(sSentNoExcept!=null && sSentNoExcept.equals("3")){out.print("checked");}%>></input> 3. 귀사가 하도급을 주기만 하는 경우</li>
                  <li><input type="radio" name="q0" value="4" <%if(sSentNoExcept!=null && sSentNoExcept.equals("4")){out.print("checked");}%>></input> 4. 하도급을 주지도 받지도 않는 경우 (하도급거래 없음)</li>
                  <li><input type="radio" name="q0" value="5" <%if(sSentNoExcept!=null && sSentNoExcept.equals("5")){out.print("checked");}%>></input> 5. 귀사가 폐업한 경우</li>
                  <li><input type="radio" name="q0" value="6" <%if(sSentNoExcept!=null && sSentNoExcept.equals("6")){out.print("checked");}%>></input> 6. 기타사유(<input type="text" name="q0Etc" value="<%=sSentNoExceptEtc%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li></li>
                  <li></li>            
                  
                  <div class="fc pt_10"></div>
                  <!--2015-05-07 / 조사제외대상여부 확인 문항 추가 / 강슬기 -->
                  <li><span>※ </span>귀사가 <strong>위 사유에 해당</strong> 된다고 판단되실 경우에는, 해당되는 조사제외 대상 항목을 선택하여 주시고, 저장하신 후 <strong>「4. 조사표 전송」</strong>란으로 가셔서 조사표 전송 버튼을 실행해 주시기 바랍니다.</li>
                  <div class="fc pt_10"></div>
                  <%-- <li>＊ 단, 하도급법이 적용되지 않는 사유를 기재</li>
                  <ul class="lt"><input type="hidden" name="rnoexptVal" value="<%=sSentNoExcept%>"/>
                    <li><textarea cols="80" rows="4" maxlength="600" name="reason" class="textarea01b" placeholder="예: ①수급사업자 요건에 해당되지 않음 ②단순 구매ㆍ매매 행위 ③하도급을 주기만 함  ④하도급거래 없음 등" onFocus="javascript:this.className='textarea01o';" onBlur="javascript:this.className='textarea01b';" onkeyup="byteLengCheck(this, 600, this.name,'content_bytes1');"><%=StringUtil.checkNull(reason)%></textarea></li>
      ...
      <div class="boxcontent2">
        <ul class="boxcontenthelp clt" style="padding-left:20px;">
          <li class="boxcontenttitle"><span>▣</span>귀사가 원 사업자와의 거래 관계가 하도급거래에 해당되는 경우에는 다음 단계인 『3. 하도급거래 현황』 으로 가셔서 질문 내용에 대해 응답하여<br/> 주시기 바랍니다. </li>
        </ul>
      </div>
      ...
      <div class="fr">
        <ul class="lt">
          ...
          <li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_0<%=ckOentGB%>_03.jsp" onfocus="this.blur()" class="contentbutton2">3. 하도급 거래 현황으로 가기</a></li>
          <li class="fl pr_2"><a href="../rsch210909/WB_VP_Subcon_0<%=ckOentGB%>_04.jsp" onfocus="this.blur()" class="contentbutton2">4. 조사표 전송으로 가기</a></li>
        </ul>
      </div>
      <!-- 버튼 end -->
