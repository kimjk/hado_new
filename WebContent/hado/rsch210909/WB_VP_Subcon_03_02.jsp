...
* 프로그램명   : WB_VP_Subcon_03_02.jsp
* 프로그램설명  : 수급사업자 > 년도별 조사표 > 2015년 용역업 조사표 > 귀사의 일반현황
* 프로그램버전  : 1.0.1
* 최초작성일자  : 2009년 05월
* 작 성 이 력       :
*=========================================================
...
/*---------------------------------------- Variable Difinition ----------------------------------------*/
  ...
  /* 조사제외대상 기타사유 추가 20210915 */
    String sSentNoExceptEtc = "";     // 조사제외대상 기타사유
  ...
  if ( (ckMngNo != null) && (!ckMngNo.equals("")) ) {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        if( rs.getString("Sent_Amt") != null && rs.getString("Sent_Amt") != "") {
          samt  = rs.getString("Sent_Amt");
        }
        ...
        if( rs.getString("Sent_Con_Amt") != null && rs.getString("Sent_Con_Amt") != "" ) {
          sconamt = rs.getString("Sent_Con_Amt");
        }
        /* /* 20100720 - 정광식 / NULL 인경우 0으로 기본값 세팅 * /
        if( rs.getString("Sent_Sale") != null && rs.getString("Sent_Sale") != "") {
          ssale = rs.getString("Sent_Sale");
        }
        /* 20100720 - 정광식 / NULL 인경우 0으로 기본값 세팅 * /
        if( rs.getString("Sent_Emp_Cnt") != null && rs.getString("Sent_Emp_Cnt") != "") {
...
<head>
  ...
  //<![CDATA[
    ...
    function relationf() {
      var seontaekam = false;
      var obj = document.info.rnoexpt;

      for (i = 0; i < obj.length; ++i) {
        seontaekam = seontaekam || obj[i].checked;
      }

      document.info.reason.disabled = !seontaekam;

      if (document.info.reason.disabled == true) {
        document.info.reason.value = "";
      }
    }
    ...
    function loadf(){
      ...
      if(msg=="") {
        if(confirm("일반현황 정보를 불러옵니다.")) {
          ...
          //processSystemStart("[1/1] 일반현황 정보를 불러옵니다.");
	...
	function savef(){
        ...
        if(!jQuery("input:radio[name='q0']").is(":checked")) {
            ...
            researchf(main.q4,1,"회사개요의 4번 총근로자수를 입력해주세요");
    ...
    function goPrint(){
      url = "WB_VP_Subcon_03_02.jsp?mode=print";
      w = 1024;
      h = 768;
...
<body onload="<%= (q_Cmd.equals("print")) ? "doPrint();" : "onDocumentInit();" %>">
<div id="container">
  <div id="wrapper">
        ...
        <li class="fr">
          <ul class="lt">
            <li class="pt_20"><font color="#FF6600">[
              ...
              <%=ckOentName%>&nbsp;/&nbsp;<%=ckSentName%><iframe src="../Include/WB_FP_sessionClock.jsp" name="TimerArea" id="TimerArea" width="220" height="22" marginwidth="0" marginheight="1" style="vertical-align: text-bottom;" frameborder="0"></iframe></li>
          </ul>
        </li>
      </ul>
    </div>
    ...
    <div id="submenu">
      <ul class="lt fr">
        ...
        <li class="fl pr_2"><a href="./WB_VP_Subcon_0<%=ckOentGB%>_02.jsp" onfocus="this.blur()" class="mainmenuup">2. 귀사의 일반현황</a></li>
        ...
        <li class="fl pr_2"><a href="./WB_VP_Subcon_Add.jsp" onfocus="this.blur()" class="mainmenu">5. 추가 설문</a></li>
      </ul>
    </div>
    <!-- End Header -->
    ...
    <div id="subcontent">
            ...
            <li>
              <table class="tbl_blue">
                ...
                <tr>
                  ...
                  <td><a href="javascript:loadf();" onfocus="this.blur()" class="contentbutton2">일반현황 정보 가져오기</a></td>
                </tr>
                </tbody>
              </table>
            </li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="clt">
            ...
            <li class="boxcontentsubtitle">* 영업비용은 손익계산서에 있는 자료 기준으로 입력하되, 영업비용을 구하기 어려우면 대락적인 금액으로 기입</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
      ...
      <div class="fr">
        <ul class="lt">
          <%if (ckMngNo.matches("HE010[1-3]00001")) {%>
          ...
          <li class="fl pr_2"><a href="./WB_VP_Subcon_0<%=ckOentGB%>_03.jsp" onfocus="this.blur()" class="contentbutton2">3. 하도급 거래 현황으로 가기</a></li>
          <li class="fl pr_2"><a href="./WB_VP_Subcon_0<%=ckOentGB%>_04.jsp" onfocus="this.blur()" class="contentbutton2">4. 조사표 전송으로 가기</a></li>
        </ul>
      </div>
      <!-- 버튼 end -->
