...
* 프로그램명		: WB_VP_Subcn_03_04.jsp
* 프로그램설명	: 수급사업자 > 년도별 조사표 > 2015년 용역업 조사표 > 조사표 전송
* 프로그램버전	: 1.0.1
* 최초작성일자	: 2009년 05월
* 작 성 이 력       :
*=========================================================
	...
	//<![CDATA[
		...
		function infoSubmit() {
			...
			if(confirm("[ 로그인 차단을 실행합니다. ]\n\n차단 이후에는 접속이 불가능합니다.\n확인을 누르시면 로그인 차단을 실행합니다.")) {
				...
				processSystemStart("[1/1] 로그인 차단을 실행합니다.");
		...
		function message(){
		    ...
		    if(type == 'N'){
		        alert("본 추가 설문은 하도급거래를 하고 있는 기업들을 대상으로 진행 하고 있습니다. 귀사는 하도급거래를 하고 있지 않다고 응답 하셨기 때문에 추가설문에 응답 하실 수 없습니다. 감사합니다.");
		    }
		}
	//]]
	</script>
	...
	<!-- Begin Header -->
		...
		<div id="submenu">
			<ul class="lt fr">
				...
				<li class="fl pr_2"><a href="./WB_VP_Subcon_0<%=ckOentGB%>_04.jsp" onfocus="this.blur()" class="mainmenuup">4. 조사표 전송</a></li>
				<li class="fl pr_2"><a href="./WB_VP_Subcon_Add.jsp" onfocus="this.blur()" onClick="message();" class="mainmenu">5. 추가 설문</a></li>
			</ul>
		</div>
		<!-- End Header -->
			...
			<table width="100%" cellpadding="0" cellspacing="2" border="0">
				...
				<tbody>
					<tr>
						...
						<td>
							<ul class="lt">
								<li class="fl pr_2"><h1 class="contenttitle"><a href="javascript:savef();" onfocus="this.blur()" class="contentbutton2">조사표 전송 실행</a></h1></li>
								<li class="fl pr_2"><h1 class="contenttitle"><a href="javascript:goPrint();" onfocus="this.blur()" class="contentbutton2">화면 인쇄하기</a></h1></li>
								<li class="fl pr_2"><h1 class="contenttitle"><a href="javascript:checkSubmit();" onfocus="this.blur()" class="contentbutton2">조사표 전송 확인</a></h1></li>
								<% if( (!sentStatus.equals("")) && (sentStatus != null) ) { %>
								<li class="fl pr_2"><h1 class="contenttitle"><a href="javascript:infoSubmit();" onfocus="this.blur()" class="contentbutton2">저장 및 로그인 차단</a></h1></li>
								<% } %>
							</ul>
						</td>
					</tr>
...
<!-- 		</h1> -->
		...
		<!-- <div class="boxcontent2">
			<ul class="boxcontenthelp lt text_list" style="margin-left:10px; margin-right:10px;">
				<li><span>▣</span><font style="font-weight:bold;">개정 하도급법 주요 내용에 대한 설문조사를 실시하고 있습니다. <font color="#FF0066">아래 "신규제도관련 설문조사로 이동"</font>버튼을 눌러 주십시오.</font></li>
			</ul>
		</div>
		<div class="fc pt_20"></div> -->
		...
		<!-- <div class="fr">
			<ul class="lt">
				<li class="fl pr_2"><a href="./WB_VP_Subcon_Add.jsp" onfocus="this.blur()" class="contentbutton2">신규제도관련 설문조사로 이동</a></li>
			</ul>
		</div> -->
		<!-- 버튼 end -->
