...
* 프로그램명	: Oent_Violate_45_Excel.jsp
...
/*=================================== Record Selection Processing =====================================*/
	...
	// Default Value
	arrItemText[0] = "제조ㆍ수리ㆍ시공 또는 용역수행 방법에 관한 정보ㆍ자료";
	arrItemText[1] = "특허권, 실용신안권 등 지적재신권과 관련된 정보";
	arrItemText[2] = "시공프로세스 메뉴얼, 설계도면, 생산원가 내역서 등 독립된 경제적 가치가 있는 기술상 또는 경영상의 정보";
/*=====================================================================================================*/
%>
<html>
	<head>
