	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="Oent_Violate_49_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
			...
			<div id="contents">
				...
				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle"> 하도급거래 관련서류 보존기간</li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 > 하도급거래 관련서류 보존기간</li>
						<p></p>
					</div>	
