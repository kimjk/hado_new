...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="Oent_Violate_31_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="062" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">수급사업자와 하도급대금 조정을 위한 협의를 하였는지</li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 > 수급사업자와 하도급대금 조정을 위한 협의를 하였는지</li>
						<p></p>
					</div>	
