...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="Oent_Violate_05_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="036" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">영업비밀ㆍ기술자료요구에 따른 분쟁 </li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 > 영업비밀ㆍ기술자료요구에 따른 분쟁 </li>
						<p></p>
					</div>	
