...
/*=================================== Record Selection Processing =====================================*/
	...
	try {
		...
		// 업종별 해당 문항 번호
		if( session.getAttribute("wgb").equals("1") ) {
			sSQLs+="			AND Oent_Q_CD=11 AND Oent_Q_GB=10 AND Oent_GB='1' \n";
		} else if( session.getAttribute("wgb").equals("2") ) {
			sSQLs+="			AND Oent_Q_CD=12 AND Oent_Q_GB=8 AND Oent_GB='2' \n";
		} else if( session.getAttribute("wgb").equals("3") ) {
			sSQLs+="			AND Oent_Q_CD=11 AND Oent_Q_GB=10 AND Oent_GB='3' \n";
		} else {
			if( currentYear == 2010 ) {
				sSQLs+="			AND ( (Oent_Q_CD=11 AND Oent_Q_GB=10 AND Oent_GB='1') \n";
				sSQLs+="				OR (Oent_Q_CD=12 AND Oent_Q_GB=8 AND Oent_GB='2') \n";
				sSQLs+="				OR (Oent_Q_CD=11 AND Oent_Q_GB=10 AND Oent_GB='3') ) \n";
			} else {
				sSQLs+="			AND Oent_Q_CD=11 AND Oent_Q_GB=10 \n";	
			}
		}
