...
* 프로그램명	: Oent_Violate_54_Excel.jsp
* 프로그램설명	: 원사업자 > 조사결과분석 > 어음대체결제수단의 평균결제기간
* 프로그램버전	: 1.0.1
	...
	try {
		...
		if( session.getAttribute("wgb").equals("1") ) {
			if( currentYear >= 2015 ) {
				...
				sSQLs+="	AND Oent_Q_CD=16 AND Oent_Q_GB=3  AND Oent_GB='1' \n";
				...
				sSQLs+="	AND Oent_Q_CD=10 AND Oent_Q_GB=10 AND Oent_GB='1' \n";
			...
			if( currentYear >= 2015 ) {
				sSQLs+="	AND Oent_Q_CD=19 AND Oent_Q_GB=4  AND Oent_GB='2' \n";
			} else if( currentYear >= 2014 ) {
				sSQLs+="	AND Oent_Q_CD=18 AND Oent_Q_GB=3  AND Oent_GB='2' \n";
			} else if( currentYear >= 2012 ) {
				sSQLs+="	AND Oent_Q_CD=17 AND Oent_Q_GB=3  AND Oent_GB='2' \n";
			} else if( currentYear == 2005 ) {
				...
				sSQLs+="	AND Oent_Q_CD=9 AND Oent_Q_GB=10 AND Oent_GB='2' \n";
			} else if( currentYear == 2001 ) {
			...
			if( currentYear >= 2015 ) {
				...
				sSQLs+="	AND Oent_Q_CD=16 AND Oent_Q_GB=3  AND Oent_GB='3' \n";
			} else if( currentYear >= 2012 ) {
				sSQLs+="	AND Oent_Q_CD=15 AND Oent_Q_GB=3  AND Oent_GB='3' \n";
			} else if( currentYear == 2005 ) {
				...
				sSQLs+="	AND Oent_Q_CD=10 AND Oent_Q_GB=10 AND Oent_GB='3' \n";
			} else if( currentYear == 2001 ) {
			...
			if( currentYear >= 2015 ) {
				sSQLs+="	AND ( (Oent_Q_CD=17 AND Oent_Q_GB=4 AND Oent_GB='1') \n";
				sSQLs+="		OR (Oent_Q_CD=19 AND Oent_Q_GB=4 AND Oent_GB='2') \n";
				sSQLs+="		OR (Oent_Q_CD=16 AND Oent_Q_GB=4 AND Oent_GB='3') ) \n";
			} else if( currentYear >= 2014 ) {
				sSQLs+="	AND ( (Oent_Q_CD=17 AND Oent_Q_GB=3 AND Oent_GB='1') \n";
				sSQLs+="		OR (Oent_Q_CD=18 AND Oent_Q_GB=3 AND Oent_GB='2') \n";
				sSQLs+="		OR (Oent_Q_CD=16 AND Oent_Q_GB=3 AND Oent_GB='3') ) \n";
			} else if( currentYear >= 2012 ) {
				sSQLs+="	AND ( (Oent_Q_CD=16 AND Oent_Q_GB=3 AND Oent_GB='1') \n";
				sSQLs+="		OR (Oent_Q_CD=17 AND Oent_Q_GB=3 AND Oent_GB='2') \n";
				sSQLs+="		OR (Oent_Q_CD=15 AND Oent_Q_GB=3 AND Oent_GB='3') ) \n";
			} else if( currentYear == 2005 ) {
				sSQLs+="	AND ( (Oent_Q_CD=17 AND Oent_Q_GB=3 AND Oent_GB='1') \n";
				...
				sSQLs+="	AND ( (Oent_Q_CD=10 AND Oent_Q_GB=10 AND Oent_GB='1') \n";
				sSQLs+="		OR (Oent_Q_CD=9 AND Oent_Q_GB=10 AND Oent_GB='2') \n";
				sSQLs+="		OR (Oent_Q_CD=10 AND Oent_Q_GB=10 AND Oent_GB='3') ) \n";
			} else if( currentYear == 2001 ) {
				sSQLs+="	AND ( (Oent_Q_CD=10 AND Oent_Q_GB=9 AND Oent_GB='1') \n";
