	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="Oent_Violate_51_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="060" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle"> 계약내용 추가ㆍ변경내용 통보 여부(건설)</li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 > 계약내용 추가ㆍ변경내용 통보 여부(건설)</li>
						<p></p>
					</div>	
