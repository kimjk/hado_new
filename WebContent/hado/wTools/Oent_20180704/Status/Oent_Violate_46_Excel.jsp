...
* 프로그램명	: Oent_Violate_46_Excel.jsp
...
/*=================================== Record Selection Processing =====================================*/
	...
	// Default Value
	arrItemText[0] = "요구 목적 등이 기재된 서면을 주었음";
	arrItemText[1] = "기술자료의 필요성 등을 구두로 상세히 설명해 주었음(최종적으로 서면을 주지 않음)";
	arrItemText[2] = "서면을 발급해 준 경우도 있고, 구두로만 설명해 준 경우도 있었음";
/*=====================================================================================================*/
%>
<html>
	<head>
