...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="SOent_Submit_Place_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
			...
			<div id="contents">
				...
				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">
							담당사무소별 제출현황</li>
						<li class="whereiam">HOME > 수급사업자 > 제출현황 > 담당사무소별 제출현황</li>
						<p></p>
					</div>	
					<div class="searchbox" id="searchbox">
						...
						<form action="" method="post" name=searchform>
							<tr>
								...
								<td>
									<select name="cyear">
										<%//for(int xx=2010; xx<=st_Current_Year_n; xx++) {
