...
* 프로그램명	: SOent_Submit_Oent_List.jsp
	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="SOent_Submit_Oent_List_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
			...
			<div id="contents">
				...
				<div id="divContent">
					<div id="searchContent">
						...
						<li class="whereiam">HOME > 수급사업자 > 제출현황 > 원사업자 명부 제출현황 리스트</li>
						<p></p>
					</div>	
					<div class="searchbox" id="searchbox">
						<table class="searchboxtable">
						<form action="SOent_Submit_Oent_List.jsp?comm=search" method="post" name="searchform">
							<tr>
								<th>조사년도</th>
								<td>
									<select name="cyear">
										<%for(int xx=2016; xx<=st_Current_Year_n; xx++) {
										String tmpCYear = ""+xx;%>
