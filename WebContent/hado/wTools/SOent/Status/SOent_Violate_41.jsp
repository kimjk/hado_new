...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="SOent_Violate_41_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="089" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">서면미발급시 하도급대금 감액 또는 발주 취소 여부</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > <br/>서면미발급시 하도급대금 감액 또는 발주 취소 여부</li>
						<p></p>
					</div>
