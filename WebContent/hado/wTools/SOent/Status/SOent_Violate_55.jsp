	...
	//<![CDATA[
		...
		function goSearch()
		{
			...
			if(nNowProcess == 0) {
				...
				frm.action="SOent_Violate_55_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="051" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">물품/목적물 미수령 사유</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > 물품/목적물 미수령 사유</li>
						<p></p>
					</div>
