...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="SOent_Violate_26_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="090" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">[단독]건설업 업체별 위반항목 내역</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > [단독]건설업 업체별 위반항목 내역</li>
						<p></p>
					</div>
					<div class="searchbox" id="searchbox">
						...
						<form action="" method="post" name="searchform">
							<tr>
								...
								<td>
									<select name="wgb">
										<option value="2" selected>건설</option>
									</select>
								</td>
								<th>업종</th>
								<td>
									<select name="sgb">
										...
										<%
										for(int j=0 ; j < arrCCode.size() ; j++) { %>
											<option value="<%=arrCCode.get(j)%>"><%=arrCName.get(j)%></option>
										<%
										} %>
									</select>
								</td>
