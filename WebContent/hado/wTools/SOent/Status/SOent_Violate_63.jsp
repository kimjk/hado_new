	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="SOent_Violate_63_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
			...
			<div id="contents">
				...
				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">원재료 가격 상승폭</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > 원재료 가격 상승폭</li>
						<p></p>
					</div>
