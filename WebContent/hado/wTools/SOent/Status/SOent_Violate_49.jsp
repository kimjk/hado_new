...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="SOent_Violate_49_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="106" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">[단독]원재료 인상에 따른 하도급대금 조정 협의 여부</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > <br/>[단독]원재료 인상에 따른 하도급대금 조정 협의 여부</li>
						<p></p>
					</div>
