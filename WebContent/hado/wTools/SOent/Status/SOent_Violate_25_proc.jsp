	...
	try {
		...
		if( !tt.equals("start") ) {
			...
			if( session.getAttribute("wgb").equals("1") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=18 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=2 \n";
			} else if( session.getAttribute("wgb").equals("3") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=16 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=2 \n";
			} else {
				sSQLs+="		AND ((HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=18 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=2  AND HADO_TB_Subcon_"+currentYear+".oent_gb='1') \n";
				sSQLs+="		OR ( HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=16  AND  HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=2  AND HADO_TB_Subcon_"+currentYear+".oent_gb='3')) \n";
			}
...
content+="		<th colspan='2'>도입 인지 여부</th>";
content+="  </tr>";
content+="	<tr>";
content+="		<th>알고있음</th>";
content+="		<th>모름</th>";
