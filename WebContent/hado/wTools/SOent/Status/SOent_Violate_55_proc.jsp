...
* 프로그램명	 : SOent_Violate_55proc.jsp																				   
* 프로그램설명	: 수급사업자 > 조사결과분석 > 물품/목적물 미수령 사유   
* 프로그램버전	: 1.0.1																				                        
	...
	try {
		...
		if( !tt.equals("start") ) {
			...
			if( !session.getAttribute("wgb").equals("") ) {
				sSQLs="SELECT a.Oent_Type,b.Common_NM,a.Field01,a.Field02,a.Field03,a.Field04,a.Field05,a.Field06,a.Field07,a.Field08 FROM ( \n";
				sSQLs+="	SELECT "+currentOent+".Oent_Type, \n";
			} else {
				sSQLs="SELECT Oent_GB Oent_Type,'' Common_NM,Field01,Field02,Field03,Field04,Field05,Field06,Field07,Field08 FROM ( \n";
...
content+="		<th colspan='7'>물품, 목적물 미수령 사유 (중복응답, 제조업 기준)</th>";
content+="  </tr>";
content+="	<tr>";
content+="		<th>불량품</th>";
content+="		<th>발주서대로 제조되지 않음</th>";
content+="		<th>원사업자의 일방적인 발주변경, 취소</th>";
content+="		<th>납기에 납품하지 않음</th>";
content+="		<th>고객의 클레임 또는 판매부진</th>";
content+="		<th>원사업자의 사양변경 또는 모델단종</th>";
content+="		<th>기타</th>";
