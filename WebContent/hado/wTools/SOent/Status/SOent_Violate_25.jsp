...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="SOent_Violate_25_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="084" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">기술자료 예치제도 도입 인지 여부</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > <br/>기술자료 예치제도 도입 인지 여부</li>
						<p></p>
					</div>
