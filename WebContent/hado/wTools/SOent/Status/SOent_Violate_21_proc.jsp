	...
	try {
		...
		if( !tt.equals("start") ) {
			...
			if( session.getAttribute("wgb").equals("1") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=17 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=4 \n";
			} else if( session.getAttribute("wgb").equals("3") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=15 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=4 \n";
			} else {
				sSQLs+="		AND ((HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=17 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=4  AND HADO_TB_Subcon_"+currentYear+".oent_gb='1') \n";
				sSQLs+="		OR ( HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=15  AND  HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=4  AND HADO_TB_Subcon_"+currentYear+".oent_gb='3')) \n";
			}
...
content+="		<th colspan='2'>배타적 거래</th>";
content+="  </tr>";
content+="	<tr>";
content+="		<th>있었음</th>";
content+="		<th>없었음</th>";
