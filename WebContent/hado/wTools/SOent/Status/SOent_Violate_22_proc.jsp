	...
	try {
		...
		if( !tt.equals("start") ) {
			...
			if( session.getAttribute("wgb").equals("1") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=17 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=5 \n";
				...
				sSQLs+="		AND ((HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=17 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=5  AND HADO_TB_Subcon_"+currentYear+".oent_gb='1') \n";
				sSQLs+="		OR ( HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=15  AND  HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=5  AND HADO_TB_Subcon_"+currentYear+".oent_gb='3')) \n";
			}
