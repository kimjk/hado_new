	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="SOent_Violate_60_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="056" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">하도급대금 감액 사유 통보 방법</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > 하도급대금 감액 사유 통보 방법</li>
						<p></p>
					</div>
