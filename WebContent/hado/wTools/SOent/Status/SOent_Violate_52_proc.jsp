...
/*  3. 일자 : 2014년 2월																			   */
/*  4. 최초작성자 및 일자 : (주)로티스아이 정광식 / 2014-02-21										   */
/*  5. 업데이트내용 (내용 / 일자)																	   */
/*  6. 비고																							   */
/*		1) 최초작성자 / 정광식 / 2014-02-21														   */
/*-----------------------------------------------------------------------------------------------------*/
	...
	try {
		...
		if( !tt.equals("start") ) {
			...
			if( session.getAttribute("wgb").equals("1") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_cd=14 AND HADO_TB_SOent_Answer_"+currentYear+".soent_q_gb=1 \n";
			} else if( session.getAttribute("wgb").equals("2") ) {
				sSQLs+="		AND HADO_TB_SOent_Answer_"+currentYear+".SOent_Q_CD=17 AND HADO_TB_SOent_Answer_"+currentYear+".SOent_Q_GB=1 \n";
				...
				sSQLs+="			OR (HADO_TB_SOent_Answer_"+currentYear+".SOent_Q_CD=17 AND HADO_TB_SOent_Answer_"+currentYear+".SOent_Q_GB=1 AND HADO_TB_SOent_Answer_"+currentYear+".Oent_GB='2') \n";
				sSQLs+="			OR (HADO_TB_SOent_Answer_"+currentYear+".SOent_Q_CD=14 AND HADO_TB_SOent_Answer_"+currentYear+".SOent_Q_GB=1 AND HADO_TB_SOent_Answer_"+currentYear+".Oent_GB='3') ) \n";
			}
