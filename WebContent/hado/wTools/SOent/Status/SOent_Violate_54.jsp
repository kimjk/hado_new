	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="SOent_Violate_54_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
			...
			<div id="contents">
				...
				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">물품/목적물 미수령 여부</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > 물품/목적물 미수령 여부</li>
						<p></p>
					</div>
