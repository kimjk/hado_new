...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="SOent_Violate_32_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="095" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">[단독]건설업 수급사업자별 원사업자 입력 현황</li>
						<li class="whereiam">HOME > 수급사업자 > 조사결과분석 > <br/>[단독]건설업 수급사업자별 원사업자 입력 현황</li>
						<p></p>
					</div>
