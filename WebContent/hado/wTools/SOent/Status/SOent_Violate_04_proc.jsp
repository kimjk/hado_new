...
/*=================================== Record Selection Processing =====================================*/
	...
	try {
		...
		if( !tt.equals("start") ) {			
			...
			sSQLs+="SUM(CASE Index_Value WHEN '3' THEN 1 ELSE 0 END) c FROM ( \n";
			...
			if( currentYear==2010 ) {
				sSQLs+="		WHERE Sent_Q_CD=15 AND Sent_Q_GB=4 AND Current_Year='"+currentYear+"' \n";
			} else {
				sSQLs+="		WHERE Sent_Q_CD=13 AND Sent_Q_GB=4 AND Current_Year='"+currentYear+"' \n";
					}
