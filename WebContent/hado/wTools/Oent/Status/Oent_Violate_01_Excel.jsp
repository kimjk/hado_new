...
* 프로그램명	: Oent_Violate_01_Excel.jsp	
* 프로그램설명	: 원사업자 > 조사결과분석 > 하도급단가 인하여부
* 프로그램버전	: 1.0.1
...
/*=================================== Record Selection Processing =====================================*/
	...
	// view table name
	String currentTalbe;
	//*	2018-07-10	김보선		2015년 이후 조건식 추가
		if( currentYear>2015 ) {
			currentTalbe = "HADO_VT_OENT_ANSWER_ST_"+currentYear+" \n";
