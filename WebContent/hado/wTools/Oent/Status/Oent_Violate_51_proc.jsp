...
* 프로그램명	: Oent_Violate_51_proc.jsp
* 프로그램설명	: 원사업자 > 조사결과분석 > 계약내용 추가ㆍ변경내용 통보 여부(건설)
* 프로그램버전	: 1.0.1
...
content+="	<tr>";
content+="		<th><a href='Oent_Violate_51_Excel.jsp' target='_blank'><img src='/hado/hado/wTools/img/img_forExcel.gif'></a></th>";
content+="	</tr>";
content+="</table>";
