...
* 프로그램명	: Oent_Violate_37_proc.jsp
* 프로그램설명	: 원사업자 > 조사결과분석 > 물품(목적물)수령 여부(제조/용역)
* 프로그램버전	: 1.0.1
	...
	try {
		...
		if( currentYear>=2014 ) {
			if( session.getAttribute("wgb").equals("1") ) {
				sSQLs+="	AND Oent_GB='1' AND Oent_Q_CD=10 AND Oent_Q_GB=1 \n";	
...
content+="	<tr>";
content+="		<th><a href='Oent_Violate_37_Excel.jsp' target='_blank'><img src='/hado/hado/wTools/img/img_forExcel.gif'></a></th>";
content+="	</tr>";
content+="</table>";
