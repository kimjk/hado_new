...
* 프로그램명	: Oent_Violate_47.jsp
* 프로그램설명	: 원사업자 > 조사결과분석 > 기술자료 제공 방법
* 프로그램버전	: 1.0.1
	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="Oent_Violate_47_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="061" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle"> 기술자료 제공 방법</li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 >기술자료 제공 방법</li>
						<p></p>
					</div>	
