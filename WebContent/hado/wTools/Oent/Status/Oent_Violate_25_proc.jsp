...
/*---------------------------------------- Variable Difinition ----------------------------------------*/
	...
	//2018-07-04	김보선		배열 크기 변경
	String[] No_Money_NM=new String[43];
	String[] No_Money_CD=new String[43];
...
/********************************************************************************************************/
		...
		//2018-07-04	김보선		사용하지않는 업종코드 제외
		if( currentYear!=2016) sSQLs+=" AND COMMON_CD !='I56' \n";
