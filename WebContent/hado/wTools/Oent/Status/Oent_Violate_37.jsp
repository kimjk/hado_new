...
*	2016-01-06	민현근		DB변경으로 인한 인코딩 변경
	...
	//<![CDATA[
		...
		function goSearch() {
			...
			if(nNowProcess == 0) {
				...
				frm.action="Oent_Violate_37_proc.jsp?comm=search";
				frm.submit();
				nNowProcess = 1;
				bodyhidden();
			} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="048" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle"> 물품(목적물) 수령 여부 (제조+용역)</li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 > 물품(목적물) 수령 여부(제조+용역)</li>
						<p></p>
					</div>	
