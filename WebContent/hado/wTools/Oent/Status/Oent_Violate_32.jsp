...
<script language="JavaScript">
	...
	function goSearch()
	{
		...
		if(nNowProcess == 0) {
			...
			frm.action="Oent_Violate_32_proc.jsp?comm=search";
			frm.submit();
			nNowProcess = 1;
			bodyhidden();
		} else {
	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="contents">
				...
				<jsp:param value="063" name="sel"/>
				</jsp:include>
				<!-- End Left-menu -->

				<div id="divContent">
					<div id="searchContent">
						<li class="subtitle">수급사업자와의 하도급대금 인상요청에 따른 수용 정도 </li>
						<li class="whereiam">HOME > 원사업자 > 조사결과분석 > 수급사업자와의 하도급대금 인상요청에 따른 수용 정도 </li>
						<p></p>
					</div>	
