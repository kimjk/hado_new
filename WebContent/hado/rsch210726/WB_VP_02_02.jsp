...
* 2015-05-12    정광식  조사대상 업체 라디어박스 선택해제 기능 추가 (javascript)
* 2015-05-18    강슬기  내부관리툴에서 파일 업로드 제한
* 2015-12-30    정광식  DB변경으로 인한 인코딩 변경
* 2016-04-11    박원영  우편번호 5자리 변경으로 input창 수정
...
String sOentYearSale1 = "0";    // 연간매출액 (조사년도-3)
String sOentYearSale2 = "0";    // 연간매출액 (조사년도-2)
String sOentYearSale3 = "0";    // 연간매출액 (조사년도-1)
...
<head>
  ...
  <![endif]-->
    ...
    function savef() {
      ...
      researchf(main.q3_10,1,"회사개요의 3번 <%= nCurrentYear-3%>년 시공능력평가액을 입력해주세요");
      researchf(main.q3_11,1,"회사개요의 3번 <%= nCurrentYear-2%>년 시공능력평가액을 입력해주세요");
      researchf(main.q3_12,1,"회사개요의 3번 <%= nCurrentYear-1%>년 시공능력평가액을 입력해주세요");
      ...
      if(msg=="") {
        if(confirm("[ 회사개요를 저장합니다. ]\n\n접속자가 많을경우 다소 시간이 걸릴수도 있습니다.\n정상적으로 저장이 안될경우\n수십분후에 다시시도하여 주십시오.\n\n서버의 부하로 저장에 실패할경우\n응답하신 조사내용을 복구할 수 없습니다.\n응답하신 조사표를 인쇄하여 보관하시고\n오류페이지에서 마우스오른쪽 버튼을 눌러\n새로고침을 선택하여 재저장을 시도하십시오.\n\n확인을 누르시면 저장합니다.")) {
          ...
          main.action = "WB_CP_Research_Qry.jsp?type=Const&step=Basic";
          main.submit();
        }
      } else {
        alert(msg+"\n\n저장이 취소되었습니다.")
...
<body onload="onDocument();">
  ...
  <div id="wrapper">
    ...
    <div id="subheader">
      <ul class="lt">
        <li class="fl"><a href="#none" onfocus="this.blur()"><img src="img/logo.jpg" width="242" height="55"></img></a></li>
        <li class="fr">
          <ul class="lt">
    ...
    <div class="fc"></div>
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          <ul class="clt">
            ...
            <li><input type="radio" name="q0" value="1" <%if(sOentNoExcept.equals("1")){out.print("checked");}%>></input> 1. ‘원사업자’ 요건에 해당하지 않는 경우</li>
            <li><input type="radio" name="q0" value="2" <%if(sOentNoExcept.equals("2")){out.print("checked");}%>></input> 2. 하도급거래가 없거나 하도급을 받기만 하는 경우</li>
            <li><input type="radio" name="q0" value="3" <%if(sOentNoExcept.equals("3")){out.print("checked");}%>></input> 3. “채무자회생 및 파산에 관한법률”에 의한 회생절차 또는 기업개선작업(work-out)이 진행 중인 경우</li>
            <li><input type="radio" name="q0" value="4" <%if(sOentNoExcept.equals("4")){out.print("checked");}%>></input> 4. 부도나 영업중단 또는 폐업한 경우</li>
            <li><input type="radio" name="q0" value="5" <%if(sOentNoExcept.equals("5")){out.print("checked");}%>></input> 5. 다른 회사에 흡수합병된 경우</li>
                  <li><input type="radio" name="q0" value="6" <%if(sOentNoExcept.equals("6")){out.print("checked");}%>></input> 6. 2020년 전체 하도급거래에 대해 별도의 공정위 직권조사를 받았거나 받고 있는 경우</li>      
                        <li></li>
        ...
        <div class="boxcontentright">
          <ul class="lt">
            <li>
              ...
              <%-- <input type="radio" name="q2" value="4" <%if(sOentCapa!=null && sOentCapa.equals("4")){out.print("checked");}%>></input> 4. 기타(<input type="text" name="q2Etc" value="<%=sOentCapaTxt%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li> --%>
            </li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="clt">
            <li class="boxcontenttitle"><span>3. </span>귀사의 지난 3년간(<%=nCurrentYear-3%>년~<%=nCurrentYear-1%>년) 매출액, 영업비용, 자산총액을 응답해주십시오.</li>
            ...
            <li class="boxcontentsubtitle">* 시공능력평가액의 경우, 등록(또는 면허)된 공종별 시공능력평가액을 모두 합산</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li>
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr align="center">
                    <th><%= nCurrentYear-3%>년도</th>
                    <td height="40" valign="top"><input type="text" name="q3_10" value="<%=sOentConstAppr01%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount0010');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount0010" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= nCurrentYear-2%>년도</th>
                    <td height="40" valign="top"><input type="text" name="q3_11" value="<%=sOentConstAppr02%>" onKeyUp="sukeyup(this); amountToHangul(this,'hanAmount0011');" maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
                      <div id="hanAmount0011" style="color:#ff6600; font-weight:bold; text-align:left;"></div>
                    </td>
                  </tr>
                  <tr align="center">
                    <th><%= nCurrentYear-1%>년도</th>
                    <td height="40" valign="top"><input type="text" name="q3_12" value="<%=sOentConstAppr03%>" onkeyup ="sukeyup(this); amountToHangul(this,'hanAmount0012');"  maxlength="13" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';" ></input> 백만원
