					...
					<ul class="lt">
						...
						<li class="boxcontentsubtitle">
						  <a href="http://pf.kakao.com/_xjYjxfs/chat">
						    <img src="./img/qr_cord.png" alt="카카오톡 상담하기"/>
						  </a>
						</li>
						<li><span>카카오톡 상담톡 연결</span></li>
					</ul>
				</div>
				<div class="boxcontentright">
					<ul class="clt">
						...
						<li><br/></li>
						<li><span>▶</span> 조사 대상이 되지 않는 경우, <strong>「회사 개요」부분까지 입력</strong>하고, 조사제외 대상임을 입증할 수 있는 <strong>증빙자료(PDF파일)를 사이트에 업로드</strong>하신 후, <strong>「3. 하도급거래상황」의 5번문항(하도급거래형태)에 "다. 하도급거래를 하지 않음"을 선택하고 저장</strong>, <strong>&lt;조사표 전송&gt; 메뉴를 실행</strong>하여 주시기 바랍니다.</li>
						<li><br/></li>
