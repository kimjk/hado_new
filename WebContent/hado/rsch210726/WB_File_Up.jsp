...
<form name="upform" action="WB_Upload_Qry.jsp" method="post" enctype="multipart/form-data">

<h1 style="margin:10px; padding-left:15px; background-color:#D0D7E5; color:#666; font:bold 18px/2 굴림, Dotum;">수급사업자명부 업로드</h1>
