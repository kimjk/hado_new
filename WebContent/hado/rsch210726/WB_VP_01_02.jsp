    ...
    function savef() {
      ...
      if(msg=="") {
        if(confirm("[ 회사개요를 저장합니다. ]\n\n접속자가 많을경우 다소 시간이 걸릴수도 있습니다.\n정상적으로 저장이 안될경우\n수십분후에 다시시도하여 주십시오.\n\n서버의 부하로 저장에 실패할경우\n응답하신 조사내용을 복구할 수 없습니다.\n응답하신 조사표를 인쇄하여 보관하시고\n오류페이지에서 마우스오른쪽 버튼을 눌러\n새로고침을 선택하여 재저장을 시도하십시오.\n\n확인을 누르시면 저장합니다.")) {
          ...
          main.action = "WB_CP_Research_Qry.jsp?type=Prod&step=Basic";
          main.submit();
        }
      } else {
        alert(msg+"\n\n저장이 취소되었습니다.")
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  <tr>
                    ...
                    - <%=nCurrentYear-2%>년도 손익계산서 (제조, 용역 업종)<br/>
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          ...
          <ul class="lt">
            ...
            <li><input type="radio" name="q1" value="3" <%if(sCompStatus!=null && sCompStatus.equals("3")){out.print("checked");}%> onclick="chkCompStatus();"></input> 3. 영업중단 중 또는 폐업준비 중</li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="clt">
            ...
            <li class="boxcontentsubtitle">* 영업비용은 매출원가, 인건비, 임차료, 세금과공과, 감가삼각비 등 생산활동에 소용된 비용을 포괄하며, 손익계산서 상 매출원가와 판매비및관리비의 합으로 계산함.</li>
            <li class="boxcontentsubtitle">* 영업비용의 경우 경제와 관련된 조사들에 대부분 포함되는 질문임. 업계전반을 살피는 목적으로(업황을 파악하는 목적)으로 사용될 예정임.(하도급법 위반과는 상관없음)</li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="clt">
            ...
            <li class="boxcontentsubtitle">* 상용 근로자 : 계약기간이 1년 이상 또는 무기 계약 중인 근로자로서 원천징수 이행상황 신고서상의 근로소득 간이세액(A01)의 총인원</li>
