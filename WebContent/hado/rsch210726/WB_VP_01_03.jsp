...
*   2018-06-26  김보선   research2f 체크시 문항의 -1, -2가 붙은 문항 예외처리
*   2019-06-07  김성연       22번 목차 삭제 - 목차만 삭제하여 뒷번호 당겼지만 항목에 대한 번호는 기존 그대로 유지 즉 24번 목차가 23되었지만 VALUE KEY는 그대로 24로 진행
*   2021-07-24  정용덕       8번 문항 선택 방식 변경 - 입력 -> 선택
*/
%>
<%@ page import="java.io.*"%>
  ...
  <![endif]-->
    ...
    function savef() {
      ...
      if( main.q2_5_1[2].checked==true ) {
        ...
        initf(main, 21, 1, 3, 4); initf(main, 21, 19, 1, 0);  initf(main, 21, 2, 2, 0); initf(main, 20, 21, 1, 0);
        initf(main, 21, 22, 1, 0);  initf(main, 21, 23, 1, 0);  initf(main, 21, 24, 1, 0);  initf(main, 21, 25, 1, 0);
        initf(main, 21, 26, 1, 0);  initf(main, 21, 27, 1, 0);  initf(main, 21, 28, 1, 0);  initf(main, 21, 31, 1, 0);
        initf(main, 21, 32, 1, 0);  initf(main, 21, 33, 1, 0);  initf(main, 21, 34, 1, 0);  initf(main, 21, 35, 1, 0);
        initf(main, 21, 36, 1, 0);  initf(main, 21, 37, 1, 0);  initf(main, 21, 41, 2, 0);  initf(main, 21, 42, 2, 0);
        initf(main, 21, 43, 2, 0);  initf(main, 21, 44, 2, 0);  initf(main, 21, 45, 2, 0);  initf(main, 21, 46, 2, 0);
        initf(main, 21, 47, 2, 0);  initf(main, 21, 48, 2, 0);  initf(main, 21, 49, 2, 0);  initf(main, 21, 7, 2, 0);
        initf(main, 21, 8, 2, 0); initf(main, 21, 9, 3, 5); initf(main, 21, 18, 1, 0);  initf(main, 21, 10, 2, 0);
        initf(main, 21, 11, 3, 8);  initf(main, 21, 17, 1, 0);  initf(main, 21, 12, 2, 0);  initf(main, 21, 13, 3, 11);
        initf(main, 21, 16, 1, 0);
      
      }
      else {
        
        if( main.q2_5_1[0].checked==true ) research2f_txt(main, 6, 1, 1, 0, '2018년도 하도급을 받은 금액');
        if( main.q2_5_1[0].checked==true ) research2f_txt(main, 6, 2, 1, 0, '2019년도 하도급을 받은 금액');
        if( main.q2_5_1[0].checked==true ) research2f_txt(main, 6, 3, 1, 0, '2020년도 하도급을 받은 금액');
        ...
        research2f(main, 21, 1, 3, 4);
        research2f(main, 21, 2, 2, 0);
        research2f_txt(main, 22, 20, 2, 0, '(1) 3배 손해배상제 적용대상 확대');
    research2f_txt(main, 22, 21, 2, 0, '(2) 부당특약 금지');
    research2f_txt(main, 22, 22, 2, 0, '(3) 하도급대금 지급보증 제도 보완 ');
    research2f_txt(main, 22, 23, 2, 0, '(4) 중소기업협동조합에 납품단가조정협의권을 부여');
    research2f_txt(main, 22, 24, 2, 0, '(5) 조사개시 전 법위반 행위 자진시정 시 제재 면제');
    research2f_txt(main, 22, 25, 2, 0, '(6) 중견기업의 수급사업자 보호대상 포함');
    research2f_txt(main, 22, 26, 2, 0, '(7) 신고포상금 지급');
    research2f_txt(main, 22, 27, 2, 0, '(8) 조사개시 후 대금 미지급 자진시정 시 벌점 부과 면제');
    research2f_txt(main, 22, 28, 2, 0, '(9) 단순기술 유출도 위법행위로 인정');
    research2f_txt(main, 22, 29, 2, 0, '(10) 기술탈취 행위에 대한 조사시효를 3년에서 7년으로 연장 답');
    research2f_txt(main, 22, 30, 2, 0, '(11) 경영정보 요구 금지, 특정 사업자와 거래유도 금지, 기술 수출 제한 행위 금지 답');
        ...
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 21, 1, 0); else research3f_txt(main, 21, 21, 1, 0, 21, 2, '(3)문항의 대형마트에 하도급을 준 금액');
        
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 22, 1, 0); else research3f_txt(main, 21, 22, 1, 0, 21, 2, '(3)문항의 SSM에 하도급을 준 금액');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 23, 1, 0); else research3f_txt(main, 21, 23, 1, 0, 21, 2, '(3)문항의 편의점에 하도급을 준 금액');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 24, 1, 0); else research3f_txt(main, 21, 24, 1, 0, 21, 2, '(3)문항의 기타 업태에 하도급을 준 금액');
        
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 25, 1, 0); else research3f_txt(main, 21, 25, 1, 0, 21, 2, '(4)문항의 하도급을 준 대형마트 수');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 26, 1, 0); else research3f_txt(main, 21, 26, 1, 0, 21, 2, '(4)문항의 하도급을 준 SSM 수');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 27, 1, 0); else research3f_txt(main, 21, 27, 1, 0, 21, 2, '(4)문항의 하도급을 준 편의점 수');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 28, 1, 0); else research3f_txt(main, 21, 28, 1, 0, 21, 2, '(4)문항의 하도급을 준 기타 업태 수');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 31, 1, 0); else research3f_txt(main, 21, 31, 1, 0, 21, 2, '(5)문항의 10%이상 인하한 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 32, 1, 0); else research3f_txt(main, 21, 32, 1, 0, 21, 2, '(5)문항의 5~10%미만 인하한 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 33, 1, 0); else research3f_txt(main, 21, 33, 1, 0, 21, 2, '(5)문항의 0~5%미만 인하한 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 34, 1, 0); else research3f_txt(main, 21, 34, 1, 0, 21, 2, '(5)문항의 변화 없는 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 35, 1, 0); else research3f_txt(main, 21, 35, 1, 0, 21, 2, '(5)문항의 0~5%미만 인상한 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 36, 1, 0); else research3f_txt(main, 21, 36, 1, 0, 21, 2, '(5)문항의 5~10%미만 인상한 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 37, 1, 0); else research3f_txt(main, 21, 37, 1, 0, 21, 2, '(5)문항의 10%이상 인상한 비중');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 41, 2, 0); else research3f_txt(main, 21, 41, 2, 0, 21, 2, '(6)문항의 1)귀사의 인건비 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 42, 2, 0); else research3f_txt(main, 21, 42, 2, 0, 21, 2, '(6)문항의 2)귀사가 구입한 원자재 가격 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 43, 2, 0); else research3f_txt(main, 21, 43, 2, 0, 21, 2, '(6)문항의 3)수급사업자의 생산성 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 44, 2, 0); else research3f_txt(main, 21, 44, 2, 0, 21, 2, '(6)문항의 4)수급사업자의 인건비 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 45, 2, 0); else research3f_txt(main, 21, 45, 2, 0, 21, 2, '(6)문항의 5)수급사업자가 구입한 원자재 가격 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 46, 2, 0); else research3f_txt(main, 21, 46, 2, 0, 21, 2, '(6)문항의 6)발주(구매)한 물량 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 47, 2, 0); else research3f_txt(main, 21, 47, 2, 0, 21, 2, '(6)문항의 7)환율 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 48, 2, 0); else research3f_txt(main, 21, 48, 2, 0, 21, 2, '(6)문항의 8)시장 가격경쟁 정도 변화 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 49, 2, 0); else research3f_txt(main, 21, 49, 2, 0, 21, 2, '(6)문항의 9)기타 고려 정도');
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 7, 2, 0); else research3f(main, 21, 7, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 8, 2, 0); else research3f(main, 21, 8, 2, 0, 21, 2);
        
        if( main.q2_21_2[1].checked==true ) {
          initf(main, 21, 9, 3, 5);
        }
        else {
          if( main.q2_21_8[0].checked==true ) initf(main, 21, 9, 3, 5); else research3f(main, 21, 9, 3, 5, 21, 2);
        } 
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 10, 2, 0); else research3f(main, 21, 10, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) {
          initf(main, 21, 11, 3, 8);
        }
        else {
          if( main.q2_21_10[0].checked==true ) initf(main, 21, 11, 3, 8); else research3f(main, 21, 11, 3, 8, 21, 2);
        }
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 12, 2, 0); else research3f(main, 21, 12, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) {
          initf(main, 21, 13, 3, 11);
        }
        else {
          if( main.q2_21_12[0].checked==true ) initf(main, 21, 13, 3, 11); else research3f(main, 21, 13, 3, 11, 21, 2);
        } 
      ...
      if(msg == "") {
        if(confirm("[ 조사표내용을 저장합니다. ]\n\n접속자가 많을경우 다소 시간이 걸릴수도 있습니다.\n정상적으로 저장이 안될경우\n수십분후에 다시시도하여 주십시오.\n\n서버의 부하로 저장에 실패할경우\n응답하신 조사내용을 복구할 수 없습니다.\n응답하신 조사표를 인쇄하여 보관하시고\n오류페이지에서 마우스오른쪽 버튼을 눌러\n새로고침을 선택하여 재저장을 시도하십시오.\n\n확인을 누르시면 저장합니다.")) {
          ...
          main.action = "WB_CP_Research_Qry.jsp?type=Prod&step=Detail";
          main.submit();
        }
      } else {
        alert(msg + "\n\n저장이 취소되었습니다.")
    ...
    function savef2(main) {
      ...
      if( confirm("[임시저장] 기능은 여러번 나누어서 응답하기 위한 기능입니다.\n\n조사표를 마무리 하기 위해서는 꼭 [저 장] 기능을 이용하셔야 하며,\n[저 장] 기능을 사용하지 않을 경우 [조사표 전송]이 안되오니\n조사표 응답을 완료할때는 필히 [저 장] 기능을 이용하셔야 합니다.\n\n확인을 누르시면 [임시저장] 기능을 실행합니다.") ) {
        ...
        main.target = "ProceFrame";
        main.action = "WB_CP_Research_Qry.jsp?type=Prod&step=Temp";
        main.submit();
      }
    }
    ...
    function relationf(main) {
      ...
      if( main.q2_5_1[2].checked==true ) {
        ...
        research3f(main, 21, 1, 3, 4, 5, 1);  //research3f(main, 21, 19, 1, 0, 5, 1); 
        research3f(main, 21, 2, 2, 0, 5, 1);  
        //research3f(main, 20, 21, 1, 0, 5, 1);
        research3f(main, 21, 22, 1, 0, 5, 1); 
        research3f(main, 21, 23, 1, 0, 5, 1); 
        research3f(main, 21, 24, 1, 0, 5, 1); 
        research3f(main, 21, 25, 1, 0, 5, 1);
        research3f(main, 21, 26, 1, 0, 5, 1); 
        research3f(main, 21, 27, 1, 0, 5, 1); 
        research3f(main, 21, 28, 1, 0, 5, 1); 
        
        research3f(main, 21, 31, 1, 0, 5, 1); research3f(main, 21, 32, 1, 0, 5, 1); research3f(main, 21, 33, 1, 0, 5, 1); research3f(main, 21, 34, 1, 0, 5, 1); 
        research3f(main, 21, 35, 1, 0, 5, 1); research3f(main, 21, 36, 1, 0, 5, 1); research3f(main, 21, 37, 1, 0, 5, 1); 
        
        research3f(main, 21, 41, 2, 0, 5, 1); research3f(main, 21, 42, 2, 0, 5, 1); research3f(main, 21, 43, 2, 0, 5, 1); research3f(main, 21, 44, 2, 0, 5, 1); 
        research3f(main, 21, 45, 2, 0, 5, 1); research3f(main, 21, 46, 2, 0, 5, 1); research3f(main, 21, 47, 2, 0, 5, 1); research3f(main, 21, 48, 2, 0, 5, 1); 
        research3f(main, 21, 49, 2, 0, 5, 1); 
        
        research3f(main, 21, 7, 2, 0, 5, 1); research3f(main, 21, 8, 2, 0, 5, 1); research3f(main, 21, 9, 3, 5, 5, 1);
        
        //research3f(main, 21, 18, 1, 0, 5, 1); 
        research3f(main, 21, 10, 2, 0, 5, 1);
        research3f(main, 21, 11, 3, 8, 5, 1); 
        //research3f(main, 21, 17, 1, 0, 5, 1); 
        research3f(main, 21, 12, 2, 0, 5, 1); 
        research3f(main, 21, 13, 3, 11, 5, 1);
        //research3f(main, 21, 16, 1, 0, 5, 1); 
        ...
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 21, 1, 0); else research3f(main, 21, 21, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 22, 1, 0); else research3f(main, 21, 22, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 23, 1, 0); else research3f(main, 21, 23, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 24, 1, 0); else research3f(main, 21, 24, 1, 0, 21, 2);
        
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 25, 1, 0); else research3f(main, 21, 25, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 26, 1, 0); else research3f(main, 21, 26, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 27, 1, 0); else research3f(main, 21, 27, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 28, 1, 0); else research3f(main, 21, 28, 1, 0, 21, 2);
        
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 31, 1, 0); else research3f(main, 21, 31, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 32, 1, 0); else research3f(main, 21, 32, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 33, 1, 0); else research3f(main, 21, 33, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 34, 1, 0); else research3f(main, 21, 34, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 35, 1, 0); else research3f(main, 21, 35, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 36, 1, 0); else research3f(main, 21, 36, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 37, 1, 0); else research3f(main, 21, 37, 1, 0, 21, 2);
        
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 41, 2, 0); else research3f(main, 21, 41, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 42, 2, 0); else research3f(main, 21, 42, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 43, 2, 0); else research3f(main, 21, 43, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 44, 2, 0); else research3f(main, 21, 44, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 45, 2, 0); else research3f(main, 21, 45, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 46, 2, 0); else research3f(main, 21, 46, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 47, 2, 0); else research3f(main, 21, 47, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 48, 2, 0); else research3f(main, 21, 48, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 49, 2, 0); else research3f(main, 21, 49, 2, 0, 21, 2);
        
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 7, 2, 0); else research3f(main, 21, 7, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 8, 2, 0); else research3f(main, 21, 8, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 9, 3, 5); else research3f(main, 21, 9, 3, 5, 21, 2);
        
        //if( main.q2_21_2[1].checked==true ) initf(main, 21, 18, 1, 0); else research3f(main, 21, 18, 1, 0, 21, 2);  
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 10, 2, 0); else research3f(main, 21, 10, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 11, 3, 8); else research3f(main, 21, 11, 3, 8, 21, 2);
        //if( main.q2_21_2[1].checked==true ) initf(main, 21, 17, 1, 0); else research3f(main, 21, 17, 1, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 12, 2, 0); else research3f(main, 21, 12, 2, 0, 21, 2);
        if( main.q2_21_2[1].checked==true ) initf(main, 21, 13, 3, 11); else research3f(main, 21, 13, 3, 11, 21, 2);
        //if( main.q2_21_2[1].checked==true ) initf(main, 21, 16, 1, 0); else research3f(main, 21, 16, 1, 0, 21, 2);
        
        if( main.q2_21_8[0].checked==true ) initf(main, 21, 9, 3, 5); else research3f(main, 21, 9, 3, 5, 21, 8);
        //if( main.q2_21_8[0].checked==true ) initf(main, 21, 18, 1, 0); else research3f(main, 21, 18, 1, 0, 21, 8);
        
        if( main.q2_21_10[0].checked==true ) initf(main, 21, 11, 3, 8); else research3f(main, 21, 11, 3, 8, 21, 10);
        //if( main.q2_21_10[0].checked==true ) initf(main, 21, 17, 1, 0); else research3f(main, 21, 17, 1, 0, 21, 10);
        
        if( main.q2_21_12[0].checked==true ) initf(main, 21, 13, 3, 11); else research3f(main, 21, 13, 3, 11, 21, 12);
        //if( main.q2_21_12[0].checked==true ) initf(main, 21, 16, 1, 0); else research3f(main, 21, 16, 1, 0, 21, 12);
...
//alert("fno ==============>> " + fno + "  sno ===========>> " + sno + "  type=====>> "+ type + "    ccheck =====>>>" + ccheck);
      if(ccheck=="no") {
        msg=msg+"\n";
...
//alert("값:"+obj+"/"+fno+"/"+sno+"타입:"+type);
    ...
    function onDocument() {
      ...
      fn_hap21_4(document.info);
      fn_hap21_5(document.info);
    ...
    function fn_hap21_4(main) {
      main.allSum21_4.value
      =Cnum(main.q2_21_25.value)
      +Cnum(main.q2_21_26.value)
      +Cnum(main.q2_21_27.value)
      +Cnum(main.q2_21_28.value);
    }
    function fn_hap21_5(main) {
        var total;
        total = Cnum(main.q2_21_31.value)
               +Cnum(main.q2_21_32.value)
               +Cnum(main.q2_21_33.value)
               +Cnum(main.q2_21_34.value)
               +Cnum(main.q2_21_35.value)
               +Cnum(main.q2_21_36.value)
               +Cnum(main.q2_21_37.value);
        main.allSum21_5.value = Cnum(total.toFixed(1));
...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="subheader">
      <ul class="lt">
        <li class="fl">
                    <a href="#none" onfocus="this.blur()"><img src="img/logo.jpg" width="242" height="55" /></a>
                </li>
        <li class="fr">
          <ul class="lt">
    ...
    <div id="subcontent">
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          <ul class="clt"><!-- 여기 -->
            ...
            <li><a href="#mokcha2" class="contentbutton3">11. 하도급 계약 체결 시, 하도급 거래 단가의 결정에 관하여</a></li>
            <li><a href="#mokcha3" class="contentbutton3">12. 제조 위탁의 취소 및 변경에 관하여</a></li>
            ...
            <li><a href="#mokcha12" class="contentbutton3">21. PB제품 거래에 관하여</a></li>
            <li><a href="#mokcha13" class="contentbutton3">22. 새로 도입된 제도에 대한 인지도</a></li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          ...
          <ul class="lt">
            <li><input type="radio" name="q2_5_1" value="1" <%if(qa[5][1][1]!=null && qa[5][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(5,1);"></input> 가. 하도급을 주기도 하고 받기도 함<span class="boxcontentsubtitle">문6으로</span></li>
            ...
            <li>
              <table class="tbl_blue">
                ...
                <tbody>
                  <tr>
                    <th>구분</th>
                    <th>원(상위) 사업자에게 하도급을 받은 금액<br/>[VAT 포함 금액]</th>
                  </tr>
                  <tr>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="clt">
            <li class="boxcontenttitle"><span>8. </span><%= nCurrentYear-1%>년도에 귀사는 수급사업자에게 '하도급을 준' 금액의 단계별 비중을 응답해 주십시오.</li>
            <li class="boxcontentsubtitle">* [보기] 완성품 제조업체 -> 1차 협력업체 -> 2차 협력업체 -> 3차 협력업체 -> 4차 협력업체 등</li>
            <li class="boxcontentsubtitle">* 귀사가 하도급을 주기만 한 경우 귀사는 완성품 제조업체에 해당</li>
            <li class="boxcontentsubtitle">* 귀사가 완성품 제조업체로부터 하도급을 받아 수급사업자에게 하도급을 준 경우 귀사는 1차 협력업체에 해당</li>
        ...
        <div class="boxcontentright">
          <ul class="lt">
            ...
            <li><input type="radio" name="q2_8_1" value="1" <%if(qa[8][1][1]!=null && qa[8][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(8,1);"></input> 가. 완성품 제조업체</li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도 선정한 수급사업자 중 경쟁입찰 방식은 통해 선정한 비율은 어떻게 됩니까?</li>
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          ...
          <ul class="lt">
            <li><input type="radio" name="q2_10_5" value="1" <%if(qa[10][5][1]!=null && qa[10][5][1].equals("1")){out.print("checked");}%> onclick="checkradio(10,5);"></input> 가. 100% (전부 서면계약)<span class="boxcontentsubtitle">문11-1로</span></li>
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          <li class="noneboxcontenttitle"><a name="mokcha2">11. 하도급계약 체결 시, 하도급거래 단가의 결정에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
          <li class="boxcontentsubtitle">※ 문11-1에서 문11-3은 하도급 계약 체결 시, 하도급 거래 단가의 결정에 관한 질문입니다.</li>
        </ul>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(1) </span> 귀사가  <%= nCurrentYear-1%>년도에 수급사업자와 맺은 하도급거래 단가는 <%= nCurrentYear-2%>년도 단가에 비해 어느 정도 변동되었습니까? 단가 변동의 정도에 해당되는 하도급 계약 건수의 비중을 기입하여 주십시오.</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
            ...
            <li>
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr>
                    <th style="text-align: left;">2) 귀사가 구입한 원자재 가격 변화</th>
                    <td style="text-align: center;">
                  ...
                  <tr>
                    <th style="text-align: left;">5) 수급사업자가 구입한 원자재 가격 변화</th>
                    <td style="text-align: center;">
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          <li class="noneboxcontenttitle"><a name="mokcha3">12. 제조 위탁과 취소 및 변경에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
          <li class="boxcontentsubtitle">※ 문12-1에서 문12-2은 제조 위탁의 취소 및 변경에 관한 질문입니다.</li>
        </ul>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(1) </span> <%= nCurrentYear-1%>년도에 귀사가 수급사업자에게 제조 위탁을 한 후, 임의로 위탁을 취소하거나 변경하지 않고 본래의 계약대로 이행한 계약건수의 비율은 어떻게 됩니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(2) </span> 귀사가 임의로 제조 위탁을 취소하거나 변경한 이유는 무엇입니까?</li>
        ...
        <div class="boxcontentright">
          <ul class="lt">
            ...
            <li><input type="checkbox" name="q2_12_2_2" value="1" <%if(qa[12][2][2]!=null && qa[12][2][2].equals("1")){out.print("checked");}%>></input> 나. 귀사의 판매부진</li>
            <li><input type="checkbox" name="q2_12_2_3" value="1" <%if(qa[12][2][3]!=null && qa[12][2][3].equals("1")){out.print("checked");}%>></input> 다. 제품의 사양 변경 또는 모델 단종</li>
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          <li class="noneboxcontenttitle"><a name="mokcha4">13. 물품 수령에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
          <li class="boxcontentsubtitle">※ 문13-1에서 문13-2은 물품 수령에 관한 질문입니다.</li>
        </ul>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도에 제조 위탁한 물품을 수령한 비율은 어떻게 됩니까?</li>
            <li class="boxcontentsubtitle">* 수령 비율 = 100*(수령한 물량/제조위탁한 물량)</li>
          </ul>
        </div>
        <div class="boxcontentright">
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(2) </span> 귀사가 제조 위탁한 물품을 수령하지 않은 이유는 무엇입니까?</li>
            <li class="boxcontentsubtitle">(해당 항목에 모두 선택)</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li><input type="checkbox" name="q2_13_2_1" value="1" <%if(qa[13][2][1]!=null && qa[13][2][1].equals("1")){out.print("checked");}%>></input> 가. 납품 제품이 불량품임</li>
            <li><input type="checkbox" name="q2_13_2_2" value="1" <%if(qa[13][2][2]!=null && qa[13][2][2].equals("1")){out.print("checked");}%>></input> 나. 발주서대로 제조되지 않음</li>
            ...
            <li><input type="checkbox" name="q2_13_2_7" value="1" <%if(qa[13][2][7]!=null && qa[13][2][7].equals("1")){out.print("checked");}%>></input> 사. 사양이 변경되거나 모델이 단종됨</li>
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          ...
          <li class="boxcontentsubtitle">※ 문14-1에서 문14-2은 계약체결 후, 하도급대금 감액에 관한 질문입니다.</li>
        </ul>
      </div>
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          <ul class="lt">
            <li><input type="checkbox" name="q2_14_2_1" value="1" <%if(qa[14][2][1]!=null && qa[14][2][1].equals("1")){out.print("checked");}%>></input> 가. 납품 제품이 불량품임</li>
            <li><input type="checkbox" name="q2_14_2_2" value="1" <%if(qa[14][2][2]!=null && qa[14][2][2].equals("1")){out.print("checked");}%>></input> 나. 발주서대로 제조되지 않음</li>
            ...
            <li><input type="checkbox" name="q2_14_2_4" value="1" <%if(qa[14][2][4]!=null && qa[14][2][4].equals("1")){out.print("checked");}%>></input> 라. 판매부진에 따른 고통분담</li>
            ...
            <li><input type="checkbox" name="q2_14_2_6" value="1" <%if(qa[14][2][6]!=null && qa[14][2][6].equals("1")){out.print("checked");}%>></input> 바. 귀사의 저가수주 또는 염가판매를 반영함</li>
            ...
            <li><input type="checkbox" name="q2_14_2_9" value="1" <%if(qa[14][2][9]!=null && qa[14][2][9].equals("1")){out.print("checked");}%>></input> 자. 원자재 가격의 하락을 반영함</li>
            <li><input type="checkbox" name="q2_14_2_10" value="1" <%if(qa[14][2][10]!=null && qa[14][2][10].equals("1")){out.print("checked");}%>></input> 차. 물품의 판매가격 하락을 반영함</li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            ...
            <li class="boxcontentsubtitle">* 목적물 수령일은 통상 세금계산서 발행일을 기준으로 함.</li>
          </ul>
        </div>
        <div class="boxcontentright">
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            ...
            <li class="boxcontentsubtitle">* 동일 수급사업자가 하도급대금 조정 신청(A)을 한 후 중소기업 협동조합을 통하여 대금 조정을 재신청(B)한 경우는 , 후자(B)의 조정신청 건수로만 계산</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            ...
            <li class="boxcontentsubtitle">* 특약은 하도급 본 계약서 내용 외에 클레임 약정서 등 계약상 권리·의무 관계를 추가로 기재한 서면 등을 말함.</li>
          </ul>
        </div>
        <div class="boxcontentright">
          ...
          <ul class="lt">
            ...
            <li><input type="radio" name="q2_18_1" value="2" <%if(qa[18][1][2]!=null && qa[18][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(18,1);"></input> 나. 없다<span class="boxcontentsubtitle">문19-1로</span></li>
          </ul>
          <div class="fc pt_50"></div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(1) </span> 귀사는  <%= nCurrentYear-1%>년도에 수급사업자에게 기술 자료를 요청한 적이 있습니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(5) </span> 귀사가 기술자료 요청 시 사용한 서면자료 양식은 무엇입니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          ...
          <ul class="lt">
            ...
            <li><input type="radio" name="q2_19_7" value="2" <%if(qa[19][7][2]!=null && qa[19][7][2].equals("1")){out.print("checked");}%> onclick="checkradio(19,7);"></input> 나. 서면발급이 필요한 사항인지 불분명하여서</li>
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          <li class="noneboxcontenttitle"><a name="mokcha12">21. PB제품 거래에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
          <li class="boxcontentsubtitle">※ 문21-1에서 문21-13은 PB제품 거래에 관한 질문입니다.</li>
        </ul>
      </div>
      
      <div class="boxcontent2">
        <ul class="boxcontenthelp lt">
          <li class="boxcontenttitle"> ※ 본 항목은 <u>귀사가 대형마트, SSM(기업형 슈퍼마켓), 편의점 분야의 원사업자인 경우에 한하여, <%= nCurrentYear-1%>년도 PB제품 관련 하도급거래에 관해 응답</u><br/>하시기 바랍니다.<br/>
          </li>
        </ul>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(1) </span> 귀사가 속한 업태는 무엇입니까?</li>
            <li class="boxcontentsubtitle">(복수선택 가능)</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li><input type="checkbox" name="q2_21_1_1" value="1" <%if(qa[21][1][1]!=null && qa[21][1][1].equals("1")){out.print("checked");}%>></input> 가. 대형마트</li>
            <li><input type="checkbox" name="q2_21_1_2" value="1" <%if(qa[21][1][2]!=null && qa[21][1][2].equals("1")){out.print("checked");}%>></input> 나. SSM(기업형 슈퍼마켓)</li>
            <li><input type="checkbox" name="q2_21_1_3" value="1" <%if(qa[21][1][3]!=null && qa[21][1][3].equals("1")){out.print("checked");}%>></input> 다. 편의점</li>
            <li><input type="checkbox" name="q2_21_1_4" value="1" <%if(qa[21][1][4]!=null && qa[21][1][4].equals("1")){out.print("checked");}%>></input> 라. 기타 (<input type="text" name="q2_21_19" value="<%=qa[21][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(2) </span> 귀사는 <%= nCurrentYear-1%>년도에 원사업자로서 PB제품 제조를 위탁하였습니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
          ...
          <ul class="lt">
            <li><input type="radio" name="q2_21_2" value="1" <%if(qa[21][2][1]!=null && qa[21][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,2);"></input> 가. 예<span class="boxcontentsubtitle">문21-3으로</span></li>
            <li><input type="radio" name="q2_21_2" value="2" <%if(qa[21][2][2]!=null && qa[21][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,2);"></input> 나. 아니요<span class="boxcontentsubtitle">문22로</span></li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(3) </span> 귀사가 <%= nCurrentYear-1%>년도 수급사업자에게 PB제품을 제조위탁한 금액은 얼마입니까?</li>
            <li class="boxcontentsubtitle">* 업태를 복수로 선택한 경우, 각 업태별로 입력</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li>
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr>
                    <th>대형마트</th>
                    <td><input type="text" name="q2_21_21" value="<%=qa[21][21][20]%>" onKeyUp="sukeyup(this);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 백만원</td>
                  </tr>
                  <tr>
                    <th>SSM(기업형 슈퍼마켓)</th>
                    <td><input type="text" name="q2_21_22" value="<%=qa[21][22][20]%>" onKeyUp="sukeyup(this);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 백만원</td>
                  </tr>
                  <tr>
                    <th>편의점</th>
                    <td><input type="text" name="q2_21_23" value="<%=qa[21][23][20]%>" onKeyUp="sukeyup(this);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 백만원</td>
                  </tr>
                  <tr>
                    <th>기타</th>
                    <td><input type="text" name="q2_21_24" value="<%=qa[21][24][20]%>" onKeyUp="sukeyup(this);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 백만원</td>
                  </tr>
                </tbody>
              </table>
            </li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(4) </span> 귀사가 <%= nCurrentYear-1%>년도에 PB제품을 제조위탁한 수급 사업자 수는 몇 개사입니까?</li>
            <li class="boxcontentsubtitle">* 업태를 복수로 선택한 경우, 각 업태별로 입력</li>
          </ul>
        </div>
        <div class="boxcontentright">
            ...
            <li>
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr>
                    <th>전체</th>
                    <td><input type="text" readonl체="readonly" name="allSum21_4" value="" size="30" class="text06"></input> 개사</td>
                  </tr>
                  <tr>
                    <th>대형마트</th>
                    <td><input type="text" name="q2_21_25" value="<%=qa[21][25][20]%>" onKeyUp="sukeyup(this); fn_hap21_4(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                  </tr>
                  <tr>
                    <th>SSM(기업형 슈퍼마켓)</th>
                    <td><input type="text" name="q2_21_26" value="<%=qa[21][26][20]%>" onKeyUp="sukeyup(this); fn_hap21_4(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                  </tr>
                  <tr>
                    <th>편의점</th>
                    <td><input type="text" name="q2_21_27" value="<%=qa[21][27][20]%>" onKeyUp="sukeyup(this); fn_hap21_4(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                  </tr>
                  <tr>
                    <th>기타</th>
                    <td><input type="text" name="q2_21_28" value="<%=qa[21][28][20]%>" onKeyUp="sukeyup(this); fn_hap21_4(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                  </tr>
                </tbody>
              </table>
            </li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(5) </span> 귀사가 <%= nCurrentYear-1%>년도에 수급사업자와 맺은 PB제품 하도급 거래 단가는 <%= nCurrentYear-2%>년도 단가에 비해 어느 정도 변동되었습니까? 단가 변동의 정도에 해당되는 하도급 계약 건수의 비중을 기입하여 주십시오.</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li>
              <table class="tbl_blue">
                ...
                <tbody>
                  <tr>
                    <th>PB제품 단가 변동의 정도</th>
                    <th>PB제품 하도급 계약 건수의 비중</th>
                  </tr>
                  <tr>
                    <th>전체</th>
                    <td><input type="text" readonly="readonly" name="allSum21_5" value="" size="30" class="text06"></input> %</td>
                  </tr>
                  <tr>
                    <th>10% 이상 인하</th>
                    <td><input type="text" name="q2_21_31" value="<%=qa[21][31][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                  <tr>
                    <th>5~10% 미만 인하</th>
                    <td><input type="text" name="q2_21_32" value="<%=qa[21][32][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                  <tr>
                    <th>1~5% 미만 인하</th>
                    <td><input type="text" name="q2_21_33" value="<%=qa[21][33][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                  <tr>
                    <th>변화 없음</th>
                    <td><input type="text" name="q2_21_34" value="<%=qa[21][34][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                  <tr>
                    <th>0~5% 미만 인상</th>
                    <td><input type="text" name="q2_21_35" value="<%=qa[21][35][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                  <tr>
                    <th>5~10% 미만 인상</th>
                    <td><input type="text" name="q2_21_36" value="<%=qa[21][36][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                  <tr>
                    <th>10% 이상 인상</th>
                    <td><input type="text" name="q2_21_37" value="<%=qa[21][37][20]%>" onKeyUp="sukeyup(this); fn_hap21_5(this.form);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> %</td>
                  </tr>
                </tbody>
              </table>
            </li>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(6) </span> PB제품 하도급 단가 결정에 아래 요인들을 어느 정도 고려하였습니까?</li>
            <li class="boxcontentsubtitle"></li>
              ...
              <table class="tbl_blue">
                ...
                <tbody>
                  ...
                  <tr>
                    <th style="text-align: left;">1) 귀사의 인건비 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_41" value="<%=setHiddenValue(qa, 21, 41, 6)%>"></input>
                      <input type="radio" name="q2_21_41" value="1" <%if(qa[21][41][1]!=null && qa[21][41][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,41);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_41" value="2" <%if(qa[21][41][2]!=null && qa[21][41][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,41);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_41" value="3" <%if(qa[21][41][3]!=null && qa[21][41][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,41);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_41" value="4" <%if(qa[21][41][4]!=null && qa[21][41][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,41);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_41" value="5" <%if(qa[21][41][5]!=null && qa[21][41][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,41);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_41" value="6" <%if(qa[21][41][6]!=null && qa[21][41][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,41);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">2) 귀사가 구입한 원자재 가격 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_42" value="<%=setHiddenValue(qa, 21, 42, 6)%>"></input>
                      <input type="radio" name="q2_21_42" value="1" <%if(qa[21][42][1]!=null && qa[21][42][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,42);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_42" value="2" <%if(qa[21][42][2]!=null && qa[21][42][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,42);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_42" value="3" <%if(qa[21][42][3]!=null && qa[21][42][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,42);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_42" value="4" <%if(qa[21][42][4]!=null && qa[21][42][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,42);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_42" value="5" <%if(qa[21][42][5]!=null && qa[21][42][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,42);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_42" value="6" <%if(qa[21][42][6]!=null && qa[21][42][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,42);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">3) 수급사업자의 생산성 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_43" value="<%=setHiddenValue(qa, 21, 43, 6)%>"></input>
                      <input type="radio" name="q2_21_43" value="1" <%if(qa[21][43][1]!=null && qa[21][43][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,43);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_43" value="2" <%if(qa[21][43][2]!=null && qa[21][43][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,43);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_43" value="3" <%if(qa[21][43][3]!=null && qa[21][43][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,43);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_43" value="4" <%if(qa[21][43][4]!=null && qa[21][43][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,43);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_43" value="5" <%if(qa[21][43][5]!=null && qa[21][43][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,43);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_43" value="6" <%if(qa[21][43][6]!=null && qa[21][43][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,43);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">4) 수급사업자의 인건비 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_44" value="<%=setHiddenValue(qa, 21, 44, 6)%>"></input>
                      <input type="radio" name="q2_21_44" value="1" <%if(qa[21][44][1]!=null && qa[21][44][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,44);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_44" value="2" <%if(qa[21][44][2]!=null && qa[21][44][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,44);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_44" value="3" <%if(qa[21][44][3]!=null && qa[21][44][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,44);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_44" value="4" <%if(qa[21][44][4]!=null && qa[21][44][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,44);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_44" value="5" <%if(qa[21][44][5]!=null && qa[21][44][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,44);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_44" value="6" <%if(qa[21][44][6]!=null && qa[21][44][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,44);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">5) 수급사업자가 구입한 원자재 가격 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_45" value="<%=setHiddenValue(qa, 21, 45, 6)%>"></input>
                      <input type="radio" name="q2_21_45" value="1" <%if(qa[21][45][1]!=null && qa[21][45][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,45);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_45" value="2" <%if(qa[21][45][2]!=null && qa[21][45][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,45);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_45" value="3" <%if(qa[21][45][3]!=null && qa[21][45][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,45);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_45" value="4" <%if(qa[21][45][4]!=null && qa[21][45][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,45);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_45" value="5" <%if(qa[21][45][5]!=null && qa[21][45][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,45);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_45" value="6" <%if(qa[21][45][6]!=null && qa[21][45][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,45);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">6) 발주(구매)한 물량 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_46" value="<%=setHiddenValue(qa, 21, 46, 6)%>"></input>
                      <input type="radio" name="q2_21_46" value="1" <%if(qa[21][46][1]!=null && qa[21][46][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,46);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_46" value="2" <%if(qa[21][46][2]!=null && qa[21][46][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,46);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_46" value="3" <%if(qa[21][46][3]!=null && qa[21][46][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,46);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_46" value="4" <%if(qa[21][46][4]!=null && qa[21][46][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,46);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_46" value="5" <%if(qa[21][46][5]!=null && qa[21][46][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,46);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_46" value="6" <%if(qa[21][46][6]!=null && qa[21][46][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,46);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">7) 환율 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_47" value="<%=setHiddenValue(qa, 21, 47, 6)%>"></input>
                      <input type="radio" name="q2_21_47" value="1" <%if(qa[21][47][1]!=null && qa[21][47][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,47);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_47" value="2" <%if(qa[21][47][2]!=null && qa[21][47][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,47);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_47" value="3" <%if(qa[21][47][3]!=null && qa[21][47][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,47);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_47" value="4" <%if(qa[21][47][4]!=null && qa[21][47][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,47);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_47" value="5" <%if(qa[21][47][5]!=null && qa[21][47][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,47);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_47" value="6" <%if(qa[21][47][6]!=null && qa[21][47][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,47);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">8) 시장 가격경쟁 정도 변화</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_48" value="<%=setHiddenValue(qa, 21, 48, 6)%>"></input>
                      <input type="radio" name="q2_21_48" value="1" <%if(qa[21][48][1]!=null && qa[21][48][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,48);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_48" value="2" <%if(qa[21][48][2]!=null && qa[21][48][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,48);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_48" value="3" <%if(qa[21][48][3]!=null && qa[21][48][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,48);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_48" value="4" <%if(qa[21][48][4]!=null && qa[21][48][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,48);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_48" value="5" <%if(qa[21][48][5]!=null && qa[21][48][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,48);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_48" value="6" <%if(qa[21][48][6]!=null && qa[21][48][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,48);"></input>
                    </td>
                  </tr>
                  <tr>
                    <th style="text-align: left;">9) 기타</th>
                    <td style="text-align: center;">
                      <input type="hidden" name="c2_21_49" value="<%=setHiddenValue(qa, 21, 49, 6)%>"></input>
                      <input type="radio" name="q2_21_49" value="1" <%if(qa[21][49][1]!=null && qa[21][49][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,49);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_49" value="2" <%if(qa[21][49][2]!=null && qa[21][49][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,49);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_49" value="3" <%if(qa[21][49][3]!=null && qa[21][49][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,49);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_49" value="4" <%if(qa[21][49][4]!=null && qa[21][49][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,49);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_49" value="5" <%if(qa[21][49][5]!=null && qa[21][49][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,49);"></input>
                    </td>
                    <td style="text-align: center;">
                      <input type="radio" name="q2_21_49" value="6" <%if(qa[21][49][6]!=null && qa[21][49][6].equals("1")){out.print("checked");}%> onclick="checkradio(21,49);"></input>
                    </td>
                  </tr>
                </tbody>
              </table>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(7) </span>  하도급 단가 결정은 어떻게 이루어졌습니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
          <input type="hidden" name="c2_21_7" value="<%=setHiddenValue(qa, 21, 7, 3)%>"></input>
          <ul class="lt">
            <li><input type="radio" name="q2_21_7" value="1" <%if(qa[21][7][1]!=null && qa[21][7][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,7);"></input> 가. 귀사의 제안과 수급사업자의 수용</li>
            <li><input type="radio" name="q2_21_7" value="2" <%if(qa[21][7][2]!=null && qa[21][7][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,7);"></input> 나. 수급사업자의 제안과 귀사의 수용</li>
            <li><input type="radio" name="q2_21_7" value="3" <%if(qa[21][7][3]!=null && qa[21][7][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,7);"></input> 다. 수차례 협의 과정을 통한 결정</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(8) </span> 귀사가 수급사업자에게 PB제품의 제조 위탁을 한 후, 임의로 위탁을 취소하거나 변경하지 않고 본래의 계약대로 이행한 계약건수의 비율은 어떻게 됩니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
          <input type="hidden" name="c2_21_8" value="<%=setHiddenValue(qa, 21, 8, 5)%>"></input>
          <ul class="lt">
            <li><input type="radio" name="q2_21_8" value="1" <%if(qa[21][8][1]!=null && qa[21][8][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,8);"></input> 가. 100% (전체이행)<span class="boxcontentsubtitle">문21-10으로</span></li>
            <li><input type="radio" name="q2_21_8" value="2" <%if(qa[21][8][2]!=null && qa[21][8][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,8);"></input> 나. 95% ~ 100% 미만 (예외적 경우 제외한 전체이행)</li>
            <li><input type="radio" name="q2_21_8" value="3" <%if(qa[21][8][3]!=null && qa[21][8][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,8);"></input> 다. 75% ~ 95% 미만</li>
            <li><input type="radio" name="q2_21_8" value="4" <%if(qa[21][8][4]!=null && qa[21][8][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,8);"></input> 라. 50% ~ 75% 미만</li>
            <li><input type="radio" name="q2_21_8" value="5" <%if(qa[21][8][5]!=null && qa[21][8][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,8);"></input> 마. 50% 미만</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(9) </span> 귀사가 임의로 PB제품의 제조 위탁을 취소하거나 변경한 이유는 무엇입니까?</li>
            <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li><input type="checkbox" name="q2_21_9_1" value="1" <%if(qa[21][9][1]!=null && qa[21][9][1].equals("1")){out.print("checked");}%>></input> 가. 고객의 주문취소 때문</li>
            <li><input type="checkbox" name="q2_21_9_2" value="1" <%if(qa[21][9][2]!=null && qa[21][9][2].equals("1")){out.print("checked");}%>></input> 나. 우리 회사의 판매부진 때문</li>
            <li><input type="checkbox" name="q2_21_9_3" value="1" <%if(qa[21][9][3]!=null && qa[21][9][3].equals("1")){out.print("checked");}%>></input> 다. 위탁물 수령 이전에 수급사업자의 부도로 정산합의</li>
            <li><input type="checkbox" name="q2_21_9_4" value="1" <%if(qa[21][9][4]!=null && qa[21][9][4].equals("1")){out.print("checked");}%>></input> 라. 수급사업자의 계약불이행 때문</li>
            <li><input type="checkbox" name="q2_21_9_5" value="1" <%if(qa[21][9][5]!=null && qa[21][9][5].equals("1")){out.print("checked");}%>></input> 마. 기타 (<input type="text" name="q2_21_18" value="<%=qa[21][18][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(10) </span> 귀사가 <%= nCurrentYear-1%>년도에 제조 위탁한 PB제품을 수령한 비율은 어떻게 됩니까?</li>
            <li class="boxcontentsubtitle">* 수령 비율 = 100*(수령한 물량/제조위탁한 물량)</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <input type="hidden" name="c2_21_10" value="<%=setHiddenValue(qa, 21, 10, 5)%>"></input>
          <ul class="lt">
            <li><input type="radio" name="q2_21_10" value="1" <%if(qa[21][10][1]!=null && qa[21][10][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,10);"></input> 가. 100% (전체수령)<span class="boxcontentsubtitle">문21-12로</span></li>
            <li><input type="radio" name="q2_21_10" value="2" <%if(qa[21][10][2]!=null && qa[21][10][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,10);"></input> 나. 95% ~ 100% 미만 (예외적 경우 제외한 전체수령)</li>
            <li><input type="radio" name="q2_21_10" value="3" <%if(qa[21][10][3]!=null && qa[21][10][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,10);"></input> 다. 75% ~ 95% 미만</li>
            <li><input type="radio" name="q2_21_10" value="4" <%if(qa[21][10][4]!=null && qa[21][10][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,10);"></input> 라. 50% ~ 75% 미만</li>
            <li><input type="radio" name="q2_21_10" value="5" <%if(qa[21][10][5]!=null && qa[21][10][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,10);"></input> 마. 50% 미만</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(11) </span> 귀사가 제조 위탁한 PB제품을 수령하지 않은 이유는 무엇입니까?</li>
            <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li><input type="checkbox" name="q2_21_11_1" value="1" <%if(qa[21][11][1]!=null && qa[21][11][1].equals("1")){out.print("checked");}%>></input> 가. 납품 제품이 불량품임</li>
            <li><input type="checkbox" name="q2_21_11_2" value="1" <%if(qa[21][11][2]!=null && qa[21][11][2].equals("1")){out.print("checked");}%>></input> 나. 발주서대로 제조되지 않음</li>
            <li><input type="checkbox" name="q2_21_11_3" value="1" <%if(qa[21][11][3]!=null && qa[21][11][3].equals("1")){out.print("checked");}%>></input> 다. 수급사업자의 책임으로 납품이 지연됨</li>
            <li><input type="checkbox" name="q2_21_11_4" value="1" <%if(qa[21][11][4]!=null && qa[21][11][4].equals("1")){out.print("checked");}%>></input> 라. 발주자(고객)가 발주내용을 변경·취소함</li>
            <li><input type="checkbox" name="q2_21_11_5" value="1" <%if(qa[21][11][5]!=null && qa[21][11][5].equals("1")){out.print("checked");}%>></input> 마. 발주자(고객)의 클레임이 발생함</li>
            <li><input type="checkbox" name="q2_21_11_6" value="1" <%if(qa[21][11][6]!=null && qa[21][11][6].equals("1")){out.print("checked");}%>></input> 바. 시장에서 판매실적이 부진함</li>
            <li><input type="checkbox" name="q2_21_11_7" value="1" <%if(qa[21][11][7]!=null && qa[21][11][7].equals("1")){out.print("checked");}%>></input> 사. 사양이 변경되거나 모델이 단종됨</li>
            <li><input type="checkbox" name="q2_21_11_8" value="1" <%if(qa[21][11][8]!=null && qa[21][11][8].equals("1")){out.print("checked");}%>></input> 아. 기타 (<input type="text" name="q2_21_17" value="<%=qa[21][17][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(12) </span> 귀사가 당초 계약할 때 정했던 금액대로 PB제품 하도급대금(단가)을 지급한 비율은 어떻게 됩니까?</li>
            <li class="boxcontentsubtitle"></li>
          </ul>
        </div>
        <div class="boxcontentright">
          <input type="hidden" name="c2_21_12" value="<%=setHiddenValue(qa, 21, 12, 5)%>"></input>
          <ul class="lt">
            <li><input type="radio" name="q2_21_12" value="1" <%if(qa[21][12][1]!=null && qa[21][12][1].equals("1")){out.print("checked");}%> onclick="checkradio(21,12);"></input> 가. 100% (전체지급)<span class="boxcontentsubtitle">문22로</span></li>
            <li><input type="radio" name="q2_21_12" value="2" <%if(qa[21][12][2]!=null && qa[21][12][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,12);"></input> 나. 95% ~ 100% 미만 (예외적 경우 제외한 전체지급)</li>
            <li><input type="radio" name="q2_21_12" value="3" <%if(qa[21][12][3]!=null && qa[21][12][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,12);"></input> 다. 75% ~ 95% 미만</li>
            <li><input type="radio" name="q2_21_12" value="4" <%if(qa[21][12][4]!=null && qa[21][12][4].equals("1")){out.print("checked");}%> onclick="checkradio(21,12);"></input> 라. 50% ~ 75% 미만</li>
            <li><input type="radio" name="q2_21_12" value="5" <%if(qa[21][12][5]!=null && qa[21][12][5].equals("1")){out.print("checked");}%> onclick="checkradio(21,12);"></input> 마. 50% 미만</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent">
        <div class="boxcontentleft">
          <ul class="elt">
            <li class="boxcontenttitle"><span>(13) </span> 귀사가 당초 계약할 때 정했던 금액보다 적게 PB제품 관련 하도급대금(단가)을 적게 지급한 이유는 무엇입니까?</li>
            <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
          </ul>
        </div>
        <div class="boxcontentright">
          <ul class="lt">
            <li><input type="checkbox" name="q2_21_13_1" value="1" <%if(qa[21][13][1]!=null && qa[21][13][1].equals("1")){out.print("checked");}%>></input> 가. 납품 제품이 불량품임</li>
            <li><input type="checkbox" name="q2_21_13_2" value="1" <%if(qa[21][13][2]!=null && qa[21][13][2].equals("1")){out.print("checked");}%>></input> 나. 발주서대로 제조되지 않음</li>
            <li><input type="checkbox" name="q2_21_13_3" value="1" <%if(qa[21][13][3]!=null && qa[21][13][3].equals("1")){out.print("checked");}%>></input> 다. 발주자 또는 거래처가 주문을 취소함</li>
            <li><input type="checkbox" name="q2_21_13_4" value="1" <%if(qa[21][13][4]!=null && qa[21][13][4].equals("1")){out.print("checked");}%>></input> 라. 판매부진에 따른 고통분담</li>
            <li><input type="checkbox" name="q2_21_13_5" value="1" <%if(qa[21][13][5]!=null && qa[21][13][5].equals("1")){out.print("checked");}%>></input> 마. 광고비·판매촉진비의 사전 지급을 반영함</li>
            <li><input type="checkbox" name="q2_21_13_6" value="1" <%if(qa[21][13][6]!=null && qa[21][13][6].equals("1")){out.print("checked");}%>></input> 바. 귀사의 저가수주 또는 염가판매를 반영함</li>
            <li><input type="checkbox" name="q2_21_13_7" value="1" <%if(qa[21][13][7]!=null && qa[21][13][7].equals("1")){out.print("checked");}%>></input> 사. 귀사의 자금사정을 고려함</li>
            <li><input type="checkbox" name="q2_21_13_8" value="1" <%if(qa[21][13][8]!=null && qa[21][13][8].equals("1")){out.print("checked");}%>></input> 아. 귀사가 환율변동으로 입은 손해를 반영함</li>
            <li><input type="checkbox" name="q2_21_13_9" value="1" <%if(qa[21][13][9]!=null && qa[21][13][9].equals("1")){out.print("checked");}%>></input> 자. 원자재가격의 하락을 반영함</li>
            <li><input type="checkbox" name="q2_21_13_10" value="1" <%if(qa[21][13][10]!=null && qa[21][13][10].equals("1")){out.print("checked");}%>></input> 차. 물품의 판매가격 하락을 반영함</li>
            <li><input type="checkbox" name="q2_21_13_11" value="1" <%if(qa[21][13][11]!=null && qa[21][13][11].equals("1")){out.print("checked");}%>></input> 카. 기타 (<input type="text" name="q2_21_16" value="<%=qa[21][16][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          <li class="noneboxcontenttitle"><a name="mokcha13">22. 제도에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        </ul>
      </div>
                      ...
                      <table class="tbl_blue">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_20" value="<%=setHiddenValue(qa, 21, 20, 6)%>"></input>
                              <input type="radio" name="q2_22_20" value="1" <%if(qa[22][20][1]!=null && qa[22][20][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,20);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_20" value="2" <%if(qa[22][20][2]!=null && qa[22][20][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,20);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_20" value="3" <%if(qa[22][20][3]!=null && qa[22][20][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,20);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_20" value="4" <%if(qa[22][20][4]!=null && qa[22][20][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,20);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_20" value="5" <%if(qa[22][20][5]!=null && qa[22][20][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,20);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">2) 부당특약 금지</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_21" value="<%=setHiddenValue(qa, 21, 21, 6)%>"></input>
                              <input type="radio" name="q2_22_21" value="1" <%if(qa[22][21][1]!=null && qa[22][21][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,21);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_21" value="2" <%if(qa[22][21][2]!=null && qa[22][21][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,21);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_21" value="3" <%if(qa[22][21][3]!=null && qa[22][21][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,21);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_21" value="4" <%if(qa[22][21][4]!=null && qa[22][21][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,21);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_21" value="5" <%if(qa[22][21][5]!=null && qa[22][21][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,21);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">3) 하도급대금 지급보증 제도 보완</th>
                            <td style="text-align: center;" >
                              <input type="hidden" name="c2_22_22" value="<%=setHiddenValue(qa, 21, 22, 6)%>"></input>
                              <input type="radio" name="q2_22_22" value="1" <%if(qa[22][22][1]!=null && qa[22][22][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,22);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_22" value="2" <%if(qa[22][22][2]!=null && qa[22][22][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,22);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_22" value="3" <%if(qa[22][22][3]!=null && qa[22][22][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,22);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_22" value="4" <%if(qa[22][22][4]!=null && qa[22][22][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,22);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_22" value="5" <%if(qa[22][22][5]!=null && qa[22][22][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,22);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">4) 중소기업협동조합에 납품단가조정협의권을 부여</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_23" value="<%=setHiddenValue(qa, 21, 23, 6)%>"></input>
                              <input type="radio" name="q2_22_23" value="1" <%if(qa[22][23][1]!=null && qa[22][23][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,23);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_23" value="2" <%if(qa[22][23][2]!=null && qa[22][23][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,23);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_23" value="3" <%if(qa[22][23][3]!=null && qa[22][23][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,23);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_23" value="4" <%if(qa[22][23][4]!=null && qa[22][23][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,23);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_23" value="5" <%if(qa[22][23][5]!=null && qa[22][23][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,23);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">5) 조사개시 전 법위반 행위 자진시정 시 제재 면제</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_24" value="<%=setHiddenValue(qa, 21, 24, 6)%>"></input>
                              <input type="radio" name="q2_22_24" value="1" <%if(qa[22][24][1]!=null && qa[22][24][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,24);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_24" value="2" <%if(qa[22][24][2]!=null && qa[22][24][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,24);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_24" value="3" <%if(qa[22][24][3]!=null && qa[22][24][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,24);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_24" value="4" <%if(qa[22][24][4]!=null && qa[22][24][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,24);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_24" value="5" <%if(qa[22][24][5]!=null && qa[22][24][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,24);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">6) 중견기업의 수급사업자 보호대상 포함</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_25" value="<%=setHiddenValue(qa, 21, 25, 6)%>"></input>
                              <input type="radio" name="q2_22_25" value="1" <%if(qa[22][25][1]!=null && qa[22][25][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,25);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_25" value="2" <%if(qa[22][25][2]!=null && qa[22][25][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,25);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_25" value="3" <%if(qa[22][25][3]!=null && qa[22][25][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,25);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_25" value="4" <%if(qa[22][25][4]!=null && qa[22][25][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,25);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_25" value="5" <%if(qa[22][25][5]!=null && qa[22][25][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,25);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">7) 신고포상금 지급</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_26" value="<%=setHiddenValue(qa, 21, 26, 6)%>"></input>
                              <input type="radio" name="q2_22_26" value="1" <%if(qa[22][26][1]!=null && qa[22][26][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,26);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_26" value="2" <%if(qa[22][26][2]!=null && qa[22][26][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,26);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_26" value="3" <%if(qa[22][26][3]!=null && qa[22][26][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,26);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_26" value="4" <%if(qa[22][26][4]!=null && qa[22][26][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,26);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_26" value="5" <%if(qa[22][26][5]!=null && qa[22][26][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,26);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">8) 조사개시 후 대금 미지급 자진시정 시 벌점 부과 면제</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_27" value="<%=setHiddenValue(qa, 21, 27, 6)%>"></input>
                              <input type="radio" name="q2_22_27" value="1" <%if(qa[22][27][1]!=null && qa[22][27][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,27);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_27" value="2" <%if(qa[22][27][2]!=null && qa[22][27][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,27);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_27" value="3" <%if(qa[22][27][3]!=null && qa[22][27][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,27);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_27" value="4" <%if(qa[22][27][4]!=null && qa[22][27][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,27);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_27" value="5" <%if(qa[22][27][5]!=null && qa[22][27][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,27);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">9) 단순기술 유출도 위법행위로 인정</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_28" value="<%=setHiddenValue(qa, 21, 28, 6)%>"></input>
                              <input type="radio" name="q2_22_28" value="1" <%if(qa[22][28][1]!=null && qa[22][28][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,28);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_28" value="2" <%if(qa[22][28][2]!=null && qa[22][28][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,28);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_28" value="3" <%if(qa[22][28][3]!=null && qa[22][28][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,28);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_28" value="4" <%if(qa[22][28][4]!=null && qa[22][28][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,28);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_28" value="5" <%if(qa[22][28][5]!=null && qa[22][28][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,28);"></input>
                            </td>
                          </tr>
                          <tr>
                            <th style="text-align: left;">10) 기술탈취 행위에 대한 조사시효를 3년에서 7년으로 연장</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_29" value="<%=setHiddenValue(qa, 21, 29, 6)%>"></input>
                              <input type="radio" name="q2_22_29" value="1" <%if(qa[22][29][1]!=null && qa[22][29][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,29);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_29" value="2" <%if(qa[22][29][2]!=null && qa[22][29][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,29);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_29" value="3" <%if(qa[22][29][3]!=null && qa[22][29][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,29);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_29" value="4" <%if(qa[22][29][4]!=null && qa[22][29][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,29);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_29" value="5" <%if(qa[22][29][5]!=null && qa[22][29][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,29);"></input>
                            </td>
                          </tr> 
                          <tr>
                            <th style="text-align: left;">11) 경영정보 요구 금지, 특정 사업자와 거래유도 금지, 기술 수출 제한 행위 금지</th>
                            <td style="text-align: center;">
                              <input type="hidden" name="c2_22_30" value="<%=setHiddenValue(qa, 21, 30, 6)%>"></input>
                              <input type="radio" name="q2_22_30" value="1" <%if(qa[22][30][1]!=null && qa[22][30][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,30);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_30" value="2" <%if(qa[22][30][2]!=null && qa[22][30][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,30);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_30" value="3" <%if(qa[22][30][3]!=null && qa[22][30][3].equals("1")){out.print("checked");}%> onclick="checkradio(22,30);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_30" value="4" <%if(qa[22][30][4]!=null && qa[22][30][4].equals("1")){out.print("checked");}%> onclick="checkradio(22,30);"></input>
                            </td>
                            <td style="text-align: center;">
                              <input type="radio" name="q2_22_30" value="5" <%if(qa[22][30][5]!=null && qa[22][30][5].equals("1")){out.print("checked");}%> onclick="checkradio(22,30);"></input>
                            </td>
                          </tr>            
                        </tbody>
                      </table>
    ...
    <div class="boxcontent2">
      ...
      <div class="boxcontent3">
        <ul class="boxcontenthelp2 lt">
          <li class="noneboxcontenttitle"> 23. 하도급제도 개선 또는 원사업자와 수급사업자간 수평적 협력관계 증진을 위하여 건의, 개선할 사항 등이 있으면 기재하여 주시기 바랍니다.<a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        </ul>
      </div>
      ...
      <div class="boxcontent">
        ...
        <div class="boxcontentright">
          <ul class="lt"><textarea cols="80" rows="8" maxlength="600" name="q2_23_1" class="textarea01b" maxlength="600" onFocus="javascript:this.className='textarea01o';" onBlur="javascript:this.className='textarea01b';" onkeyup="byteLengCheck(this, 4000, this.name,'content_bytes25_1');"><%=qa[23][1][20]%></textarea>
          </ul>
        </div>
        <div class="fc"></div>
      </div>
