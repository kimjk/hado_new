...
<%
/**
* 프로젝트명   : 하도급거래 서면실태조사 지원을 위한 개발용역 사업_1
  ...
  <![endif]-->
    ...
    function savef() {
      ...
      if( main.q2_5_1[2].checked==true ) {
        ...
        research2f_txt(main, 11, 20, 2, 0, '(1)항목의 1)귀사의 인건비 변화');
        research2f_txt(main, 11, 21, 2, 0, '(1)항목의 2)귀사가 구입한 원자재 가격 변화');
        research2f_txt(main, 11, 22, 2, 0, '(1)항목의 3)수급사업자의 생산성 변화');
        research2f_txt(main, 11, 23, 2, 0, '(1)항목의 4)수급사업자의 인건비 변화');
        research2f_txt(main, 11, 24, 2, 0, '(1)항목의 5)수급사업자가 구입한 원자재 가격 변화');
        research2f_txt(main, 11, 25, 2, 0, '(1)항목의 6)발주한 물량 변화(다량발주 등)');
        research2f_txt(main, 11, 26, 2, 0, '(1)항목의 7)귀사의 자금 또는 예산사정 변화');
        research2f_txt(main, 11, 27, 2, 0, '(1)항목의 8)기타');
        research2f(main, 12, 1, 2, 0);
        research2f(main, 13, 1, 2, 0);
        research2f(main, 14, 1, 2, 0);
        research2f(main, 15, 1, 2, 0);
        research2f(main, 16, 1, 2, 0);
        research2f_txt(main, 17, 11, 1, 0, '(1)항목의 중소기업 수급사업자에게 현금 지급한 비율');
        research2f_txt(main, 17, 12, 1, 0, '(1)항목의 중소기업 수급사업자에게 외상매출채권 담보대출 지급한 비율');
        research2f_txt(main, 17, 13, 1, 0, '(1)항목의 중소기업 수급사업자에게 기업구매전용카드 지급한 비율');
        research2f_txt(main, 17, 14, 1, 0, '(1)항목의 중소기업 수급사업자에게 구매론 지급한 비율');
        research2f_txt(main, 17, 15, 1, 0, '(1)항목의 중소기업 수급사업자에게 상생결제 시스템 지급한 비율');
        research2f_txt(main, 17, 16, 1, 0, '(1)항목의 중소기업 수급사업자에게 위 어음대체결제수단 지급한 비율');
        research2f_txt(main, 17, 17, 1, 0, '(1)항목의 중소기업 수급사업자에게 어음(만기 60일 이하) 지급한 비율');
        research2f_txt(main, 17, 18, 1, 0, '(1)항목의 중소기업 수급사업자에게 어음(만기 61~120일) 지급한 비율');
        research2f_txt(main, 17, 19, 1, 0, '(1)항목의 중소기업 수급사업자에게 어음(만기 121일 초과) 지급한 비율');
        research2f_txt(main, 17, 20, 1, 0, '(1)항목의 중소기업 수급사업자에게 기타 지급한 비율');
        research2f_txt(main, 17, 21, 1, 0, '(1)항목의 중견기업 수급사업자에게 현금 지급한 비율');
        research2f_txt(main, 17, 22, 1, 0, '(1)항목의 중견기업 수급사업자에게 외상매출채권 담보대출 지급한 비율');
        research2f_txt(main, 17, 23, 1, 0, '(1)항목의 중견기업 수급사업자에게 기업구매전용카드 지급한 비율');
        research2f_txt(main, 17, 24, 1, 0, '(1)항목의 중견기업 수급사업자에게 구매론 지급한 비율');
        research2f_txt(main, 17, 25, 1, 0, '(1)항목의 중견기업 수급사업자에게 상생결제 시스템 지급한 비율');
        research2f_txt(main, 17, 26, 1, 0, '(1)항목의 중견기업 수급사업자에게 위 어음대체결제수단 지급한 비율');
        research2f_txt(main, 17, 27, 1, 0, '(1)항목의 중견기업 수급사업자에게 어음(만기 60일 이하) 지급한 비율');
        research2f_txt(main, 17, 28, 1, 0, '(1)항목의 중견기업 수급사업자에게 어음(만기 61~120일) 지급한 비율');
        research2f_txt(main, 17, 29, 1, 0, '(1)항목의 중견기업 수급사업자에게 어음(만기 121일 초과) 지급한 비율');
        research2f_txt(main, 17, 30, 1, 0, '(1)항목의 중견기업 수급사업자에게 기타 지급한 비율');
        ...
        research2f_txt(main, 21, 1, 1, 0, '(1)자금 지원 업체 수');
        research2f_txt(main, 21, 2, 1, 0, '(1)물자 지원 업체 수');
        research2f_txt(main, 21, 3, 1, 0, '(1)인력 지원 업체 수');
        research2f_txt(main, 21, 4, 1, 0, '(1)기술 지원 업체 수');
        research2f_txt(main, 21, 5, 1, 0, '(1)경영 지원 업체 수');
        research2f_txt(main, 21, 6, 1, 0, '(1)판로 지원 업체 수');
        research2f_txt(main, 21, 7, 1, 0, '(1)기타 지원 업체 수');
        research2f(main, 22, 1, 2, 0);
        research2f(main, 23, 1, 2, 0);
        research2f(main, 24, 1, 2, 0);
        
        research2f_txt(main, 25, 20, 2, 0, '(1) 3배 손해배상제 적용대상 확대');
        research2f_txt(main, 25, 21, 2, 0, '(2) 부당특약 금지');
        research2f_txt(main, 25, 22, 2, 0, '(3) 하도급대금 지급보증 제도 보완 ');
        research2f_txt(main, 25, 23, 2, 0, '(4) 중소기업협동조합에 납품단가조정협의권을 부여');
        research2f_txt(main, 25, 24, 2, 0, '(5) 조사개시 전 법위반 행위 자진시정 시 제재 면제');
        research2f_txt(main, 25, 25, 2, 0, '(6) 중견기업의 수급사업자 보호대상 포함');
        research2f_txt(main, 25, 26, 2, 0, '(7) 신고포상금 지급');
        research2f_txt(main, 25, 27, 2, 0, '(8) 조사개시 후 대금 미지급 자진시정 시 벌점 부과 면제');
        research2f_txt(main, 25, 28, 2, 0, '(9) 단순기술 유출도 위법행위로 인정');
        research2f_txt(main, 25, 29, 2, 0, '(10) 기술탈취 행위에 대한 조사시효를 3년에서 7년으로 연장 답');
        research2f_txt(main, 25, 30, 2, 0, '(11) 경영정보 요구 금지, 특정 사업자와 거래유도 금지, 기술 수출 제한 행위 금지 답');

        if( main.q2_5_1[1].checked==true ) {
          initf(main, 6, 1, 1, 0);  initf(main, 6, 2, 1, 0);  initf(main, 6, 3, 1, 0);
        }
        else {
          research3f_txt(main, 6, 1, 1, 0, 5, 1, '(1)문항의 2018년도 하도급을 받은 금액');
          research3f_txt(main, 6, 2, 1, 0, 5, 1, '(1)문항의 2019년도 하도급을 받은 금액');
          research3f_txt(main, 6, 3, 1, 0, 5, 1, '(1)문항의 2020년도 하도급을 받은 금액');
        }
        ...
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 31, 1, 0); else research3f_txt(main, 17, 31, 1, 0, 17, 2, '(3)문항의  중소기업 수급사업자에게 현금 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 32, 1, 0); else research3f_txt(main, 17, 32, 1, 0, 17, 2, '(3)문항의  중소기업 수급사업자에게 어음대체 결제수단 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 33, 1, 0); else research3f_txt(main, 17, 33, 1, 0, 17, 2, '(3)문항의  중소기업 수급사업자에게 어음 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 34, 1, 0); else research3f_txt(main, 17, 34, 1, 0, 17, 2, '(3)문항의  중소기업 수급사업자에게 기타 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 41, 1, 0); else research3f_txt(main, 17, 41, 1, 0, 17, 2, '(3)문항의  중견기업 수급사업자에게 현금 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 42, 1, 0); else research3f_txt(main, 17, 42, 1, 0, 17, 2, '(3)문항의  중견기업 수급사업자에게 어음대체 결제수단 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 43, 1, 0); else research3f_txt(main, 17, 43, 1, 0, 17, 2, '(3)문항의  중견기업 수급사업자에게 어음 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 44, 1, 0); else research3f_txt(main, 17, 44, 1, 0, 17, 2, '(3)문항의  중견기업 수급사업자에게 기타 지급한 비율');
        if( main.q2_17_2[0].checked==true ) initf(main, 17, 4, 2, 0); else research3f(main, 17, 4, 2, 0, 17, 2);
        
        if( main.q2_19_1[1].checked==true ) initf(main, 19, 11, 1, 0); else research3f_txt(main, 19, 11, 1, 0, 19, 1, '(2)문항의  직접 하도급대금 조정신청한 수급사업자 수');
        if( main.q2_19_1[1].checked==true ) initf(main, 19, 12, 1, 0); else research3f_txt(main, 19, 12, 1, 0, 19, 1, '(2)문항의  직접 하도급대금 조정신청한 수급사업자와 10일 이내에 협의를 개시한 업체 수');
        if( main.q2_19_1[1].checked==true ) initf(main, 19, 13, 1, 0); else research3f_txt(main, 19, 13, 1, 0, 19, 1, '(2)문항의  중소기업협동조합을 통해 조정신청한 수급사업자 수');
        if( main.q2_19_1[1].checked==true ) initf(main, 19, 14, 1, 0); else research3f_txt(main, 19, 14, 1, 0, 19, 1, '(2)문항의  중소기업협동조합을 통해 조정신청한 수급사업자와 10일 이내에 협의를 개시한 업체 수');
        ...
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 21, 1, 0); else research3f_txt(main, 24, 21, 1, 0, 24, 1, '(2)문항의 전속거래 업체 수 비중');//
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 22, 1, 0); else research3f_txt(main, 24, 22, 1, 0, 24, 1, '(2)문항의 전속거래로부터 구매 비중');//
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 23, 1, 0); else research3f_txt(main, 24, 23, 1, 0, 24, 1, '(2)문항의 전속거래 평균 기간');//
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 3, 3, 5); else research3f(main, 24, 3, 3, 5, 24, 1);
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 41, 2, 0); else research3f_txt(main, 24, 41, 2, 0, 24, 1, '(3)문항의 1)품질 유지');
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 42, 2, 0); else research3f_txt(main, 24, 42, 2, 0, 24, 1, '(3)문항의 2)원가 경쟁력 유지');
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 43, 2, 0); else research3f_txt(main, 24, 43, 2, 0, 24, 1, '(3)문항의 3)기술유출 방지');
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 44, 2, 0); else research3f_txt(main, 24, 44, 2, 0, 24, 1, '(3)문항의 4)안정적 물량 조달');
        if( main.q2_24_1[1].checked==true ) initf(main, 24, 45, 2, 0); else research3f_txt(main, 24, 45, 2, 0, 24, 1, '(3)문항의 5)기타');
    ...
    function relationf(main) {
      ...
      if( main.q2_5_1[2].checked==true ) {
        ...
        if( main.q2_12_1[0].checked==true || main.q2_12_1[1].checked==true ) initf(main, 12, 2, 2, 0); else research3f(main, 12, 2, 2, 0, 12, 1);
        if( main.q2_12_1[0].checked==true || main.q2_12_1[1].checked==true ) initf(main, 12, 19, 1, 0); else research3f(main, 12, 19, 1, 0, 12, 1);//저장시 에는 체크안함
        
        if( main.q2_13_1[0].checked==true ) initf(main, 13, 2, 2, 0); else research3f(main, 13, 2, 2, 0, 13, 1);
        if( main.q2_13_1[0].checked==true ) initf(main, 13, 19, 1, 0); else research3f(main, 13, 19, 1, 0, 13, 1);//저장시 에는 체크안함
        if( main.q2_13_1[0].checked==true ) initf(main, 13, 3, 2, 0); else research3f(main, 13, 3, 2, 0, 13, 1);
        
        if( main.q2_14_1[0].checked==true ) initf(main, 14, 3, 6, 0); else research3f(main, 14, 2, 3, 6, 13, 1);
        if( main.q2_14_1[0].checked==true ) initf(main, 14, 19, 1, 0); else research3f(main, 14, 19, 1, 0, 13, 1);//저장시 에는 체크안함
...
<body>
  ...
  <div id="wrapper">
    ...
    <div id="subheader">
      <ul class="lt">
        ...
        <li class="fr">
          <ul class="lt">
            <li class="pt_20"><font color="#FF6600">[건설업]</font>
  ...
  <div id="subcontent">
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        <ul class="clt"><!-- 여기 -->
          ...
          <li><a href="#mokcha2" class="contentbutton3">11. 하도급 계약 체결 시, 공사대금의 결정에 관하여</a></li>
          <li><a href="#mokcha3" class="contentbutton3">12. 하도급대금 지급보증에 관하여</a></li>
          <li><a href="#mokcha4" class="contentbutton3">13. 건설 위탁의 취소 및 변경에 관하여</a></li>
          <li><a href="#mokcha5" class="contentbutton3">14. 목적물 인수에 관하여</a></li>
          <li><a href="#mokcha6" class="contentbutton3">15. 계약체결 후, 하도급대금 감액에 관하여</a></li>
          <li><a href="#mokcha7" class="contentbutton3">16. 선급금 지급에 관하여</a></li>
          <li><a href="#mokcha8" class="contentbutton3">17. 하도급대금 지급에 관하여</a></li>
          <li><a href="#mokcha9" class="contentbutton3">18. 설계변경 또는 경제상황의 변동(물가상승)에 따른 공사대금 증액조정에 관하여</a></li>
          <li><a href="#mokcha10" class="contentbutton3">19. 공급원가(재료비, 노무비, 경비 등) 변동에 따른 하도급대금 조정 신청에 관하여</a></li>
          <li><a href="#mokcha11" class="contentbutton3">20. 하자보증 이행에 관하여</a></li>
          <li><a href="#mokcha12" class="contentbutton3">21. 협력관계에 관하여</a></li>
          <li><a href="#mokcha13" class="contentbutton3">22. 특약에 관하여</a></li>
          <li><a href="#mokcha14" class="contentbutton3">23. 기술 자료 제공 요구에 관하여</a></li>
          <li><a href="#mokcha15" class="contentbutton3">24. 전속거래에 관하여</a></li>
          <li><a href="#mokcha16" class="contentbutton3">25. 새로 도입된 제도에 대한 인지도</a></li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="clt">
          ...
          <li class="boxcontentsubtitle">* 귀사가 하도급을 주기만 한 경우 귀사는 원청 시공업체에 해당</li>
          <li class="boxcontentsubtitle">* 귀사가 원청 시공업체로부터 하도급을 받아 수급사업자에게 하도급을 준 경우 귀사는 1차 협력업체에 해당</li>
      ...
      <div class="boxcontentright">
          <ul class="lt">
            ...
            <li><input type="radio" name="q2_8_1" value="1" <%if(qa[8][1][1]!=null && qa[8][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(8,1);"></input> 가. 원청 시공업체</li>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도 선정한 수급사업자 중 경쟁입찰 방식을 통해 선정한 비율 어떻게 됩니까?</li>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_10_5" value="1" <%if(qa[10][5][1]!=null && qa[10][5][1].equals("1")){out.print("checked");}%> onclick="checkradio(10,5);"></input> 가. 100% (전체 사용)<span class="boxcontentsubtitle">문11로</span></li>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha2">11. 하도급계약 체결 시, 공사대금의 결정에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문11은 하도급 계약 체결 시, 공사대금의 결정에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도에 하도급계약을 체결하면서, 공사대금의 결정에 아래 요인들을 어느 정도 고려하였습니까?</li>
          <li class="boxcontentsubtitle"></li>
          ...
          <li>
            <table class="tbl_blue" style="text-align: center;">
              ...
              <tbody>
                ...
                <tr>
                  <th style="text-align: left;">7) 귀사의 자금 또는 예산사정 변화</th>
                  <td>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha3">12. 하도급대금 지급보증에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문12-1에서 문12-2는 하도급대금 지급보증에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도 건설 위탁 시 수급사업자에게 하도급대금 지급보증을 해준 비율은 어떻게 됩니까? 계약건수를 기준으로 응답하여 주시고, 면제대상인 계약들은 계산에서 제외하여 주십시오.</li>
          <li class="boxcontentsubtitle">* 하도급대금 지급보증 면제 대상</li>
          <li class="boxcontentsubtitle">1. 2개 이상의 신용평가전문기관 회사채평가에서 A이상의 등급을 받은 업체의 경우(2020.7.7. 이후 면제 대상 아님)</li>
          <li class="boxcontentsubtitle">2. 개별 공사금액이 1,000만원 이하인 경우</li>
          <li class="boxcontentsubtitle">3. 발주자가 수급사업자에게 하도급대금을 직접 지급하는 경우</li>
          <li class="boxcontentsubtitle">4. 상생결제시스템을 통해 하도급대금을 지급하는 경우</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <input type="hidden" name="c2_12_1" value="<%=setHiddenValue(qa, 12, 1, 6)%>"></input>
        <ul class="lt">
          <li><input type="radio" name="q2_12_1" value="1" <%if(qa[12][1][1]!=null && qa[12][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(12,1);"></input> 가. 당사는 지급보증 면제대상 기업임<span class="boxcontentsubtitle">문13-1로</span></li>
          <li><input type="radio" name="q2_12_1" value="2" <%if(qa[12][1][2]!=null && qa[12][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(12,1);"></input> 나. 100% (전체 지급보증)<span class="boxcontentsubtitle">문13-1로</span></li>
          <li><input type="radio" name="q2_12_1" value="3" <%if(qa[12][1][3]!=null && qa[12][1][3].equals("1")){out.print("checked");}%> onclick="checkradio(12,1);"></input> 다. 95% ~ 100% 미만 (예외적 경우 제외한 전체 지급보증)</li>
          <li><input type="radio" name="q2_12_1" value="4" <%if(qa[12][1][4]!=null && qa[12][1][4].equals("1")){out.print("checked");}%> onclick="checkradio(12,1);"></input> 라. 75% ~ 95% 미만</li>
          <li><input type="radio" name="q2_12_1" value="5" <%if(qa[12][1][5]!=null && qa[12][1][5].equals("1")){out.print("checked");}%> onclick="checkradio(12,1);"></input> 마. 50% ~ 75% 미만</li>
          <li><input type="radio" name="q2_12_1" value="6" <%if(qa[12][1][6]!=null && qa[12][1][6].equals("1")){out.print("checked");}%> onclick="checkradio(12,1);"></input> 바. 50% 미만</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 면제대상이 아닌 계약에 대하여 귀사가 수급사업자에게 하도급대금 지급보증을 해주지 않은 주된 이유는 무엇입니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_12_2" value="1" <%if(qa[12][2][1]!=null && qa[12][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(12,2);"></input> 가. 수급사업자와 합의함</li>
          <li><input type="radio" name="q2_12_2" value="2" <%if(qa[12][2][2]!=null && qa[12][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(12,2);"></input> 나. 보증수수료 부담을 고려함</li>
          <li><input type="radio" name="q2_12_2" value="3" <%if(qa[12][2][3]!=null && qa[12][2][3].equals("1")){out.print("checked");}%> onclick="checkradio(12,2);"></input> 다. 보증기관에서 보증서 발급을 회피함</li>
          <li><input type="radio" name="q2_12_2" value="4" <%if(qa[12][2][4]!=null && qa[12][2][4].equals("1")){out.print("checked");}%> onclick="checkradio(12,2);"></input> 라. 기타(<input type="text" name="q2_12_19" value="<%=qa[12][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha4">13. 건설 위탁의 취소 및 변경에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문13-1에서 문13-3은 건설 위탁의 취소 및 변경에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> <%= nCurrentYear-1%>년도에 귀사가 수급사업자에게 건설 위탁을 한 후, 임의로 위탁을 취소하거나 변경하지 않고 본래의 계약대로 이행한 계약건수의 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 귀사가 임의로 건설 위탁을 취소하거나 변경한 이유는 무엇입니까?</li>
          <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_13_2_1" value="1" <%if(qa[13][2][1]!=null && qa[13][2][1].equals("1")){out.print("checked");}%>></input> 가. 발주자의 주문취소</li>
          <li><input type="checkbox" name="q2_13_2_2" value="1" <%if(qa[13][2][2]!=null && qa[13][2][2].equals("1")){out.print("checked");}%>></input> 나. 귀사의 경영악화</li>
          <li><input type="checkbox" name="q2_13_2_3" value="1" <%if(qa[13][2][3]!=null && qa[13][2][3].equals("1")){out.print("checked");}%>></input> 다. 수급사업자의 부도발생</li>
          <li><input type="checkbox" name="q2_13_2_4" value="1" <%if(qa[13][2][4]!=null && qa[13][2][4].equals("1")){out.print("checked");}%>></input> 라. 수급사업자의 계약불이행</li>
          <li><input type="checkbox" name="q2_13_2_5" value="1" <%if(qa[13][2][5]!=null && qa[13][2][5].equals("1")){out.print("checked");}%>></input> 마. 수급사업자의 시공능력 부족</li>
          <li><input type="checkbox" name="q2_13_2_6" value="1" <%if(qa[13][2][6]!=null && qa[13][2][6].equals("1")){out.print("checked");}%>></input> 바. 타 수급사업자가 더 양호한 조건을 제시</li>
          <li><input type="checkbox" name="q2_13_2_7" value="1" <%if(qa[13][2][7]!=null && qa[13][2][7].equals("1")){out.print("checked");}%>></input> 사. 기타 (<input type="text" name="q2_13_29" value="<%=qa[13][29][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(3) </span> 귀사가 <%= nCurrentYear-1%>년 중 당초 위탁했던 하도급계약에 일부 계약내용이 추가 또는 변경되어 추가비용이 발생한 경우가 있다면, 그 계약건수의 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_13_3" value="1" <%if(qa[13][3][1]!=null && qa[13][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(13,3);"></input> 가. 추가비용 발생한 경우 없음</li>
          <li><input type="radio" name="q2_13_3" value="2" <%if(qa[13][3][2]!=null && qa[13][3][2].equals("1")){out.print("checked");}%> onclick="checkradio(13,3);"></input> 나. 30% 미만</li>
          <li><input type="radio" name="q2_13_3" value="3" <%if(qa[13][3][3]!=null && qa[13][3][3].equals("1")){out.print("checked");}%> onclick="checkradio(13,3);"></input> 다. 30% ~ 50% 미만</li>
          <li><input type="radio" name="q2_13_3" value="4" <%if(qa[13][3][4]!=null && qa[13][3][4].equals("1")){out.print("checked");}%> onclick="checkradio(13,3);"></input> 라. 50% 이상</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha5">14. 목적물 인수에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문14-1에서 문14-2는 목적물 인수에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도에 건설 위탁한 목적물을 인수한 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle">* 인수 비율 = 100*(인수한 물량/건설 위탁한 물량)</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <input type="hidden" name="c2_14_1" value="<%=setHiddenValue(qa, 14, 1, 5)%>"></input>
        <ul class="lt">
          <li><input type="radio" name="q2_14_1" value="1" <%if(qa[14][1][1]!=null && qa[14][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(14,1);"></input> 가. 100% (전체인수)<span class="boxcontentsubtitle">문15-1로</span></li>
          <li><input type="radio" name="q2_14_1" value="2" <%if(qa[14][1][2]!=null && qa[14][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(14,1);"></input> 나. 95% ~ 100% 미만 (예외적 경우 제외한 전체인수)</li>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 귀사가 건설 위탁한 목적물을 인수하지 않은 이유는 무엇입니까?</li>
          <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_14_2_1" value="1" <%if(qa[14][2][1]!=null && qa[14][2][1].equals("1")){out.print("checked");}%>></input> 가. 발주자가 거래를 취소하여서</li>
          <li><input type="checkbox" name="q2_14_2_2" value="1" <%if(qa[14][2][2]!=null && qa[14][2][2].equals("1")){out.print("checked");}%>></input> 나. 시방서 또는 발주서대로 시공되지 않아서</li>
          <li><input type="checkbox" name="q2_14_2_3" value="1" <%if(qa[14][2][3]!=null && qa[14][2][3].equals("1")){out.print("checked");}%>></input> 다. 목적물에 하자가 존재해서</li>
          <li><input type="checkbox" name="q2_14_2_4" value="1" <%if(qa[14][2][4]!=null && qa[14][2][4].equals("1")){out.print("checked");}%>></input> 라. 수급사업자의 책임으로 약정기안이 지켜지지 않아서</li>
          <li><input type="checkbox" name="q2_14_2_5" value="1" <%if(qa[14][2][5]!=null && qa[14][2][5].equals("1")){out.print("checked");}%>></input> 마. 설계변경 등으로 추가공사금액이 확정되지 않아서</li>
          <li><input type="checkbox" name="q2_14_2_6" value="1" <%if(qa[14][2][6]!=null && qa[14][2][6].equals("1")){out.print("checked");}%>></input> 사. 기타 (<input type="text" name="q2_14_19" value="<%=qa[14][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha6">15. 계약체결 후, 하도급대금 감액에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문15-1에서 문15-2는 계약체결 후, 하도급대금 감액에 관한 질문입니다. </li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도 당초 계약할 때 정했던 금액대로 하도급대금을 지급한 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_15_1" value="1" <%if(qa[15][1][1]!=null && qa[15][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(15,1);"></input> 가. 100% (전체지급)<span class="boxcontentsubtitle">문16-1로</span></li>
          <li><input type="radio" name="q2_15_1" value="2" <%if(qa[15][1][2]!=null && qa[15][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(15,1);"></input> 나. 95% ~ 100% 미만 (예외적 경우 제외한 전체지급)</li>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 귀사가 당초 계약할 때 정했던 금액보다 하도급대금을 적게 지급한 이유는 무엇입니까?</li>
          <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_15_2_1" value="1" <%if(qa[15][2][1]!=null && qa[15][2][1].equals("1")){out.print("checked");}%>></input> 가. 하자시공 등 수급사업자의 책임</li>
          <li><input type="checkbox" name="q2_15_2_2" value="1" <%if(qa[15][2][2]!=null && qa[15][2][2].equals("1")){out.print("checked");}%>></input> 나. 수급사업자가 시방서대로 시공하지 않음</li>
          <li><input type="checkbox" name="q2_15_2_3" value="1" <%if(qa[15][2][3]!=null && qa[15][2][3].equals("1")){out.print("checked");}%>></input> 다. 발주자의 주문 변경(발주취소, 물량감소 등)</li>
          <li><input type="checkbox" name="q2_15_2_4" value="1" <%if(qa[15][2][4]!=null && qa[15][2][4].equals("1")){out.print("checked");}%>></input> 라. 귀사의 저가 수주를 고려</li>
          <li><input type="checkbox" name="q2_15_2_5" value="1" <%if(qa[15][2][5]!=null && qa[15][2][5].equals("1")){out.print("checked");}%>></input> 마. 귀사의 자금사정을 고려</li>
          <li><input type="checkbox" name="q2_15_2_6" value="1" <%if(qa[15][2][6]!=null && qa[15][2][6].equals("1")){out.print("checked");}%>></input> 바. 대금 지급시점의 원자재 가격 하락을 반영</li>
          <li><input type="checkbox" name="q2_15_2_7" value="1" <%if(qa[15][2][7]!=null && qa[15][2][7].equals("1")){out.print("checked");}%>></input> 사. 지급수단 조정(현금 지급비율 조정 등)을 고려</li>
          <li><input type="checkbox" name="q2_15_2_8" value="1" <%if(qa[15][2][8]!=null && qa[15][2][8].equals("1")){out.print("checked");}%>></input> 아. 지급기일 조정(어음결제기간 조정 등)을 고려</li>
          <li><input type="checkbox" name="q2_15_2_9" value="1" <%if(qa[15][2][9]!=null && qa[15][2][9].equals("1")){out.print("checked");}%>></input> 자. 기타 (<input type="text" name="q2_15_19" value="<%=qa[15][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha7">16. 선급금 지급에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문16-1에서 문16-2는 선지급 지급에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도에 발주자로부터 선급금을 지급받은 후, 지급받은 내용과 비율에 따라 선급금을 수급사업자에게 15일 이내에 지급한 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_16_1" value="1" <%if(qa[16][1][1]!=null && qa[16][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(16,1);"></input> 가. 100% (전체지급)<span class="boxcontentsubtitle">문17-1로</span></li>
          ...
          <li><input type="radio" name="q2_16_1" value="6" <%if(qa[16][1][6]!=null && qa[16][1][6].equals("1")){out.print("checked");}%> onclick="checkradio(16,1);"></input> 바. 자급대상 선급금 없음<span class="boxcontentsubtitle">문17-1로</span></li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 귀사가 <%= nCurrentYear-1%>년도에 발주자로부터 받은 선급금을 내용과 비율에 따라 수급사업자에게 지급하지 못한 경우가 있다면 이유는 무엇입니까?</li>          
        </ul>
      </div>
      <div class="boxcontentright">
        <input type="hidden" name="c2_16_2" value="<%=setHiddenValue(qa, 16, 2, 6)%>"></input>
        <ul class="lt">
          <li><input type="radio" name="q2_16_2" value="1" <%if(qa[16][2][1]!=null && qa[16][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(16,2);"></input> 가. 수급사업자가 선급금 수령을 포기하거나 유예를 요청함</li>
          <li><input type="radio" name="q2_16_2" value="2" <%if(qa[16][2][2]!=null && qa[16][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(16,2);"></input> 나. 수급사업자에게 선급금을 지급하지 않기로 하도급계약을 맺음</li>
          <li><input type="radio" name="q2_16_2" value="3" <%if(qa[16][2][3]!=null && qa[16][2][3].equals("1")){out.print("checked");}%> onclick="checkradio(16,2);"></input> 다. 수급사업자가 선급금지급 이행보증서 미제출</li>
          <li><input type="radio" name="q2_16_2" value="4" <%if(qa[16][2][4]!=null && qa[16][2][4].equals("1")){out.print("checked");}%> onclick="checkradio(16,2);"></input> 라. 공사금액이 소액이고 공사기간이 짧았음</li>
          <li><input type="radio" name="q2_16_2" value="5" <%if(qa[16][2][5]!=null && qa[16][2][5].equals("1")){out.print("checked");}%> onclick="checkradio(16,2);"></input> 마. 귀사의 자금사정등으로 지급하지 못함</li>
          <li><input type="radio" name="q2_16_2" value="6" <%if(qa[16][2][6]!=null && qa[16][2][6].equals("1")){out.print("checked");}%> onclick="checkradio(16,2);"></input> 바. 기타 (<input type="text" name="q2_16_19" value="<%=qa[16][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha8">17. 하도급대금 지급에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문17-1에서 문17-4는 하도급대금 지급에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_17_2" value="1" <%if(qa[17][2][1]!=null && qa[17][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 가. 없음<span class="boxcontentsubtitle">문18-1로</span></li>
          <li><input type="radio" name="q2_17_2" value="2" <%if(qa[17][2][2]!=null && qa[17][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 나. 30% 미만</li>
          <li><input type="radio" name="q2_17_2" value="3" <%if(qa[17][2][3]!=null && qa[17][2][3].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 다. 30% ~ 50% 미만</li>
          <li><input type="radio" name="q2_17_2" value="4" <%if(qa[17][2][4]!=null && qa[17][2][4].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 라. 50% 이상</li>
        </ul>
        <div class="fc pt_10"></div>
      </div>
      <div class="fc"></div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_17_4" value="1" <%if(qa[17][4][1]!=null && qa[17][4][1].equals("1")){out.print("checked");}%> onclick="checkradio(17,4);"></input> 가. 전부 지급</li>
          <li><input type="radio" name="q2_17_4" value="2" <%if(qa[17][4][2]!=null && qa[17][4][2].equals("1")){out.print("checked");}%> onclick="checkradio(17,4);"></input> 나. 일부 지급(일부 미지급)</li>
          <li><input type="radio" name="q2_17_4" value="3" <%if(qa[17][4][3]!=null && qa[17][4][3].equals("1")){out.print("checked");}%> onclick="checkradio(17,4);"></input> 다. 전부 미지급</li>
        </ul>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha9">18. 설계변경 또는 경제상황의 변동(물가상승)에 따른 공사대금 증액조정에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문18-1에서 문18-3은 설계변경 또는 경제상황의 변동(물가상승)에 따른 공사대금 증액조정에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도에 발주자로부터 설계변경 또는 경제상황의 변동(물가상승) 등에 따라 공사대금의 증액 조정을 받은 경우가 몇 건 있었습니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="text" name="q2_18_1" value="<%=qa[18][1][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input> 건</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 귀사가 발주자로부터 설계변경 또는 경제상황의 변동(물가상승) 등에 따른 공사대금의 증액 조정을 받은 대로 해당 수급사업자에게 공사대금의 증액 조정을 해준 경우가 몇 건 있었습니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="text" name="q2_18_2" value="<%=qa[18][2][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input> 건</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(3) </span> 귀사가 발주자로부터 설계변경 또는 경제상황의 변동(물가상승) 등에 따른 공사대금의 증액 조정을 받은 후 해당 수급사업자에게 공사대금의 증액 조정을 해주지 못한 경우가 있다면, 그 이유는 무엇입니까?</li>
          <li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_18_3_1" value="1" <%if(qa[18][3][1]!=null && qa[18][3][1].equals("1")){out.print("checked");}%>></input> 가. 하도급계약서에 ESC(물가변동으로 인한 계약 금액 조정)를 적용하지 않기로 함</li>
          <li><input type="checkbox" name="q2_18_3_2" value="1" <%if(qa[18][3][2]!=null && qa[18][3][2].equals("1")){out.print("checked");}%>></input> 나. 귀사의 자금사정으로 지급하지 못함</li>
          <li><input type="checkbox" name="q2_18_3_3" value="1" <%if(qa[18][3][3]!=null && qa[18][3][3].equals("1")){out.print("checked");}%>></input> 다. 대상 금액이나 조정비율이 작았음</li>
          <li><input type="checkbox" name="q2_18_3_4" value="1" <%if(qa[18][3][4]!=null && qa[18][3][4].equals("1")){out.print("checked");}%>></input> 라. 물가조정 대상기간 이후 하도급계약을 체결하였기 때문에 증액 조정하지 않음</li>
          <li><input type="checkbox" name="q2_18_3_5" value="1" <%if(qa[18][3][5]!=null && qa[18][3][5].equals("1")){out.print("checked");}%>></input> 마. 기타 (<input type="text" name="q2_18_19" value="<%=qa[18][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha10">19. 공급원가(재료비, 노무비, 경비 등) 변동에 따른 하도급대금 조정 신청에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문19-1에서 문19-3은 공급원가(재료비, 노무비, 경비 등) 변동에 따른 하도급대금 조정 신청에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          ...
          <li><input type="radio" name="q2_19_1" value="2" <%if(qa[19][1][2]!=null && qa[19][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(19,1);"></input> 나. 없다<span class="boxcontentsubtitle">문20으로</span></li>
        </ul>
        <div class="fc pt_50"></div>
        <div class="fc pt_50"></div>
      </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          ...
          <li class="boxcontentsubtitle">동일 수급사업자가 하도급대금 조정 신청(A)을 한 후 중소기업협동조합을 통하여 대금 조정을 재신청(B)한 경우는, 후자(B)의 조정신청 건수로만 계산</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <ul class="lt">
            ...
            <table class="tbl_blue">
              ...
              <tbody>
                ...
                <tr>
                  <th>직접 하도급대금 조정신청</th>
                  <td>
                    <input type="text" name="q2_19_11" value="<%=qa[19][11][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
                  </td>
                  <td>
                    <input type="text" name="q2_19_12" value="<%=qa[19][12][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
                  </td>
                </tr>
                <tr>
                  <th>중소기업협동조합을 통해 조정신청</th>
                  <td>
                    <input type="text" name="q2_19_13" value="<%=qa[19][13][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
                  </td>
                  <td>
                    <input type="text" name="q2_19_14" value="<%=qa[19][14][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_19_3" value="1" <%if(qa[19][3][1]!=null && qa[19][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(19,3);"></input> 가. 100% (전체 수용)</li>
          <li><input type="radio" name="q2_19_3" value="2" <%if(qa[19][3][2]!=null && qa[19][3][2].equals("1")){out.print("checked");}%> onclick="checkradio(19,3);"></input> 나. 75% ~ 100% 미만</li>
          <li><input type="radio" name="q2_19_3" value="3" <%if(qa[19][3][3]!=null && qa[19][3][3].equals("1")){out.print("checked");}%> onclick="checkradio(19,3);"></input> 다. 50% ~ 75% 미만</li>
          <li><input type="radio" name="q2_19_3" value="4" <%if(qa[19][3][4]!=null && qa[19][3][4].equals("1")){out.print("checked");}%> onclick="checkradio(19,3);"></input> 라. 25% ~ 50% 미만</li>
          <li><input type="radio" name="q2_19_3" value="5" <%if(qa[19][3][5]!=null && qa[19][3][5].equals("1")){out.print("checked");}%> onclick="checkradio(19,3);"></input> 마. 25% 미만</li>
          <li><input type="radio" name="q2_19_3" value="6" <%if(qa[19][3][6]!=null && qa[19][3][6].equals("1")){out.print("checked");}%> onclick="checkradio(19,3);"></input> 바. 0% (전체 미수용)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha11">20. 하자보증 이행에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문20-1에서 문20-6은 하자보수 보증에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(1) </span> 귀사가 <%= nCurrentYear-1%>년도 수급사업자에게 하자보증 이행을 요구한 사실이 있다면, 그 비율은 어떻게 됩니까? 계약건수를 기준으로 응답하여 주십시오.</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_20_1" value="1" <%if(qa[20][1][1]!=null && qa[20][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(20,1);"></input> 가. 하자보증 이행 요구 사실 없음<span class="boxcontentsubtitle">문21로</span></li>
          <li><input type="radio" name="q2_20_1" value="2" <%if(qa[20][1][2]!=null && qa[20][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,1);"></input> 나. 30% 미만</li>
          <li><input type="radio" name="q2_20_1" value="3" <%if(qa[20][1][3]!=null && qa[20][1][3].equals("1")){out.print("checked");}%> onclick="checkradio(20,1);"></input> 다. 30%~50% 미만</li>
          <li><input type="radio" name="q2_20_1" value="4" <%if(qa[20][1][4]!=null && qa[20][1][4].equals("1")){out.print("checked");}%> onclick="checkradio(20,1);"></input> 라. 50% 이상</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(2) </span> 귀사가 하자담보책임을 위한 하자보수보증금율을 계약서에 설정하였다면, 그 평균적인 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_20_2" value="1" <%if(qa[20][2][1]!=null && qa[20][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 가. 계약서에 하자보수보증금율 미설정</li>
          <li><input type="radio" name="q2_20_2" value="2" <%if(qa[20][2][2]!=null && qa[20][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 나. 0~5% 미만</li>
          <li><input type="radio" name="q2_20_2" value="3" <%if(qa[20][2][3]!=null && qa[20][2][3].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 다. 5~20% 미만</li>
          <li><input type="radio" name="q2_20_2" value="4" <%if(qa[20][2][4]!=null && qa[20][2][4].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 라. 10~15% 미만</li>
          <li><input type="radio" name="q2_20_2" value="5" <%if(qa[20][2][5]!=null && qa[20][2][5].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 마. 15~20% 미만</li>
          <li><input type="radio" name="q2_20_2" value="6" <%if(qa[20][2][6]!=null && qa[20][2][6].equals("1")){out.print("checked");}%> onclick="checkradio(20,2);"></input> 바. 20% 이상</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(3) </span> 귀사가 하자보증 이행을 위해 수급사업자에게 유보금 설정을 요구하였다면, 유보금을 설정한 계약 건수의 비율은 어떻게 됩니까?</li>
          <li class="boxcontentsubtitle">* 유보금 : 원사업자가 수급사업자에게 지급하여야 할 대금(선급금, 기성금, 잔금 등) 중 일부를 지급하지 아니하고 일정기간동안 유보시켜 놓은 금액</li>
        </ul>
      </div>
      <div class="boxcontentright">
        <input type="hidden" name="c2_20_3" value="<%=setHiddenValue(qa, 20, 3, 4)%>"></input>
        <ul class="lt">
          <li><input type="radio" name="q2_20_3" value="1" <%if(qa[20][3][1]!=null && qa[20][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(20,3);"></input> 가. 유보금 설정 사례 없음<span class="boxcontentsubtitle">문21로</span></li>
          <li><input type="radio" name="q2_20_3" value="2" <%if(qa[20][3][2]!=null && qa[20][3][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,3);"></input> 나. 30% 미만</li>
          <li><input type="radio" name="q2_20_3" value="3" <%if(qa[20][3][3]!=null && qa[20][3][3].equals("1")){out.print("checked");}%> onclick="checkradio(20,3);"></input> 다. 30%~50% 미만</li>
          <li><input type="radio" name="q2_20_3" value="4" <%if(qa[20][3][4]!=null && qa[20][3][4].equals("1")){out.print("checked");}%> onclick="checkradio(20,3);"></input> 라. 50% 이상</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(4) </span> 귀사가 실제 유보금으로 설정한 금액은 하도급대금의 몇 % 정도 입니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_20_4" value="1" <%if(qa[20][4][1]!=null && qa[20][4][1].equals("1")){out.print("checked");}%> onclick="checkradio(20,4);"></input> 가. 0~5% 미만</li>
          <li><input type="radio" name="q2_20_4" value="2" <%if(qa[20][4][2]!=null && qa[20][4][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,4);"></input> 나. 5~10% 미만</li>
          <li><input type="radio" name="q2_20_4" value="3" <%if(qa[20][4][3]!=null && qa[20][4][3].equals("1")){out.print("checked");}%> onclick="checkradio(20,4);"></input> 다. 10~15% 미만</li>
          <li><input type="radio" name="q2_20_4" value="4" <%if(qa[20][4][4]!=null && qa[20][4][4].equals("1")){out.print("checked");}%> onclick="checkradio(20,4);"></input> 라. 15~20% 미만</li>
          <li><input type="radio" name="q2_20_4" value="5" <%if(qa[20][4][5]!=null && qa[20][4][5].equals("1")){out.print("checked");}%> onclick="checkradio(20,4);"></input> 마. 20% 이상</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(5) </span> 귀사는 설정 유보금을 수급사업자에게 통상 언제 지급하였습니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_20_5" value="1" <%if(qa[20][5][1]!=null && qa[20][5][1].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 가. 이행기간 만료일 이후 1개월 이내</li>
          <li><input type="radio" name="q2_20_5" value="2" <%if(qa[20][5][2]!=null && qa[20][5][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 나. 이행기간 만료일 이후 1개월 ~ 5개월 이내</li>
          <li><input type="radio" name="q2_20_5" value="3" <%if(qa[20][5][3]!=null && qa[20][5][3].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 다. 이행기간 만료일 이후 5개월 ~ 1년 이내</li>
          <li><input type="radio" name="q2_20_5" value="4" <%if(qa[20][5][4]!=null && qa[20][5][4].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 라. 이행기간 만료일 이후 1년 ~ 2년 이내</li>
          <li><input type="radio" name="q2_20_5" value="5" <%if(qa[20][5][5]!=null && qa[20][5][5].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 마. 이행기간 만료일 이후  2년 ~ 3년 이내</li>
          <li><input type="radio" name="q2_20_5" value="6" <%if(qa[20][5][6]!=null && qa[20][5][6].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 바. 이행기간 만료일 이후 3년 이상</li>
          <li><input type="radio" name="q2_20_5" value="7" <%if(qa[20][5][7]!=null && qa[20][5][7].equals("1")){out.print("checked");}%> onclick="checkradio(20,5);"></input> 사. 미지급</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(6) </span> 유보금 설정 경위 및 내용에 관해 추가로 기술할 내용이 있는 경우, 자유롭게 기술하여 주시기 바랍니다.</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha12">21. 협력관계에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문21은 수급사업자와의 협력관계에 관한 질문입니다.</li>
      </ul>
    </div>
          ...
          <li>
            <table class="tbl_blue">
              ...
              <tbody>
                ...
                <tr>
                  <th>자금(출자·융자) 지원</th>
                  <td><input type="text" name="q2_21_1" value="<%=qa[21][1][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
                <tr>
                  <th>물자(원자재·설비) 지원</th>
                  <td><input type="text" name="q2_21_2" value="<%=qa[21][2][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
                <tr>
                  <th>인력(교육) 지원</th>
                  <td><input type="text" name="q2_21_3" value="<%=qa[21][3][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
                <tr>
                  <th>기술(설계) 지원</th>
                  <td><input type="text" name="q2_21_4" value="<%=qa[21][4][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
                <tr>
                  <th>경영(컨설팅·정보화) 지원</th>
                  <td><input type="text" name="q2_21_5" value="<%=qa[21][5][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
                <tr>
                  <th>판로(내수·수출) 지원</th>
                  <td><input type="text" name="q2_21_6" value="<%=qa[21][6][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
                <tr>
                  <th>기타 지원</th>
                  <td><input type="text" name="q2_21_7" value="<%=qa[21][7][20]%>" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개사</td>
                </tr>
              </tbody>
            </table>
          </li>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha13">22. 특약에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문22-1에서 문22-2는 특약에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_22_2_1" value="1" <%if(qa[22][2][1]!=null && qa[22][2][1].equals("1")){out.print("checked");}%>></input> 가. 계약시점에 예측할 수 없는 사항으로 인한 비용을 수급사업자와 분담하기 위해</li>
          <li><input type="checkbox" name="q2_22_2_2" value="1" <%if(qa[22][2][2]!=null && qa[22][2][2].equals("1")){out.print("checked");}%>></input> 나. 민원처리, 인·허가, 환경관리, 품질관리 등에 따른 비용을 수급사업자와 분담하기 위해</li>
          <li><input type="checkbox" name="q2_22_2_3" value="1" <%if(qa[22][2][3]!=null && qa[22][2][3].equals("1")){out.print("checked");}%>></input> 다. 설계 및 작업내용 변경으로 발생한 비용을 수급사업자와 분담하기 위해</li>
          <li><input type="checkbox" name="q2_22_2_4" value="1" <%if(qa[22][2][4]!=null && qa[22][2][4].equals("1")){out.print("checked");}%>></input> 라. 하자담보책임 또는 손해배상책임 이행에 따른 비용을 수급사업자와 분담하기 위해</li>
          <li><input type="checkbox" name="q2_22_2_5" value="1" <%if(qa[22][2][5]!=null && qa[22][2][5].equals("1")){out.print("checked");}%>></input> 마. 기타 (<input type="text" name="q2_22_19" value="<%=qa[22][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha14">23. 기술 자료 제공 요구에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문23-1에서 문23-7은 기술자료 제공 요구에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_23_1" value="1" <%if(qa[23][1][1]!=null && qa[23][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(23,1);"></input> 가. 있다<span class="boxcontentsubtitle">문23-2로</span></li>
          <li><input type="radio" name="q2_23_1" value="2" <%if(qa[23][1][2]!=null && qa[23][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(23,1);"></input> 나. 없다<span class="boxcontentsubtitle">문24-1로</span></li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_23_2_1" value="1" <%if(qa[23][2][1]!=null && qa[23][2][1].equals("1")){out.print("checked");}%>></input> 가. 공동 특허 개발</li>
          <li><input type="checkbox" name="q2_23_2_2" value="1" <%if(qa[23][2][2]!=null && qa[23][2][2].equals("1")){out.print("checked");}%>></input> 나. 공동 기술개발 약정 체결</li>
          <li><input type="checkbox" name="q2_23_2_3" value="1" <%if(qa[23][2][3]!=null && qa[23][2][3].equals("1")){out.print("checked");}%>></input> 다. 제품 하자의 원인규명</li>
          <li><input type="checkbox" name="q2_23_2_4" value="1" <%if(qa[23][2][4]!=null && qa[23][2][4].equals("1")){out.print("checked");}%>></input> 라. 기타 (<input type="text" name="q2_23_11" value="<%=qa[23][11][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        <ul class="lt">
          <li><input type="checkbox" name="q2_23_3_1" value="1" <%if(qa[23][3][1]!=null && qa[23][3][1].equals("1")){out.print("checked");}%>></input> 가. 공동특허, 공동 기술개발 약정 체결, 제품하자의 원인규명에 한정하여 사용</li>
          <li><input type="checkbox" name="q2_23_3_2" value="1" <%if(qa[23][3][2]!=null && qa[23][3][2].equals("1")){out.print("checked");}%>></input> 나. 공동특허, 공동 기술개발 약정 체결, 제품하자의 원인규명 이외 목적으로 귀사를 위해 사용</li>
          <li><input type="checkbox" name="q2_23_3_3" value="1" <%if(qa[23][3][3]!=null && qa[23][3][3].equals("1")){out.print("checked");}%>></input> 다. 공동특허, 공동 기술개발 약정 체결, 제품하자의 원인규명 이외 목적으로 제3자를 위해 사용</li>
          <li><input type="checkbox" name="q2_23_3_4" value="1" <%if(qa[23][3][4]!=null && qa[23][3][4].equals("1")){out.print("checked");}%>></input> 라. 공동특허, 공동 기술개발 약정 체결, 제품하자의 원인규명 이외 목적으로 제3자에게 제공</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(4) </span> 귀사는  <%= nCurrentYear-1%>년도에 수급사업자에게 기술 자료를 서면으로 요청한 적이 있습니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_23_4" value="1" <%if(qa[23][4][1]!=null && qa[23][4][1].equals("1")){out.print("checked");}%> onclick="checkradio(23,4);"></input> 가. 있다(<input type="text" name="q2_23_12" value="<%=qa[23][12][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>건)<span class="boxcontentsubtitle">문23-5로</span></li>
          <li><input type="radio" name="q2_23_4" value="2" <%if(qa[23][4][2]!=null && qa[23][4][2].equals("1")){out.print("checked");}%> onclick="checkradio(23,4);"></input> 나. 없다<span class="boxcontentsubtitle">문23-6으로</span></li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_23_5" value="1" <%if(qa[23][5][1]!=null && qa[23][5][1].equals("1")){out.print("checked");}%> onclick="checkradio(23,5);"></input> 가. 자체양식</li>
          <li><input type="radio" name="q2_23_5" value="2" <%if(qa[23][5][2]!=null && qa[23][5][2].equals("1")){out.print("checked");}%> onclick="checkradio(23,5);"></input> 나. 기술자료 요구서(공정위 예규 제263호 서식1)</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(6) </span> 귀사는  <%= nCurrentYear-1%>년도에 수급사업자에게 기술 자료를 구두로 요청한 적이 있습니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_23_6" value="1" <%if(qa[23][6][1]!=null && qa[23][6][1].equals("1")){out.print("checked");}%> onclick="checkradio(23,6);"></input> 가. 있다(<input type="text" name="q2_23_13" value="<%=qa[23][13][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>건)<span class="boxcontentsubtitle">문23-7로</span></li>
          <li><input type="radio" name="q2_23_6" value="2" <%if(qa[23][6][2]!=null && qa[23][6][2].equals("1")){out.print("checked");}%> onclick="checkradio(23,6);"></input> 나. 없다<span class="boxcontentsubtitle">문24-1로</span></li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <div class="boxcontent">
      <div class="boxcontentleft">
        <ul class="elt">
          <li class="boxcontenttitle"><span>(7) </span> 귀사가 기술 자료를 구두로 요청한 주된 이유는 무엇입니까?</li>
          <li class="boxcontentsubtitle"></li>
        </ul>
      </div>
      <div class="boxcontentright">
        ...
        <ul class="lt">
          <li><input type="radio" name="q2_23_7" value="1" <%if(qa[23][7][1]!=null && qa[23][7][1].equals("1")){out.print("checked");}%> onclick="checkradio(23,7);"></input> 가. 서면발급 의무를 알지 못해서</li>
          <li><input type="radio" name="q2_23_7" value="2" <%if(qa[23][7][2]!=null && qa[23][7][2].equals("1")){out.print("checked");}%> onclick="checkradio(23,7);"></input> 나. 서면발급이 필요한 사항인지 불분명하여서</li>
          <li><input type="radio" name="q2_23_7" value="3" <%if(qa[23][7][3]!=null && qa[23][7][3].equals("1")){out.print("checked");}%> onclick="checkradio(23,7);"></input> 다. 기술 자료 요청 건수가 너무 많아서</li>
          <li><input type="radio" name="q2_23_7" value="4" <%if(qa[23][7][4]!=null && qa[23][7][4].equals("1")){out.print("checked");}%> onclick="checkradio(23,7);"></input> 라. 관행적으로 구두 요청으로 처리해서</li>
        </ul>
      </div>
      <div class="fc"></div>
    </div>
    ...
    <h2 class="contenttitle">하도급거래 세부사항 3 : 전속거래</h2>

    <div class="fc pt_10"></div>
    
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha15">24. 전속거래에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
        <li class="boxcontentsubtitle">※ 문24-1에서 문24-3은 전속거래에 관한 질문입니다.</li>
      </ul>
    </div>
    ...
    <div class="boxcontent">
      ...
      <div class="boxcontentright">
        ...
        <ul class="lt">
          ...
          <li><input type="radio" name="q2_24_1" value="2" <%if(qa[24][1][2]!=null && qa[24][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(24,1);"></input> 나. 없다<span class="boxcontentsubtitle">문25로</span></li>
        </ul>
        <div class="fc pt_50"></div>
      </div>
      <div class="fc"></div>
          ...
          <li>
            <table class="tbl_blue">
              ...
              <tbody>
                ...
                <tr>
                  <th>전속거래 평균 기간</th>
                  <td><input type="text" name="q2_24_23" value="<%=qa[24][23][20]%>" onKeyUp="sukeyup(this);" size="30" class="text04br" onFocus="javascript:this.className='text04or';" onBlur="javascript:this.className='text04br';"></input> 개월</td>
                </tr>
              </tbody>
            </table>
          </li>
          ...
          <li>
            <table class="tbl_blue" style="text-align:center;">
              ...
              <tbody>
                ...
                <tr>
                  <th style="text-align: left;"><input type="checkbox" name="q2_24_3_1" value="1" <%if(qa[24][3][1]!=null && qa[24][3][1].equals("1")){out.print("checked");}%>></input>1) 품질 유지</th>
                  <td>
                ...
                <tr>
                  <th style="text-align: left;"><input type="checkbox" name="q2_24_3_2" value="1" <%if(qa[24][3][2]!=null && qa[24][3][2].equals("1")){out.print("checked");}%>></input>2) 원가 경쟁력 유지</th>
                  <td>
                ...
                <tr>
                  <th style="text-align: left;"><input type="checkbox" name="q2_24_3_3" value="1" <%if(qa[24][3][3]!=null && qa[24][3][3].equals("1")){out.print("checked");}%>></input>3) 기술유출 방지</th>
                  <td>
                ...
                <tr>
                  <th style="text-align: left;"><input type="checkbox" name="q2_24_3_4" value="1" <%if(qa[24][3][4]!=null && qa[24][3][4].equals("1")){out.print("checked");}%>></input>4) 안정적 물량 조달</th>
                  <td>
                ...
                <tr>
                  <th style="text-align: left;"><input type="checkbox" name="q2_24_3_5" value="1" <%if(qa[24][3][5]!=null && qa[24][3][5].equals("1")){out.print("checked");}%>></input>5) 기타(<input type="text" name="q2_24_39" value="<%=qa[24][39][20]%>" size="30" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>)</th>
                  <td>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"><a name="mokcha16">25. 제도에 관하여</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
      </ul>
    </div>
    ...
    <div class="boxcontent3">
      <ul class="boxcontenthelp2 lt">
        <li class="noneboxcontenttitle"> 26. 하도급제도 개선 또는 원사업자와 수급사업자간 수평적 협력관계 증진을 위하여 건의, 개선할 사항 등이 있으면 기재하여 주시기 바랍니다.<a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
      </ul>
    </div>
