...
/*-----------------------------------------------------------------------------------------------------*/
	...
	String city2 = new String(StringUtil.checkNull(request.getParameter("CityName" )).getBytes("utf-8"), "ISO8859-1" );
	...
	if (Item.equals("S") && sSQLInjection.equals("f")) {
		...
		try {
			...
			while (rs.next()) {
				...
				aCity[i] = new String( StringUtil.checkNull( rs.getString("Post_City") ).getBytes("ISO8859-1"), "utf-8" );
				aGu[i] = new String( StringUtil.checkNull( rs.getString("Post_Gu") ).getBytes("ISO8859-1"), "utf-8" );
				aDong[i] = new String( StringUtil.checkNull( rs.getString("Post_Dong") ).getBytes("ISO8859-1"), "utf-8" );
				aDong1[i] = new String( StringUtil.checkNull( rs.getString("Post_RI") ).getBytes("ISO8859-1"), "utf-8" );
				aBunji[i] = new String( StringUtil.checkNull( rs.getString("Post_bunji") ).getBytes("ISO8859-1"), "utf-8" );
