			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="clt">
							...
							<table class="tbl_blue">
								...
								<tbody>
									<tr>
										...
										ㆍ<font color="#FF0000">귀사가 중소기업이고, 귀사의 연간 매출액(<%=st_Current_Year_n-2%>년 기준)이<br/>&nbsp;&nbsp;&nbsp;위 원사업자의 연간 매출액에 비해 큰 경우</font></td>
									</tr>
									<tr>
										<td>② 하도급거래가 아닌 경우</td>
						...
						<div class="fc pt_10"></div>
						<li><font color="#FF0000">＊ 단, 하도급법이 적용되지 않는 사유를 기재</font></li>
