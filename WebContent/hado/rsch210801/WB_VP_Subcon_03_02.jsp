	...
	<div id="wrapper">
		...
		<div id="submenu">
			<ul class="lt fr">
				...
				<li class="fl pr_2"><a href="./WB_VP_Subcon_Add.jsp" onfocus="this.blur()" class="mainmenu">5. 신규제도관련 설문조사</a></li>
			</ul>
		</div>
		<!-- End Header -->
		...
		<div id="subcontent">
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="lt">
						...
						&nbsp;&nbsp;&nbsp;- 입력예시) (주) 회 사 명 <font color="red">(X)</font> --> (주)회사명 <font color="red">(O)</font><br/>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="clt">
						<li>
							<span>▣</span>만일 귀사와 위 원사업자와의 거래관계가 <font style="font-weight:bold;">아래 사유</font>에 <font style="font-weight:bold;">해당</font>될 경우는 <font style="font-weight:bold;">조사 제외대상에 해당</font>됩니다.
						...
						<li>
							<table class="tbl_blue">
								...
								<thead>
									<tr>
										<th style="font-weight:bold;">조사 제외 대상</th>
										<th style="font-weight:bold;">구체적 사례</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td>① 귀사가 '하도급법상의 수급사업자' 	요건에 해당되지 않는 경우</td>
										<td><ul style="list-style-type:disk; margin:10px;">
										<li>귀사가 공정거래법상의 <font style="font-weight:bold;">대기업</font>인 경우<br/></li>
										<li>귀사가 중소기업이고, 귀사의 연간 매출액(<%=st_Current_Year_n-2%>년 기준)이<br/>위 원사업자의 연간 매출액에 비해 큰 경우</li>
										</ul>
										</td>
									</tr>
									<tr>
										<td>② 하도급거래가 아닌 경우</td>
										<td><ul style="list-style-type:disk; margin:10px;">
										<li>목적물을 판매하는 단순 <font style="font-weight:bold;">매매행위</font><br/></li>
										<li>원사업자로부터 위탁받은 목적물을 제조하지 않고 <font style="font-weight:bold;">단순구매</font>하여 <font style="font-weight:bold;">납품</font>하는 경우 등</li>
										</ul>
										</td>
									</tr>
									<tr>
										...
										<td><ul style="list-style-type:disk; margin:10px;">
										<li>하도급을 주기만하는 경우는 원사업자에 해당되므로,<br/>&nbsp;&nbsp;&nbsp;수급사업자로 볼 수 없음</li>
										</ul>
										</td>
									</tr>
									<tr>
										...
										<td><ul style="list-style-type:disk; margin:10px;">
										<li>하도급거래가 없는 경우이므로 하도급법이 적용되지 않음</li>
										</ul>
										</td>
									</tr>
								</tbody>
						...
						<li><span>※</span>귀사가 <font color="#FF0066">위 사유에 해당</font>된다고 판단되실 경우에는 아래에 그 사유를 간단하게 입력하여 주시고, 저장하신 후 <font style="font-weight:bold;">「4. 조사표 전송」</font>란으로 가셔서 조사표 전송 버튼을 실행해 주시기 바랍니다.</li>
						<li>
							<font color="#FF0000">* 단, 하도급법이 적용되지 않는 사유를 기재</font><div class="fc pt_10"></div>
							<input type="hidden" name="rnoexptVal" value="<%=sSentNoExcept%>"/>
						</li>
						<li>
						<ul class="lt">
<%-- 							<li><input type="radio" name="rnoexpt" value="1" <%if( sSentNoExcept.equals("1")){out.print("checked");}%> onclick="checkradioUnit('rnoexptVal','rnoexpt');" />①귀사가 '하도급법상의 수급사업자' 요건에 해당되지 않는 경우</li> --%>
<%-- 							<li><input type="radio" name="rnoexpt" value="2" <%if( sSentNoExcept.equals("2")){out.print("checked");}%> onclick="checkradioUnit('rnoexptVal','rnoexpt');" />②하도급거래가 아닌 경우</li> --%>
<%-- 							<li><input type="radio" name="rnoexpt" value="3" <%if( sSentNoExcept.equals("3")){out.print("checked");}%> onclick="checkradioUnit('rnoexptVal','rnoexpt');" />③귀사가 하도급을 주기만 하는 경우</li> --%>
<%-- 							<li><input type="radio" name="rnoexpt" value="4" <%if( sSentNoExcept.equals("4")){out.print("checked");}%> onclick="checkradioUnit('rnoexptVal','rnoexpt');" />④하도급을 주지도 받지도 않는 경우(하도급거래 없음)</li> --%>
							<li><textarea cols="80" rows="4" name="reason" class="textarea01b" onfocus="javascript:this.className='textarea01o';" onblur="javascript:this.className='textarea01b';" onkeyup="byteLengCheck(this, 600, this.name,'content_bytes1');"><%= StringUtil.checkNull(reason)%></textarea></li>
							<li class="fr"><p align="right" style="margin-right:40px;"><span id="content_bytes1">0/600 byte</span></p></li>
						</ul></li>
					</ul>
				</div>
				<div class="fc"></div>
			...
			<div class="boxcontent2">
				<span class="boxcontenttitle" style="display:none;" >&lt;작성 안내&gt;</span>
