...
<head>
	...
	//<![CDATA[
		...
		function savef(){
			...
			if(msg=="") {
				if(confirm("[ 조사표내용을 저장합니다. ]\n\n접속자가 많을경우 다소 시간이 걸릴수도 있습니다.\n정상적으로 저장이 안될경우\n수십분후에 다시시도하여 주십시오.\n\n서버의 부하로 저장에 실패할경우\n응답하신 조사내용을 복구할 수 없습니다.\n응답하신 조사표를 인쇄하여 보관하시고\n오류페이지에서 마우스오른쪽 버튼을 눌러\n새로고침을 선택하여 재저장을 시도하십시오.\n\n확인을 누르시면 저장합니다.")) {
					...
					main.action = "WB_CP_Subcon_Qry.jsp?type=Prod&step=Detail";
					main.submit();
				}
			} else {
				ckSave = 1;
		...
		function savef2(main){
			...
			if( confirm("[임시저장] 기능은 여러번 나누어서 응답하기 위한 기능입니다.\n\n조사표를 마무리 하기 위해서는 꼭 [저 장] 기능을 이용하셔야 하며,\n[저 장] 기능을 사용하지 않을 경우 [조사표 전송]이 안되오니\n조사표 응답을 완료할때는 필히 [저 장] 기능을 이용하셔야 합니다.\n\n확인을 누르시면 [임시저장] 기능을 실행합니다.") ) {
				main.target = "proceFrame";
				main.action = "WB_CP_Subcon_Qry.jsp?type=Prod&step=Temp";
				main.submit();
			}
		}
	...
	//2015-07-18 /강슬기/화면 인쇄시 새 창에서 출력
		function goPrint(){
			url = "WB_VP_Subcon_01_03.jsp?mode=print";
			w = 1024;
			h = 768;
...
<div id="container">
	<div id="wrapper">
		...
		<div id="subcontent">
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="clt">
						...
						<li><a href="#mokcha3" class="contentbutton3">13. 제조 위탁의 취소 및 변경</a></li>
						<li><a href="#mokcha4" class="contentbutton3">14. 물품 수령</a></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="clt">
						...
						<li class="boxcontentsubtitle">* 귀사가 완성품 제조업체로부터 하도급을 받은 경우 귀사는 1차 협력업체에 해당</li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_11_5" value="2" <%if(qa[11][5][2]!=null && qa[11][5][2].equals("1")){out.print("checked");}%> onclick="checkradio(11,5);"></input> 나. 없다<span class="boxcontentsubtitle">11-6번 문항으로 이동</span></li>
					</ul>
					<div class="fc pt_50"></div>
				</div>
				<div class="fc"></div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
					<li class="noneboxcontenttitle"><a name="mokcha3">13. 제조 위탁과 취소 및 변경</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>13-1. </span> <%= st_Current_Year_n-1%>년도에 조사대상 원사업자로부터 제조 위탁을 받은 후, 임의로 위탁이 취소되거나 변경되지 않고 본래의 계약대로 이행된 계약건수의 비율은 어떻게 됩니까?</li>
						<li class="boxcontentsubtitle"></li>
					</ul>
				</div>
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_13_1" value="1" <%if(qa[13][1][1]!=null && qa[13][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(13,1);"></input> 가. 100% (전체이행)<span class="boxcontentsubtitle">14-1번 문항으로 이동</span></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>13-2. </span> 조사대상 원사업자가 제조 위탁을 취소하거나 변경한 이유는 무엇입니까?</li>
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_13_2_2" value="1" <%if(qa[13][2][2]!=null && qa[13][2][2].equals("1")){out.print("checked");}%>></input> 나. 원사업자의 판매부진</li>
						<li><input type="checkbox" name="q2_13_2_3" value="1" <%if(qa[13][2][3]!=null && qa[13][2][3].equals("1")){out.print("checked");}%>></input> 다. 원사업자 제품의 사양 변경 또는 모델 단종</li>
						...
						<li><input type="checkbox" name="q2_13_2_5" value="1" <%if(qa[13][2][5]!=null && qa[13][2][5].equals("1")){out.print("checked");}%>></input> 마. 귀사의 계약불이행(납기일 미준수, 제조불량 등)</li>
						...
						<li><input type="checkbox" name="q2_13_2_7" value="1" <%if(qa[13][2][7]!=null && qa[13][2][7].equals("1")){out.print("checked");}%>></input> 사. 이유를 모름</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent3">
				<ul class="boxcontenthelp2 lt">
					<li class="noneboxcontenttitle"><a name="mokcha4">14. 물품 수령</a><a href="#mokcha"><img src="img/icon_gotop.gif"></img></a></li>
				</ul>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>14-1. </span> 조사대상 원사업자가 <%= st_Current_Year_n-1%>년도에 귀사에게 물품을 제조 위탁한 후, 그것을 수령한 비율은 어떻게 됩니까?</li>
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_14_1" value="1" <%if(qa[14][1][1]!=null && qa[14][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(14,1);"></input> 가. 100% (전체수령)<span class="boxcontentsubtitle">15-1번 문항으로 이동</span></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>14-2. </span> 조사대상 원사업자가 제조 위탁한 물품을 수령하지 않은 이유는 무엇입니까?</li>
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_14_2_3" value="1" <%if(qa[14][2][3]!=null && qa[14][2][3].equals("1")){out.print("checked");}%>></input> 다. 원사업자 제품의 사양 변경 또는 모델 단종</li>
						...
						<li><input type="checkbox" name="q2_14_2_5" value="1" <%if(qa[14][2][5]!=null && qa[14][2][5].equals("1")){out.print("checked");}%>></input> 마. 귀사가 발주서대로 제조하지 않음</li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_15_1" value="1" <%if(qa[15][1][1]!=null && qa[15][1][1].equals("1")){out.print("checked");}%> onclick="checkradio(15,1);"></input> 가. 100% (전체받음)<span class="boxcontentsubtitle">16-1번 문항으로 이동</span></li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_15_2_7" value="1" <%if(qa[15][2][7]!=null && qa[15][2][7].equals("1")){out.print("checked");}%>></input> 사. 납품한 물품의 판매가격 하락을 반영</li>
						...
						<li><input type="checkbox" name="q2_15_2_9" value="1" <%if(qa[15][2][9]!=null && qa[15][2][9].equals("1")){out.print("checked");}%>></input> 자. 귀사의 계약불이행(제조불량, 발주내용 미준수 등)</li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>16-2. </span> 귀사가 <%= st_Current_Year_n-1%>년도에 조사대상 원사업자로부터 받은 하도급 대금의 수령 수단별 비중은 어떻게 됩니까?</li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						...
						<li class="boxcontentsubtitle">* 목적물 납품일은 통상 세금계산서 발행일을 기준으로 함.</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<input type="hidden" name="c2_16_3" value="<%=setHiddenValue(qa, 16, 3, 4)%>"></input>
					<ul class="lt">
						<li><input type="radio" name="q2_16_3" value="1" <%if(qa[16][3][1]!=null && qa[16][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(16,3);"></input> 가. 없음<span class="boxcontentsubtitle">17-1번 문항으로 이동</span></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>17-1. </span> 귀사는 납품단가조정협의 의무제에 대해 알고 있습니까?</li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_17_2" value="1" <%if(qa[17][2][1]!=null && qa[17][2][1].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 가. 있다</li>
						<li><input type="radio" name="q2_17_2" value="2" <%if(qa[17][2][2]!=null && qa[17][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(17,2);"></input> 나. 없다<span class="boxcontentsubtitle">17-5번 문항으로 이동</span></li>
					</ul>
					<div class="fc pt_50"></div>
					<div class="fc pt_50"></div>
				</div>
							...
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										<th>직접 하도급대금 조정신청</th>
										<td>
											<input type="text" name="q2_17_11" value="<%=qa[17][11][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
										</td>
										<td>
											<input type="text" name="q2_17_12" value="<%=qa[17][12][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
										</td>
									</tr>
									<tr>
										<th>중소기업협동조합을 통해 조정신청</th>
										<td>
											<input type="text" name="q2_17_13" value="<%=qa[17][13][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
										</td>
										<td>
											<input type="text" name="q2_17_14" value="<%=qa[17][14][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> 개사
										</td>
									</tr>
								</tbody>
							</table>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_18_2" value="2" <%if(qa[18][2][2]!=null && qa[18][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(18,2);"></input> 나. 없다<span class="boxcontentsubtitle">19-1번 문항으로 이동</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>19-1. </span> <%= st_Current_Year_n-1%>년도에 조사대상 원사업자가 귀사와의 협력관계 증진을 위해 다음의 사항을 유상 또는 무상으로 지원한 경우가 몇 건 있습니까?</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<ul class="lt">
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_20_1" value="2" <%if(qa[20][1][2]!=null && qa[20][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(20,1);"></input> 나. 없다<span class="boxcontentsubtitle">21-1번 문항으로 이동</span></li>
					</ul>
					<div class="fc pt_50"></div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_20_2_2" value="1" <%if(qa[20][2][2]!=null && qa[20][2][2].equals("1")){out.print("checked");}%>></input> 나. 민원처리, 인·허가, 환경관리, 품질관리 등에 따른 비용을 수급사업자와 분담하기 위해</li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>21-1. </span> 귀사는  <%= st_Current_Year_n-1%>년도에 조사대상 원사업자로부터 기술자료 제공을 요청받은 적이 있습니까?</li>
						<li class="boxcontentsubtitle"></li>
					</ul>
				</div>
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_21_1" value="2" <%if(qa[21][1][2]!=null && qa[21][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(21,1);"></input> 나. 없다<span class="boxcontentsubtitle">21-9번 문항으로 이동</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>21-3. </span> 귀사는 조사대상 원사업자의 요청에 따라 기술자료를 제공하였습니까?</li>
					</ul>
				</div>
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_21_3" value="3" <%if(qa[21][3][3]!=null && qa[21][3][3].equals("1")){out.print("checked");}%> onclick="checkradio(21,3);"></input> 다. 제공하지 않음<span class="boxcontentsubtitle">22-1번 문항으로 이동</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>21-4. </span> 조사대상 원사업자가 귀사에게 요청한 기술자료의 명칭과 귀사의 제공여부를 기재하여 주십시오.</li>
							...
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<input type="text" name="q2_21_26" value="<%=qa[21][26][20]%>" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>
										</td>
									</tr>
									<tr>
										<th>2</th>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_21_5_2" value="1" <%if(qa[21][5][2]!=null && qa[21][5][2].equals("1")){out.print("checked");}%>></input> 나. 공동특허, 공동 기술개발 약정 체결, 제품하자의 원인규명 이외 목적으로 원사업자 자실을 위해 사용</li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>21-6. </span> 귀사는  <%= st_Current_Year_n-1%>년도에 조사대상 원사업자로부터 기술자료 요청을 어떠한 양식으로 받았습니까?</li>
						<li class="boxcontentsubtitle"></li>
					</ul>
				</div>
				<div class="boxcontentright">
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>21-7. </span> 조사대상 원사업자가 기술자료 요청 시에 사용한 서면자료 양식은 무엇입니까?</li>
						<li class="boxcontentsubtitle"></li>
					</ul>
				</div>
				<div class="boxcontentright">
							...
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										<th>1</th>
										<td>
											<input type="text" name="q2_21_31" value="<%=qa[21][31][20]%>" class="text08b" onFocus="javascript:this.className='text08o';" onBlur="javascript:this.className='text08b';"></input>
										</td>
										<td>
											<input type="text" name="q2_21_34" value="<%=qa[21][34][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>백만 원
										</td>
									</tr>
									<tr>
										<th>2</th>
										<td>
											<input type="text" name="q2_21_32" value="<%=qa[21][32][20]%>" class="text08b" onFocus="javascript:this.className='text08o';" onBlur="javascript:this.className='text08b';"></input>
										</td>
										<td>
											<input type="text" name="q2_21_35" value="<%=qa[21][35][20]%>" onkeyup ="sukeyup(this)" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input>백만 원
										</td>
									</tr>
									<tr>
										<th>3</th>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>22-1. </span> <%= st_Current_Year_n-1%>년도 조사대상 원사업자와의 하도급 거래 기간 중 "원사업자가 수행해야 할" 사업장 안전관리업무 중의 일부를 귀사가 직접 수행한 사실이 있었습니까?</li>
						<li class="boxcontentsubtitle"></li>
					</ul>
				</div>
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_22_1" value="2" <%if(qa[22][1][2]!=null && qa[22][1][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,1);"></input> 나. 없다<span class="boxcontentsubtitle">23-1번 문항으로 이동</span></li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						...
						<li><input type="radio" name="q2_22_2" value="2" <%if(qa[22][2][2]!=null && qa[22][2][2].equals("1")){out.print("checked");}%> onclick="checkradio(22,2);"></input> 나. 원사업자가 부담<span class="boxcontentsubtitle">23-1번 문항으로 이동</span></li>
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					...
					<ul class="lt">
						<li><input type="radio" name="q2_22_3" value="1" <%if(qa[22][3][1]!=null && qa[22][3][1].equals("1")){out.print("checked");}%> onclick="checkradio(22,3);"></input> 가. 지급하였음<span class="boxcontentsubtitle">23-1번 문항으로 이동</span></li>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>22-4. </span> 귀사는 사업장 안전관리 수행으로 발생된 비용을 어떻게 부담하였나요?</li>
					</ul>
				</div>
				<div class="boxcontentright">
			...
			<div class="boxcontent">
				...
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_23_1_6" value="1" <%if(qa[23][1][6]!=null && qa[23][1][6].equals("1")){out.print("checked");}%>></input> 바. 기타 (<input type="text" name="q2_23_19" value="<%=qa[23][19][20]%>" size="30" class="text04bl" onFocus="javascript:this.className='text04ol';" onBlur="javascript:this.className='text04bl';"></input>)</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>23-2. </span> <%= st_Current_Year_n-1%>년도에 조사대상 원사업자가 귀사에게 경영상의 정보를 요구했다면, 요청한 경영정보와 요구 목적은 무엇입니까?</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li>
							<table class="tbl_blue">
								...
								<tbody>
									...
									<tr>
										<th>전속거래를 통한 매출액</th>
										<td><input type="text" name="q2_24_12" value="<%=qa[24][12][20]%>" onKeyUp="sukeyup(this);" size="30" class="text03b" onFocus="javascript:this.className='text03o';" onBlur="javascript:this.className='text03b';"></input> %</td>
									</tr>
									<tr>
										<th>평균 전속거래 기간</th>
			...
			<div class="boxcontent">
				<div class="boxcontentleft">
					<ul class="elt">
						<li class="boxcontenttitle"><span>24-6. </span> <%= st_Current_Year_n-1%>년도에 조사대상 원사업자가 귀사에게 정당한 사유 없이 아래의 경영간섭 행위를 한 경우가 있었습니까?</li>
						<li class="boxcontentsubtitle">(해당 항목을 모두 선택)</li>
					</ul>
				</div>
				<div class="boxcontentright">
					<ul class="lt">
						...
						<li><input type="checkbox" name="q2_24_6_10" value="1" <%if(qa[24][6][10]!=null && qa[24][6][10].equals("1")){out.print("checked");}%>></input> 차. 해당사항 없음</li>
					</ul>
				</div>
				<div class="fc"></div>
			</div>
